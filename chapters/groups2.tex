...
prove soon (such as Theorem~\ref{thm:groups2:alternating-group-simple-for-n-geq-5},
Corollary~\ref{coro:groups2:symmetric-group-not-solvable-for-n-geq-5}); but it is remarkable that such
...
\begin{exer}{}{exer:groups2:a6-simple-via-class-formula}
  ...
  \cref{coro:groups2:a5-is-simple}). [\S{}\ref{subsec:groups2:conjugacy-an-simplicity}]
\end{exer}
