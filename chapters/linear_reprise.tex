...
$\categ{C}$ by `reversing the arrows'; cf.\ \Cref{exer:3.1}. The fact
...
with a full\footnote{See \Cref{exer:3.8} for the definition of `full'
...
\begin{exam}{}{linrep:exam:1.8}
  (Cf.\ \Cref{exer:3.6}.) Construct a category by taking the objects to
...
\begin{exer}{$\lnot$}{linrep:exer:1.4}
  ...
  multiplicative subset in the sense of \Cref{exer:irred:4.7}. Prove that
  `localization is a functor': associating with every $R$-module $M$
  the localization $S^{-1}M$ (\Cref{exer:irred:4.8}) and with every
...
\begin{exer}{}{linrep:exer:1.8}
  ...
  \item Denote by $h_S$ the functor
    ...
    and let $p = \mathbb{A}^0_K$ be a point. Show that there is a
  ...
  \item If $S \subseteq \mathbb{A}^m_K$, $T \subseteq \mathbb{A}^n_K$,
    ...
    of a `polynomial function' $\mathbb{A}^m_K \to
    \mathbb{A}^n_K$. (Part of this exercise is to make sense of what
    this means!)
  \end{itemize}
\end{exer}
...
\begin{exer}{$\lnot$}{linrep:exer:1.19}
  ...
  \item Prove that $\Z_p$ is a DVR (cf.\ \Cref{exer:irred:2.19}).  (There is
...
\begin{exam}{}{linrep:exam:2.14}
  ...
  $\mathbb{A}^2$ (over a fixed field $k$) and the `projection on the
  first coordinate' $V(xy) \to \mathbb{A}^1$, $(x,y) \mapsto x$. In
...
\begin{exer}{}{linrep:exer:2.7}
  ...
  \item Prove that
    $\mathbb{C} \otimes_{\R} \mathbb{C} \cong \mathbb{C}
    \otimes_{\mathbb{C}} \mathbb{C}$.
  \end{itemize}
\end{exer}
...
\begin{exer}{}{linrep:exer:2.12}
  Let $S$ be a multiplicative subset of $R$ (cf.\ \Cref{exer:irred:4.7}).
...
\begin{exer}{$\lnot$}{linrep:exer:2.21}
  (Cf.\ \Cref{exer:irred:4.11}.) Prove that flatness is a local property: an
  ...
  isomorphic to $K_{\mathfrak{m}}$, and use \Cref{exer:irred:4.12}.) [\ref{linrep:exer:2.22}]
\end{exer}
...
\begin{exer}{}{linrep:exer:3.15}
  ...
  the ring of matrices\footnote{I was once told that
    $M_{n,n}(\mathbb{C})$ is `not seriously noncommutative' since it
    is Morita equivalent to $\mathbb{C}$, which is commutative.}
