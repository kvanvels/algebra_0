...
\begin{proof}
  ...
  an epimorphism, by Lemma~\ref{homol:1.3}.
...
structure.\footnote{However, we will soon recover a sense in which
  ...
  terms: see \Cref{homol:2.7}.} But look at your mental image of what
...
more interesting part of the statement of \Cref{homol:1.14} asserts
...
mentioned in \Cref{homol:1.7} and allowing for some abuse of language,
...
\begin{proof}
  ...
  proven in Lemma~\ref{homol:1.14}), necessarily
...
\begin{exer}{}{exer:homol:categorical-cokernel-definition}
  ...
  agrees with the one given in Definition~\ref{homol:1.2}.
\end{exer}
...
\begin{exer}{}{exer:homol:coimage-to-target-is-mono}
  ...
  Lemma~\ref{homol:1.16} was used in its proof.)
...
easier to concoct. Lemma~\ref{homol:2.3} appears to be a good example:
...
that I will quote thereafter (\Cref{homol:2.9}) will make that
material immediately obsolete.

My excuse is that while proving \Cref{homol:2.9} is beyond the scope
...
\begin{proof}
  ...
  Theorem~\ref{homol:1.13}).

  To simplify the notation, let $j = \image\varphi$. Then (by
  Lemma~\ref{homol:2.6}) $\hat{\jmath}$ is an injective function
...
\begin{proof}
  ...
  $\hat{\psi}^{-1}(0)$. By Lemma~\ref{homol:2.7}, these conditions are
  equivalent.
\end{proof}
...
\begin{exer}{}{exer:homol:mono-iff-injective-on-elements}
  ...
  `elements'. (Cf.\ Lemma~\ref{homol:2.6}.)
  [\S{}\ref{subsec:homol:working-with-elements-in-a-small-abelian-category}]
\end{exer}
...
construction; but we have also seen (\Cref{homol:2.9}) that we do not
...
\]
On the other hand, each $H^i$ is a functor (\Cref{homol:3.4}); thus
...
\begin{exer}{}{exer:homol:arrow-theoretic-proof-of-snake-lemma-variant}
  Provide an arrow-theoretic proof of \Cref{homol:3.4} (cf.\
  \Cref{homol:3.1}).
\end{exer}
...
\begin{exer}{\exerused{}}{exer:homol:details-of-long-exact-cohomology-sequence}
  ...
  (\Cref{homol:3.5}). [\S{}\ref{subsec:homol:the-long-exact-cohomology-sequence},
...
\begin{proof}
  ...
  \Cref{homol:3.5}; all we have to check is that the connecting
...
By \Cref{homol:4.2}, this condition is equivalent to the exactness of
...
resolution as in \Cref{homol:4.4} is obtained (as the reader should
...
\Cref{homol:4.2} the cone of $\alpha^\bullet$ must be exact. It is a
...
\begin{rem}{}{homol:4.12}
  ...
  quasi-isomorphisms are not invertible, since \Cref{homol:4.6} shows
...
\]
is an additive functor (\Cref{homol:1.1}). Then $\mathscr{F}$ induces
...
\Cref{homol:4.13} implies that the conclusion of \Cref{homol:4.11}
...
root of the strategy I am pursuing. The content of \Cref{homol:4.14}
...
such complex, take cohomology, and \Cref{homol:4.14} guarantees that
...
\begin{exer}{\exerused{}}{exer:homol:cone-of-null-homotopic-morphism-is-exact}
  ...
  identity. Prove directly (without appealing to \Cref{homol:4.2})
...
\begin{exer}{}{exer:homol:homotopic-maps-extend-to-cylinder-morphism}
  ...
  homotopic in the sense of \Cref{homol:4.8} if and only if they
...
\begin{exer}{\exerused{}}{exer:homol:additive-vs-exact-functors-quasi-iso-preservation}
  ...
  quasi-isomorphisms. (Hint: \Cref{homol:4.6}.) Prove that exact
...
applications. This is the moral of \Cref{homol:4.14}: homotopy
...
\begin{proof}
  ...
  By \Cref{homol:4.7}, it suffices to show that $\alpha^\bullet$
  ...
  $MC(\id_{L^\bullet})$ is an exact complex (\Cref{homol:4.2}). The
  morphism
  \[
  ...
  $\mathscr{F}(\alpha^\bullet) = 0$ (by \Cref{homol:4.7}), concluding
...
follows directly from \Cref{homol:4.10}: homotopic maps induce the
...
\subsection{Proof of Theorem~\ref{thm:homol:5.9}}%
\label{subsec:homol:proof-of-theorem-5-9}

\Cref{thm:homol:5.9} will follow from a more general observation: a
...
\begin{proof}[Proof of \cref{thm:homol:5.9}]
  ...
  (\Cref{homol:4.10}). Since $H^\bullet(\alpha^\bullet)$ is
...
\begin{exer}{\exerused{}}{exer:homol:functor-factors-through-homotopic-category}
  Prove
  \Cref{prop:homol:5.4}. [\S{}\ref{subsec:homol:definition-of-the-homotopic-category-of-complexes}]
\end{exer}
...
\begin{exer}{$\lnot$}{exer:homol:uniqueness-of-projective-resolution-up-to-homotopy}
  ...
  \item Assume that there are quasi-isomorphisms
    ...
    \S{}\ref{sec:homol:projective-and-injective-resolutions-and-the-derived-category},
    in particular \Cref{thm:homol:6.6}.)
  \end{itemize}
...
\Cref{homol:4.6}). Further, homotopy equivalences are preserved by
every additive functor (\Cref{homol:4.14}), while general
...
(\Cref{exam:homol:5.6}), an abelian category may have no nontrivial
...
with target $\iota(A)$ (cf. \Cref{homol:4.5}): this is a `homotopic
...
equivalent complexes have the same cohomology (by \Cref{homol:4.14})
...
\begin{proof}
  ...
  left is also an epimorphism, by \Cref{homol:2.3}. A projective
  ...
  \Cref{homol:2.2}) that it is a push-out as well, and
...
\Cref{homol:4.14}). The cohomology of $L^\bullet$ is only one example
...
\begin{exer}{\exerused{}}{exer:homol:resolution-functor-p-i-properties}
  ...
  also denote by $\mathscr{P}$.  (Use \Cref{lem:homol:5.14}.) Next,
...
\begin{exer}{\exerused{}}{exer:homol:uniqueness-of-derived-functor-nat-iso}
  ...
  \Cref{thm:homol:6.9} is unique up to natural
...
\begin{exer}{\exerused{}}{exer:homol:nat-transformation-identity-to-p-iota-h0}
  ...
  $\categ{A}$ and lifting morphisms as in \Cref{prop:homol:6.5}, we
...
(\Cref{homol:4.13}) that homotopic morphisms in $\categ{C}(\categ{A})$
...
\begin{rem}{}{rem:homol:7.4}
  ...
  proof of Proposition~\ref{prop:homol:7.3}, has another interesting
...
directly implied by
\begin{itemize}
\item \Cref{prop:homol:6.4}, showing that any two projective
  resolutions are homotopy equivalent, in conjunction with
\item \Cref{homol:4.14}, showing that the images of homotopy
...
\Cref{homol:3.5}.  The key point is therefore the following: assuming
...
Theorem~\ref{thm:homol:7.12} tells us that the triangle
\[
  \begin{tikzpicture}[baseline=(current bounding box.center)]
    \node (L) at (1,1.3)
    {$\iota(L)$}; \node (N) at (0,0)
...
as proven in Theorem~\ref{thm:homol:7.12}; but only functors
...
enjoy the chance to verify that indeed Claim~\ref{prop:homol:7.18}
...
\begin{exer}{\exerused{}}{exer:homol:derived-functor-nat-transformation-not-iso-example}
  ...
  \Cref{homol:4.6} as a projective resolution in
...
\begin{exer}{\exerused{}}{exer:homol:composition-of-derived-functors}
  (Cf.\ \Cref{rem:homol:7.4}.) Let $\categ{A}$, $\categ{B}$,
...
\begin{exer}{\exerused{}}{exer:homol:mapping-cone-description-of-pm-from-pl-pn}
  With notation as in \Cref{lem:homol:7.8}, show that there is a
...
\begin{exer}{$\lnot$}{exer:homol:cartan-eilenberg-resolution-computes-cohomology}
  ...
  resolutions can be constructed, as in \Cref{coro:homol:7.9} (cf.\
  also \Cref{rem:homol:7.10}). Let
  ...
  0$. (Hint: With notation as in the proof of \Cref{coro:homol:7.9},
  ...
  resolution of $H^q(M^\bullet)$; cf.\ \Cref{rem:homol:7.10}. This
...
\begin{exer}{\exerused{}}{exer:homol:hilbert-90-from-vanishing-group-cohomology}
  ...
  Use the result of Example~\ref{exam:homol:7.15}.)
...
\begin{exam}{}{exam:homol:8.10}
  ...
  \Cref{coro:homol:5.12}, up to easy adjustments, taking care of the
...
arguments used in
\S{}\ref{sec:homol:the-homotopic-category-complexes-of-projectives-and}
are bypassed, and statements such as \Cref{coro:homol:5.12} are placed
...
Theorem~\ref{thm:homol:8.3}. We will then finally be able to go back
...
\Cref{thm:homol:6.6} accomplishes this. I have called the
...
recover Theorem~\ref{thm:homol:8.12} once we have learned a bit about
...
\begin{proof}
  ...
  follows (\Cref{homol:4.2}) that this morphism is a
...
\emph{objects} (see \Cref{lem:homol:6.3}) and resolving
\emph{complexes} (as in \Cref{thm:homol:6.6}).  Indeed, by
\Cref{coro:homol:7.9} (which relies on the horseshoe lemma, therefore
...
\Cref{thm:homol:6.6}, bypassing the nastiest details of the proof
given in
\S{}\ref{sec:homol:projective-and-injective-resolutions-and-the-derived-category}.

As mentioned in \Cref{rem:homol:7.10}, double complexes of projectives
(or, working in $\categ{C}^{\ge 0}$, injectives) resolving a given
complex (and satisfying the additional condition explained in
\Cref{rem:homol:7.10}) are called \emph{Cartan-Eilenberg
...
same object, as sides of an array.  \Cref{coro:homol:7.9} tells us how
...
\[
  ...
  \end{tikzcd}
\]
which is exact by hypothesis; using \Cref{coro:homol:7.9}, view $(*)$
...
\Cref{exam:homol:7.6}. Theorem~\ref{thm:homol:8.13} makes good on our
...
Example~\ref{exam:homol:8.8} and the strategy extensively discussed
...
\begin{exer}{\exerused{}}{exer:homol:total-complex-of-mn-is-mapping-cone}
  Prove
  Proposition~\ref{prop:homol:8.11}. [\S{}\ref{subsec:homol:total-complexes-and-resolutions}]
\end{exer}
\begin{exer}{$\lnot$}{exer:homol:cartan-eilenberg-computes-composite-derived-functor}
  ...
  \Cref{coro:homol:7.9}). Consider the complex
  \[
    (\dagger) \qquad
    \begin{tikzcd}
...
applying Corollary~\ref{homol:4.2}. Thus, in the derived category the
...
\Cref{thm:homol:8.12} are often replaced by sentences such as `by an
...
Theorems~8.9 and~8.12. To see that it implies \Cref{thm:homol:8.12},
note again that
\[
...
statement in \Cref{thm:homol:8.12}. This is what is meant by the
...
sequence. The argument sketched above, deriving \Cref{thm:homol:8.12}
from Theorem~\ref{homol:9.5}, is probably clearer from this point of
...
\Cref{thm:homol:8.12} can be analyzed by using the sequence ${}_hE_i$
...
derived functor of the composition of two functors\footnote{For a
  different viewpoint on this question, see \Cref{rem:homol:7.4}.}:
