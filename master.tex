\documentclass[draft,onecolumn,oneside,12pt,leqno]{book}
...
% Default \@pnumwidth (1.55em) only fits 1-2 digit page numbers; this
% book runs past 600 pages, so 3-digit page numbers in the TOC overflow
% it and trigger overfull hbox warnings. Widen both the page-number
% column and the matching right margin used for the dotted leaders.
\makeatletter
