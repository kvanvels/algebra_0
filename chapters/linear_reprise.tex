...
\begin{exer}{$?$}{exer:linrep:complete-proof-of-adjunction}
  ...
  \Cref{lem:linrep:hom-tensor-adjunction}. [\S{}\ref{subsec:linrep:adjunction-with-hom-and-explicit-computations}]
\end{exer}
...
`alternating' tensors. By Lemma~\ref{lem:linrep:alternating-multilinear-sign-permutation},
...
proof of Lemma~\ref{lem:linrep:exterior-power-of-free-module-rank}.)
...
\begin{exam}{}{exam:linrep:homogeneous-ideal-example}
  ...
  Lemma~\ref{lem:linrep:homogeneous-ideal-tfae}. The ideal $(y, y - x^2)$ is homogeneous,
...
\]
As we have learned in Lemma~\ref{lem:linrep:homogeneous-ideal-tfae}, the kernels of these
...
\begin{rem}{}{rem:linrep:symmetric-tensors-subalgebra-caveat}
  ...
  prefer the `quotient' constructions of Lemma~\ref{lem:linrep:symmetric-exterior-algebra-as-tensor-algebra-quotient}.
\end{rem}
...
Lemma~\ref{lem:linrep:symmetric-exterior-algebra-as-tensor-algebra-quotient}).
...
\begin{exer}{$*$}{exer:linrep:multilinear-map-phi-i-alternating}
  ...
  Lemma~\ref{lem:linrep:exterior-power-of-free-module-rank} is
...
\begin{exer}{}{exer:linrep:grassmannian-2-4-as-projective-quadric}
  ...
  corresponding minors, as in Example~\ref{exam:linrep:exterior-square-of-k4}. Prove that
...
\begin{exer}{$*$}{exer:linrep:graded-algebra-lemma-equivalence}
  ...
  Lemma~\ref{lem:linrep:homogeneous-ideal-tfae}. [\S{}\ref{subsec:linrep:very-small-detour-graded-algebra}]
\end{exer}
...
\begin{exer}{$*$}{exer:linrep:skew-commutativity-of-exterior-algebra}
  ...
  Remark~\ref{rem:linrep:exterior-algebra-skew-commutative}. [\S{}\ref{subsec:linrep:tensor-algebras}]
\end{exer}
...
functor.  This fact is spelled out in Lemma~\ref{lem:linrep:hom-tensor-adjunction}, whose
...
Corollary~\ref{coro:linrep:tensor-hom-adjunction}:
...
contravariant functor. The statement of Proposition~\ref{prop:linrep:hom-contravariant-self-adjoint}
...
precise statement of Proposition~\ref{prop:linrep:hom-contravariant-self-adjoint} is that $h_N$ is
right-adjoint to $h_N^{\mathrm{op}}$.

\begin{proof}
  Let $L$, $M$, $N$ denote $R$-modules. Recall (cf.\ the
  considerations preceding Lemma~\ref{lem:linrep:hom-tensor-adjunction}) that $R$-bilinear
...
As both $\Hom_R(N, -)$ (by Corollary~\ref{coro:linrep:hom-tensor-adjunction-other-side}) and
$\Hom_R(-, N)$ (by Proposition~\ref{prop:linrep:hom-contravariant-self-adjoint}) are right-adjoint
functors, Lemma~\ref{lem:linrep:right-adjoints-commute-with-limits} tells us they commute with
...
Also, as pointed out in Claim~\ref{prop:linrep:right-adjoint-additive-functors-left-exact}, the fact that both
...
\begin{proof}
  ...
  \]
  by Corollary~\ref{coro:linrep:hom-commutes-with-products}.
\end{proof}
...
this gives a more precise version of Proposition~\ref{prop:linrep:hom-into-free-module-via-dual}.
...
\end{coro}
\begin{proof}
  This follows from Lemma~\ref{lem:linrep:dual-of-direct-sum} and the fact that
...
Corollary~\ref{coro:linrep:dual-of-free-module}: direct sums become direct products through
the contravariant Hom (Corollary~\ref{coro:linrep:hom-commutes-with-products}).  However, a direct
...
\begin{rem}{}{rem:linrep:basis-set-not-determined-by-module}
  ...
  appearing in Corollary~\ref{coro:linrep:dual-of-free-module} requires knowledge of $S$;
  indeed, we will verify in a moment (Example~\ref{exam:linrep:dual-basis-depends-on-basis}) that
...
The isomorphism $(R^n)^\vee \cong R^n$ of Corollary~\ref{coro:linrep:dual-of-free-module}
...
\begin{proof}
  Lemma~\ref{lem:linrep:duality-functor-left-exact} takes care of all but the surjectivity of
...
Even without the benefit of full exactness, Lemma~\ref{lem:linrep:duality-functor-left-exact}
and Corollary~\ref{coro:linrep:dual-of-free-module} reduce (in principle) the computation
...
$(R^n)^\vee \cong R^n$ from Corollary~\ref{coro:linrep:dual-of-free-module}.
...
By Proposition~\ref{prop:linrep:dual-module-torsion-free}, $M^{\vee\vee}$ is torsion-free. In
...
Corollary~\ref{coro:linrep:dual-of-free-module}, if $F$ is a finite-rank free $R$-module,
...
\begin{exer}{$*$}{exer:linrep:evaluation-map-dual-tensor-free-iso-hom}
  ...
  Proposition~\ref{prop:linrep:hom-into-free-module-via-dual}. [\S{}\ref{subsec:linrep:dual-modules}]
\end{exer}
...
\begin{exer}{}{exer:linrep:hom-m-mvee-equiv-bilinear-map}
  ...
  $F \cong F^\vee$ given in Corollary~\ref{coro:linrep:dual-of-free-module}.
\end{exer}
...
\begin{exer}{}{exer:linrep:dual-map-is-transpose-matrix}
  Prove Lemma~\ref{lem:linrep:dual-map-is-transpose}.
\end{exer}
...
\begin{exer}{$*$}{exer:linrep:composition-of-isos-is-canonical-biduality-map}
  ...
  $F \cong F^\vee \cong F^{\vee\vee}$ from Corollary~\ref{coro:linrep:dual-of-free-module}
...
A variation on the theme of Lemma~\ref{lem:linrep:projective-lifting-criterion} rephrases the
...
Lemma~\ref{lem:linrep:projective-lifting-criterion} does not necessarily help in acquiring a
...
\begin{proof}
  ...
  of Lemma~\ref{lem:linrep:projective-lifting-criterion}:
  \[
    \begin{tikzcd}
...
Proposition~\ref{prop:linrep:projective-iff-direct-summand-of-free} streamlines the verification of simple
...
\begin{proof}
  These statements follow easily from Proposition~\ref{prop:linrep:projective-iff-direct-summand-of-free},
...
injective modules in the style of Proposition~\ref{prop:linrep:projective-iff-direct-summand-of-free}
(however, cf.\ Remark~\ref{rem:linrep:injective-cogenerator-role}), and while it is trivially
...
Theorem~\ref{thm:linrep:baer-criterion} completely clarifies the notion of injective
...
\begin{proof}
  By adjunction (Lemma~\ref{lem:linrep:hom-tensor-adjunction-bimodule}),
  $\Hom_R(-, f^!(Q)) \cong \Hom_S(f^*(-), Q)$ as functors
  $R\text{-Mod} \to \mathrm{Ab}$. Since $f^*$ is exact
  (Proposition~\ref{prop:linrep:restriction-extension-coextension-adjunctions}) and $\Hom_S(-, Q)$ is exact by
...
\begin{proof}
  ...
  Corollary~\ref{coro:linrep:hom-from-divisible-group-is-injective}.
  ...
  $\Q^{\oplus A}/K$ is divisible (Example~\ref{exam:linrep:q-and-q-mod-z-are-injective}).
\end{proof}
...
applying Corollary~\ref{coro:linrep:module-embeds-in-injective} to $M$ to construct $Q^0$ and
...
\begin{rem}{}{rem:linrep:injective-cogenerator-role}
  Corollary~\ref{coro:linrep:module-embeds-in-injective} may be refined, proving that every
  module can in fact be realized as a submodule of a product
  $\Hom_{\Z}(R, \Q/\Z)^S$ (this is injective, by
  Corollary~\ref{coro:linrep:hom-from-divisible-group-is-injective} and
...
\item Since Hom commutes with finite direct sums
  (Corollary~\ref{coro:linrep:hom-commutes-with-products}), so does Ext; this is an easy
...
\item The first module is $\Hom_{\Z}(\Z,\Z) \cong \Z$ for $i = 0$, and
  ...
  Proposition~\ref{prop:linrep:projective-injective-via-ext-vanishing}, since $\Z$ is projective.
...
\begin{exer}{}{exer:linrep:generalize-prop-to-projective-modules}
  Prove that the result of Proposition~\ref{prop:linrep:dual-sequence-exact-when-quotient-free} holds more
