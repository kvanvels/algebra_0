...
\begin{exam}{}{linrep:exam:1.9}
  ...
  defining\footnote{The switch in the order of $S$ and $T$ is
    reasonable: as the reader has verified in \Cref{fields:exer:2.12},
...
\begin{exam}{}{linrep:exam:2.14}
  ...
  clear to the reader who has worked out \Cref{fields:exer:2.12}!). This
...
\begin{exer}{}{linrep:exer:4.8}
  ...
  coordinates (\Cref{fields:exer:2.20})
  ...
  \]
  (notation as in \Cref{fields:exer:2.21}). (Remember that you know how to
  ...
  $\mathbf{A}^4_k$. (Recall from \Cref{fields:exer:2.20} that
...
\begin{exer}{$\lnot$}{linrep:exer:4.11}
  ...
  for the point $(c_0 : \cdots : c_n)$. (Cf.\ \Cref{fields:exer:2.21}, but
