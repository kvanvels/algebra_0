...
groups; we will see how this is done in \S{}3.1. Thus, it is important
...
\begin{proof}[Proof of \cref{prop:groups2:sylow-i-strong}]
  ...
  By Cauchy's theorem\footnote{Note that, as mentioned in \S{}2.1, we
...
see a pretty (and insightful) alternative in \S{}2.3; but the proof
...
\begin{exer}{}{exer:groups2:3.13}
  ...
  commutator, as in~\S{}3.3. Prove that each $G^{(i)}$ is
...
and then try again after absorbing the material in~\S{}4.2. In short,
...
\begin{exam}{}{exam:groups2:4.16}
  Looking again at $A_5$, we have noted in~\S{}4.3 that the types of
...
$G$ (see~\S{}3.3) is the subgroup generated by all commutators
