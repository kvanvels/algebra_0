...
\begin{exer}{$\lnot$}{exer:homol:1.11}
  ...
  an exact functor
  $\mathscr{X} : \categ{A}^{\categ{C}} \to \categ{A}$. [\ref{exer:homol:1.12}, \ref{exer:homol:1.14},
  \ref{exer:homol:1.15}, \ref{exer:homol:2.15}, \ref{exer:homol:5.7}]
\end{exer}
...
\begin{exer}{$\lnot$}{exer:homol:2.8}
  ...
  in the sense of \S{}\ref{subsec:homol:working-with-elements-in-a-small-abelian-category}. [\ref{exer:homol:2.10}]
\end{exer}
...
\begin{exer}{}{exer:homol:2.10}
  ...
  defined in \S{}\ref{subsec:homol:working-with-elements-in-a-small-abelian-category} is not faithful in general. (Use \Cref{exer:homol:2.8}.)
