...
\S{}\ref{sec:linrep:tensor-products-and-the-tor-functors} and
\S{}\ref{sec:linrep:projective-and-injective-modules-and-the-ext-functors}
...
\S{}\ref{sec:rings:complexes-and-homology}) is really responsible for
...
\item Even when there are kernels and cokernels, monomorphisms need
  ...
  \S{}\ref{subsec:groups:kernel-iff-normal}), and epimorphisms need
  not be cokernels (the injection $\Z \to \Q$ is an epimorphism in
  $\categ{Ring}$; see
  \S{}\ref{subsec:rings:monomorphisms-and-epimorphisms}).
...
\S{}\ref{sec:rings:complexes-and-homology} will be our starting
...
\S{}\ref{subsec:homol:what-is-missing}) will provide a mathematical
...
\S{}\ref{subsec:homol:undesirable-features-of-otherwise-reasonable-categories}
...
replacement. Recall
(\S{}\ref{subsec:prelims:functions:monomorphisms-and-epimorphisms})
...
\begin{proof}
  ...
  an epimorphism, by Lemma~\ref{lem:homol:mono-epi-via-zero-morphisms}.
...
\begin{proof}
  ...
  Lemma~\ref{lem:homol:mono-epi-via-zero-morphisms}, and in particular $\zeta$ factors (uniquely)
...
\end{proof}
% ?
In view of Lemma~\ref{lem:homol:mono-epi-via-trivial-kernel-cokernel}, we should be able to use diagrams
\[
...
Lemma~\ref{lem:homol:kernels-monos-cokernels-epis}), we see that in an \emph{abelian} category we
can adopt a mantra entirely analogous to the useful `kernel $\iff$
submodule' of \S{}\ref{subsec:rings:submodules-and-quotients} vintage:
...
\end{proof}
% ?
Putting together Lemma~\ref{lem:homol:kernel-is-kernel-of-its-cokernel} and Lemma~\ref{lem:homol:mono-epi-via-trivial-kernel-cokernel}, we
can rephrase Definition~\ref{defn:homol:abelian-category} by listing the following
...
% ?
\begin{proof}
  By Lemma~\ref{lem:homol:mono-epi-via-trivial-kernel-cokernel} the kernel of $\varphi$ is $0 \to A$, since
  $\varphi$ is a monomorphism. Similarly, $B \to 0$ is a cokernel of
  $\varphi$. Further, $\varphi$ is the cokernel of $0 \to A$ and the
  kernel of $B \to 0$, by Lemma~\ref{lem:homol:kernel-is-kernel-of-its-cokernel}.
...
\S{}\ref{sec:homol:working-in-abelian-categories}), since the objects
...
and an epimorphism. By Lemma~\ref{lem:homol:mono-and-epi-implies-iso}, this (and a simple
...
\item $i_A : A \to A \sqcup B$ is the kernel of
  ...
  hence it is the kernel of its cokernel (Lemma~\ref{lem:homol:kernel-is-kernel-of-its-cokernel}).
...
\item The morphism $(\pi_A, \pi_B) : A \sqcup B \to A \times B$
  ...
  monomorphism (by Lemma~\ref{lem:homol:mono-epi-via-trivial-kernel-cokernel}).
\end{itemize}
...
This will conclude the proof of Proposition~\ref{prop:homol:finite-products-coproducts-coincide}, by
Lemma~\ref{lem:homol:mono-and-epi-implies-iso}.
% ?
In view of Proposition~\ref{prop:homol:finite-products-coproducts-coincide}, we can adopt for any abelian
...
(\S{}\ref{subsec:prelims:canonical-decomposition}), $\categ{Grp}$
(\S{}\ref{subsec:groups:canonical-decomposition}), $\categ{Ring}$
(\S{}\ref{subsec:rings:canonical-decomposition-and-consequences}),
$R\text{-}\categ{Mod}$
(\S{}\ref{subsec:rings:canonical-decomposition-and-isomorphism-theorems}). In
...
By Lemma~\ref{lem:homol:kernels-monos-cokernels-epis}, $\iota$ is a monomorphism. It is clear that
...
\begin{proof}
  ...
  cokernel (Lemma~\ref{lem:homol:kernel-is-kernel-of-its-cokernel}), it follows that there is a unique
...
Lemma~\ref{lem:homol:kernel-of-cokernel-factorization-properties} motivates the first definition: every
...
\begin{proof}
  ...
  its kernel (Lemma~\ref{lem:homol:kernel-is-kernel-of-its-cokernel}); in particular,
  ...
  proven in Lemma~\ref{lem:homol:kernel-of-cokernel-factorization-properties}), necessarily
  ...
  Lemma~\ref{lem:homol:mono-epi-via-trivial-kernel-cokernel}.
\end{proof}
% ?
...
\begin{proof}[Proof of \cref{thm:homol:canonical-decomposition-of-morphism}]
  ...
  (Lemma~\ref{lem:homol:kernel-of-cokernel-factorization-properties}), as well as by the universal property of
  ...
  (Lemma~\ref{lem:homol:mono-and-epi-implies-iso}), and letting $\tilde{\varphi} : C \to K$ be
...
\begin{exer}{}{exer:homol:zero-obj-iff-id-is-zero-morphism}
  ...
  zero-morphism $A \to
  A$. [\S{}\ref{subsec:homol:quasi-isomorphisms-and-derived-categories}]
\end{exer}
\begin{exer}{}{exer:homol:categorical-cokernel-definition}
  ...
  agrees with the one given in Definition~\ref{defn:homol:kernel}.
\end{exer}
...
\begin{exer}{}{exer:homol:basic-abelian-category-lemmas}
  ...
  \item Let $\iota : K \to A$ be a kernel in $\categ{A}$; prove that
    $\iota$ is a monomorphism. (Cf.\ Lemma~\ref{lem:homol:kernels-monos-cokernels-epis}.)
  ...
  \item If $\categ{A}$ is abelian, prove that every kernel in
    ...
    Lemma~\ref{lem:homol:kernel-is-kernel-of-its-cokernel}.)
...
\begin{exer}{}{exer:homol:pullback-kernel-comparison-iso}
  ...
  push-outs. [\S{}\ref{subsec:homol:products-coproducts-and-direct-sums},
  \S{}\ref{subsec:homol:the-snake-lemma-again},
  \S{}\ref{subsec:homol:from-objects-to-complexes}]
\end{exer}
...
\begin{exer}{}{exer:homol:universal-property-of-coimage}
  ...
  category. [\S{}\ref{subsec:homol:images-canonical-decomposition-of-morphisms}]
\end{exer}
\begin{exer}{}{exer:homol:coimage-to-target-is-mono}
  ...
  that $C \to B$ is a monomorphism. (Cf.\ Lemma~\ref{lem:homol:image-coimage-induced-morphisms}; you
  should not use Theorem~\ref{thm:homol:canonical-decomposition-of-morphism}, since
  Lemma~\ref{lem:homol:image-coimage-induced-morphisms} was used in its proof.)
  [\S{}\ref{subsec:homol:images-canonical-decomposition-of-morphisms}]
\end{exer}
\begin{exer}{$\lnot$}{exer:homol:epi-mono-factorization-is-coim-image}
  ...
  \image\varphi$. [\S{}\ref{subsec:homol:long-exact-sequence-of-derived-functors}]
\end{exer}
...
the universal property of images (Lemma~\ref{lem:homol:kernel-of-cokernel-factorization-properties}) yields a
...
\S{}\ref{subsec:rings:complexes-and-exact-sequences}. All expected
...
\S{}\ref{subsec:homol:additive-categories}--1.3. With notation as
...
\begin{exam}{}{exam:homol:fibered-diagram-exact-sequence}
  ...
  \item the sequence obtained by adding a $0$ to the left,
    ...
    Example~\ref{exam:homol:pullbacks-exist-in-abelian-category});
  ...
  mentioned in Example~\ref{exam:homol:pullbacks-exist-in-abelian-category}.
\end{exam}
...
\S{}\ref{sec:rings:complexes-and-homology} for sequences of
...
reviewed in \S{}\ref{sec:homol:complexes-and-homology-again}. However,
note that while we can now \emph{state} the snake lemma
(\Cref{lem:rings:snake-lemma}) in any abelian category, the (sketch of
the) \emph{proof} given in \S{}\ref{sec:rings:complexes-and-homology}
...
\S{}\ref{sec:rings:complexes-and-homology} makes use of
...
\begin{proof}
  ...
  the map $A \oplus B \to C$ considered in Example~\ref{exam:homol:fibered-diagram-exact-sequence}.
  Since epimorphisms are cokernels in an abelian category and
  cokernels are cokernels of their kernels (Lemma~\ref{lem:homol:kernel-is-kernel-of-its-cokernel}), we
  ...
  (Lemma~\ref{lem:homol:mono-epi-via-zero-morphisms}) to show that if $\zeta : B \to Z$ is a
...
(Example~\ref{exam:homol:fibered-diagram-exact-sequence}). By
\Cref{exer:homol:pullback-kernel-comparison-iso},
$\coker\varphi' = \coker\varphi = 0$; therefore $\varphi'$ is an
epimorphism. The reader should have no difficulty now proving the
statement dual to Lemma~\ref{lem:homol:epimorphisms-stable-under-pullback}, for fibered coproducts
...
\S{}\ref{subsec:homol:working-with-elements-in-a-small-abelian-category}).
...
\[\begin{tikzcd}
  ...
  \begin{tikzcd}
    ...
    \amalg_{L_0} M_0.
  \end{tikzcd}\] By Lemma~\ref{lem:homol:epimorphisms-stable-under-pullback}, $\beta_1'$ is an
...
\S{}\ref{subsec:rings:homology-and-the-snake-lemma}. Together with
...
\S{}\ref{subsec:rings:homology-and-the-snake-lemma}, by chasing
...
construction in
\S{}\ref{subsec:rings:homology-and-the-snake-lemma}. Such issues are
...
easier to concoct. Lemma~\ref{lem:homol:epimorphisms-stable-under-pullback} appears to be a good example:
...
theorem (discussed in \S{}\ref{subsec:homol:what-is-missing}) will
...
directly to \S{}\ref{subsec:homol:what-is-missing}.  The idea is to
...
discussion at the end of \S{}\ref{subsec:linrep:examples-of-functors}:
...
\S{}\ref{subsec:homol:the-snake-lemma-again} may be verified by
...
\S{}\ref{subsec:homol:what-is-missing}.  The construction can be given
as an application of the abstract language developed in
\S{}\ref{sec:linrep:preliminaries-reprise}; but I promise that the
...
\begin{proof}
  ...
  (Lemma~\ref{lem:homol:mono-epi-via-zero-morphisms}), as claimed.
...
pointed sets (hence, by chasing elements!) by Lemma~\ref{lem:homol:element-relation-characterization}.
...
\begin{proof}
  ...
  \[\begin{tikzcd}
      ...
      \arrow[u, "z"']
    \end{tikzcd}\] By Lemma~\ref{lem:homol:epimorphisms-stable-under-pullback}, $\varphi'$ is an
...
\begin{proof}
  ...
  Theorem~\ref{thm:homol:canonical-decomposition-of-morphism}).

  To simplify the notation, let $j = \image\varphi$. Then (by
  Lemma~\ref{lem:homol:mono-epi-via-elements}) $\hat{\jmath}$ is an injective function
  ...
  Lemma~\ref{lem:homol:epimorphisms-stable-under-pullback}, since the top map in the fiber square is an
...
\begin{proof}
  This now follows immediately from Lemma~\ref{lem:homol:kernel-image-via-elements}: exactness
  in $\categ{A}$ means that $\image\varphi = \ker\psi$, and exactness
  in $\categ{Set}^*$ means that the image of $\hat{\varphi}$ equals
  $\hat{\psi}^{-1}(0)$. By Lemma~\ref{lem:homol:kernel-image-via-elements}, these conditions are
  equivalent.
\end{proof}
...
\item While we can check that a diagram commutes in $\categ{A}$ by
  ...
  following Lemma~\ref{lem:homol:element-relation-characterization}), I have stopped short of claiming
...
\item The functor $\categ{A} \to \categ{Set}^*$ is not \emph{full};
  ...
  performed in \S{}\ref{subsec:homol:the-snake-lemma-again} in order
...
\S{}\ref{subsec:homol:the-snake-lemma-again}. Monomorphisms really can
...
\S{}\ref{sec:homol:the-homotopic-category-complexes-of-projectives-and}
...
\begin{exer}{}{exer:homol:pushout-preserves-monomorphism}
  ...
  Lemma~\ref{lem:homol:epimorphisms-stable-under-pullback}.)
  [\S{}\ref{subsec:homol:the-snake-lemma-again}]
\end{exer}
...
\begin{exer}{}{exer:homol:element-relation-is-equivalence-relation}
  ...
  relation. [\S{}\ref{subsec:homol:working-with-elements-in-a-small-abelian-category}]
\end{exer}
\begin{exer}{}{exer:homol:mono-iff-injective-on-elements}
  ...
  `elements'. (Cf.\ Lemma~\ref{lem:homol:mono-epi-via-elements}.)
  [\S{}\ref{subsec:homol:working-with-elements-in-a-small-abelian-category}]
\end{exer}
\begin{exer}{}{exer:homol:elements-of-kernel-identified-with-preimage}
  ...
  Lemma~\ref{lem:homol:kernel-image-via-elements}.)
  [\S{}\ref{subsec:homol:working-with-elements-in-a-small-abelian-category}]
\end{exer}
\begin{exer}{$\lnot$}{exer:homol:id-and-neg-id-same-element}
  ...
  \S{}\ref{subsec:homol:working-with-elements-in-a-small-abelian-category}. [\ref{exer:homol:element-functor-not-faithful}]
\end{exer}
...
\begin{exer}{}{exer:homol:element-functor-not-faithful}
  ...
  [\S{}\ref{subsec:homol:working-with-elements-in-a-small-abelian-category},
  \S{}\ref{subsec:homol:what-is-missing}]
\end{exer}
...
\begin{exer}{}{exer:homol:quotient-iso-image-kernel-two-morphisms}
  ...
  [\S{}\ref{subsec:homol:working-with-elements-in-a-small-abelian-category},
  \S{}\ref{subsec:homol:spectral-sequences}]
\end{exer}
...
\S{}\ref{sec:homol:working-in-abelian-categories}, we are allowed to
...
\S{}\ref{subsec:rings:complexes-and-exact-sequences}. Once more, as we
...
of an application. In \S{}\ref{sec:rings:complexes-and-homology} I
...
\begin{rem}{}{rem:homol:cohomology-definition-parsing}
  ...
  parsed as follows (cf. Remark~\ref{rem:homol:subobject-quotient-notation}). Let $I \to M^i$ be
...
(Definition~\ref{defn:homol:quasi-isomorphism}) will give us the correct framework in
...
$\Tor^R_i(M, N)$
(cf. \S{}\ref{subsec:linrep:the-tor-functors}). Algebraic topology is
...
have in fact claimed (in \S{}\ref{subsec:linrep:the-ext-functors})
...
(\S{}\ref{subsec:homol:complexes-of-complexes}).
...
\S{}\ref{subsec:rings:complexes-and-exact-sequences} is the famous
snake lemma, \Cref{lem:rings:snake-lemma}, which has come back to
entertain us in \S{}\ref{subsec:homol:the-snake-lemma-again}. Written
cohomologically and with the benefit of the language introduced in
\S{}\ref{subsec:homol:the-category-of-complexes}, the snake lemma
...
\S{}\ref{subsec:rings:homology-and-the-snake-lemma} and can be
...
We checked in \S{}\ref{subsec:rings:homology-and-the-snake-lemma} that
...
\S{}\ref{subsec:homol:the-snake-lemma-again}, it is relatively
...
$M^{i+1}$. It follows that $\delta(n) = 0$ in this case:
...
\begin{proof}
  ...
  and is left to the reader.\footnote{The reader is welcome to look
    ...
    \S{}\ref{sec:homol:working-in-abelian-categories}, element-based
...
\S{}\ref{subsec:homol:the-long-exact-cohomology-sequence} is the fact
...
\S{}\ref{subsec:homol:the-long-exact-cohomology-sequence} we have
...
see the end of \S{}\ref{subsec:homol:the-category-of-complexes}).
...
later\footnote{Beware that some authors call the distinguished
  ...
  from this viewpoint.}
(\S{}\ref{sec:homol:the-homotopic-category-complexes-of-projectives-and}). As
...
(\S{}\ref{subsec:homol:triangulated-categories}).
...
\begin{exer}{\exerused{}}{exer:homol:resolution-gives-exact-truncated-complexes}
  ...
  resolutions of
  $A$. [\S{}\ref{subsec:homol:reminder-of-basic-definitions-general-strategy},
  \S{}\ref{subsec:homol:recovering-a}]
\end{exer}
...
\begin{exer}{\exerused{}}{exer:homol:category-of-cochain-complexes-is-abelian}
  ...
  \S{}\ref{subsec:homol:the-category-of-complexes}, is itself an
  ...
  [\S{}\ref{subsec:homol:the-category-of-complexes}]
\end{exer}
...
\begin{exer}{\exerused{}}{exer:homol:sign-change-differential-isomorphic-complex}
  ...
  d^\bullet_{L^\bullet})$. [\S{}\ref{subsec:homol:the-category-of-complexes}]
\end{exer}
...
\begin{exer}{\exerused{}}{exer:homol:details-of-long-exact-cohomology-sequence}
  ...
  (\Cref{thm:homol:long-exact-cohomology-sequence}). [\S{}\ref{subsec:homol:the-long-exact-cohomology-sequence},
...
\begin{exer}{\exerused{}}{exer:homol:reduce-long-exact-seq-to-snake-lemma}
  ...
  $\ker^\bullet$, with the object\footnote{Of course $\ker$ and
    $\coker$ mean the target and source of the arrows $\ker$ and
  ...
  [\S{}\ref{subsec:homol:the-long-exact-cohomology-sequence},
...
\begin{exer}{\exerused{}}{exer:homol:exact-vertex-implies-isomorphic-cohomologies}
  ...
  \S{}\ref{subsec:homol:triangles}) is exact, then the other two
  vertices have isomorphic cohomologies, possibly up to a
  shift. [\S{}\ref{subsec:homol:the-mapping-cone-of-a-morphism}]
\end{exer}
...
\S{}\ref{subsec:homol:the-mapping-cone-of-a-morphism}. We will also
...
constructed in
\S{}\ref{subsec:homol:the-long-exact-cohomology-sequence}. In fact,
the mapping cone will give us the third vertex of a `special' triangle
(cf.\ the end of \S{}\ref{subsec:homol:triangles}):
\[
  (\dagger) \quad
  \begin{tikzpicture}[baseline=(current bounding box.center)]
    \node (M) at (1,1.3)
...
`special' triangles encountered in \S{}\ref{subsec:homol:triangles});
...
\S{}\ref{subsec:homol:triangles} (cf.\
\S{}\ref{subsec:homol:triangulated-categories}).
...
triangles' (cf.\ \S{}\ref{subsec:homol:triangles}) abstracting exact
...
\begin{proof}
  ...
  shows that
  \[
    \beta^i(\ell) - \alpha^i(\ell) \in \image d^i_{M^\bullet},
  \]
...
presented in
\S{}\ref{subsec:homol:reminder-of-basic-definitions-general-strategy}
...
choices made in \S{}\ref{subsec:linrep:the-tor-functors} and
\S{}\ref{subsec:linrep:the-ext-functors}, concerning the definition of
the Tor and Ext functors, as we will see later in the chapter
(\S{}\ref{sec:homol:derived-functors}, especially Examples~7.6
and~7.7).
...
\begin{exer}{\exerused{}}{exer:homol:homotopy-and-homotopy-equiv-are-equiv-relations}
  ...
  equivalence relations. [\S{}\ref{subsec:homol:homotopy},
  \S{}\ref{sec:homol:projective-and-injective-resolutions-and-the-derived-category}]
\end{exer}
...
\begin{exer}{\exerused{}}{exer:homol:homotopy-compatible-with-composition}
  ...
  \end{enumerate} [\S{}\ref{subsec:homol:homotopy},
  \S{}\ref{subsec:homol:definition-of-the-homotopic-category-of-complexes},
  \S{}\ref{subsec:homol:homotopy-equivalences-vs-quasi-isomorphisms-in-k-a},
  \S{}\ref{subsec:homol:proof-of-theorem-5-9}]
\end{exer}
...
\begin{exer}{\exerused{}}{exer:homol:cone-of-null-homotopic-morphism-is-exact}
  ...
  exact. [\S{}\ref{subsec:homol:homotopy}]
\end{exer}
...
\begin{exer}{\exerused{}}{exer:homol:homotopy-equiv-functor-cohomology-iso}
  Prove \Cref{thm:homol:homotopy-equivalence-preserved-under-functor}. [\S{}\ref{subsec:homol:homotopy}]
\end{exer}
...
\S{}\ref{sec:homol:cones-and-homotopies} is that while
...
\S{}\ref{subsec:homol:quasi-isomorphisms-and-derived-categories}. Again
...
\begin{proof}
  ...
  (\S{}\ref{subsec:homol:the-mapping-cone-of-a-morphism}) that
  \[
...
Lemma~\ref{lem:homol:quasi-iso-inverting-functor-respects-homotopy} tells us that every functor transforming
...
(cf. \S{}\ref{subsec:homol:complexes-of-projective-and-injective-objects})
...
As I already mentioned in \S{}\ref{subsec:homol:triangles},
$\categ{K}(\categ{A})$ is a \emph{triangulated} category; the
`distinguished triangles' are the triangles arising from the cones of
morphisms, as in
\S{}\ref{subsec:homol:the-mapping-cone-of-a-morphism}. (I will briefly
...
We can then reinterpret Lemma~\ref{lem:homol:quasi-iso-inverting-functor-respects-homotopy} as the following
...
\[\begin{tikzcd}[column sep=large]
  ...
  \end{tikzcd}\] A particular case of Proposition~\ref{prop:homol:functor-factors-through-homotopy-category}
...
\S{}\ref{subsec:linrep:projectives-and-injectives} hold in any abelian
...
\S{}\ref{subsec:linrep:projective-modules} and
\S{}\ref{subsec:linrep:injective-modules} use the specific properties
...
Example~\ref{exam:homol:finite-abelian-groups-no-proj-inj} shows that we should not expect an
...
The proof of Theorem~\ref{thm:homol:quasi-iso-of-bounded-proj-inj-complexes-is-homotopy-equivalence} will require a few
...
Lemma~\ref{lem:homol:zero-cohomology-morphism-null-homotopic}, since every morphism to an exact complex
has no choice but to induce the zero-morphism in cohomology.

The `injective' version of Corollary~\ref{coro:homol:morphism-to-exact-complex-null-homotopic} is that
...
Lemma~\ref{lem:homol:zero-cohomology-morphism-null-homotopic}. It is an essentially inescapable feature
of the theory.
...
Corollary~\ref{coro:homol:bounded-exact-complex-homotopy-trivial} is the first manifestation of the
principle captured more fully by Theorem~\ref{thm:homol:quasi-iso-of-bounded-proj-inj-complexes-is-homotopy-equivalence}: we have
...
Another consequence of Lemma~\ref{lem:homol:zero-cohomology-morphism-null-homotopic} is the following
...
\begin{proof}
  ...
  (\S{}\ref{subsec:homol:the-mapping-cone-of-a-morphism}), and define
  morphisms
  \[
  ...
  complexes $P^\bullet \to MC(\rho)[-1]^\bullet$. Indeed\footnote{It
    ...
    defined in
    \S{}\ref{subsec:homol:the-mapping-cone-of-a-morphism}. The
  ...
  Corollary~\ref{coro:homol:morphism-to-exact-complex-null-homotopic}, it follows that $\beta^\bullet$ is
...
\begin{exam}{}{exam:homol:composition-zero-but-morphism-nonzero-example}
  ...
  0$. According to Lemma~\ref{lem:homol:quasi-iso-lifting-uniqueness-setup}, the (nonzero) morphism
  $\alpha^\bullet$ is homotopic to $0$. (Indeed, a homotopy is
  immediately visible.  What is it?)
\end{exam}

\subsection{Proof of Theorem~\ref{thm:homol:quasi-iso-of-bounded-proj-inj-complexes-is-homotopy-equivalence}}%
...
\begin{proof}
  ...
  zero by Corollary~\ref{coro:homol:morphism-to-exact-complex-null-homotopic}. Therefore, there exist
  morphisms
  \[
...
injectives finally establishes Theorem~\ref{thm:homol:quasi-iso-of-bounded-proj-inj-complexes-is-homotopy-equivalence}:
...
\begin{proof}[Proof of \cref{thm:homol:quasi-iso-of-bounded-proj-inj-complexes-is-homotopy-equivalence}]
  ...
  By Proposition~\ref{prop:homol:quasi-iso-to-projective-complex-has-homotopy-inverse}, since $P_1^\bullet$ is in
  $\categ{C}^-(\categ{P})$ and
  ...
  $\categ{C}^-(\categ{P})$; hence by Proposition~\ref{prop:homol:quasi-iso-to-projective-complex-has-homotopy-inverse}
...
\begin{exer}{\exerused{}}{exer:homol:homotopic-categories-are-additive}
  ...
  additive. [\S{}\ref{subsec:homol:definition-of-the-homotopic-category-of-complexes}]
\end{exer}
\begin{exer}{\exerused{}}{exer:homol:functor-factors-through-homotopic-category}
  Prove
  \Cref{prop:homol:functor-factors-through-homotopy-category}. [\S{}\ref{subsec:homol:definition-of-the-homotopic-category-of-complexes}]
\end{exer}
...
\begin{exer}{\exerused{}}{exer:homol:direct-sum-projectives-injectives-abelian-category}
  ...
  \S{}\ref{subsec:homol:long-exact-sequence-of-derived-functors}]
\end{exer}
\begin{exer}{\exerused{}}{exer:homol:no-nontrivial-proj-inj-finite-abelian-groups}
  ...
  objects. [\S{}\ref{subsec:homol:complexes-of-projective-and-injective-objects}]
\end{exer}
\begin{exer}{\exerused{}}{exer:homol:left-adjoint-preserves-projectives}
  ...
  \S{}\ref{subsec:homol:viewpoint-shift}]
\end{exer}
...
\begin{exer}{\exerused{}}{exer:homol:split-exact-complex-characterization}
  ...
  \S{}\ref{subsec:rings:split-exact-sequences}) if and only if
...
\begin{exer}{\exerused{}}{exer:homol:exact-bounded-complex-proj-inj-homotopy-trivial}
  ...
  zero. [\S{}\ref{subsec:homol:homotopy-equivalences-vs-quasi-isomorphisms-in-k-a}]
\end{exer}
...
Theorem~\ref{thm:homol:quasi-iso-of-bounded-proj-inj-complexes-is-homotopy-equivalence} is very good news. It tells us that if we
...
(\S{}\ref{subsec:homol:poor-man-s-derived-category}).
...
\begin{proof}
  ...
  homotopy follows immediately from Lemma~\ref{lem:homol:zero-cohomology-morphism-null-homotopic}.
\end{proof}
...
(This is also a direct consequence of Lemma~\ref{lem:homol:resolution-lifting-property}.)
...
\begin{proof}
  ...
  homotopy, as an immediate consequence of Lemma~\ref{lem:homol:resolution-lifting-property}.
\end{proof}

The assignment provided by Proposition~\ref{prop:homol:morphism-lifts-to-resolutions-uniquely-up-to-homotopy} is clearly
...
Proposition~\ref{prop:homol:resolutions-are-homotopy-equivalent}), hence isomorphic in
$\categ{K}^-(\categ{P})$; morphisms in $\categ{A}$ correspond
precisely to homotopy classes of morphisms between projective
resolutions (by Proposition~\ref{prop:homol:morphism-lifts-to-resolutions-uniquely-up-to-homotopy}), hence to morphisms
in $\categ{K}^-(\categ{P})$.
...
available, in \S{}\ref{subsec:homol:derived-categories}.
...
observed in
\S{}\ref{subsec:homol:quasi-isomorphisms-and-derived-categories},
...
As always, there is a mirror statement to Theorem~\ref{thm:homol:projective-resolution-functor-exists}
...
\begin{proof}
  ...
  $\tilde\lambda^\bullet$.  Theorem~\ref{thm:homol:quasi-iso-of-bounded-proj-inj-complexes-is-homotopy-equivalence} implies then
  ...
  Lemma~\ref{lem:homol:quasi-iso-lifting-uniqueness-setup}, and this concludes the proof.
\end{proof}
...
\S{}\ref{subsec:homol:quasi-isomorphisms-and-derived-categories}. The
...
Theorem~\ref{thm:homol:derived-category-equivalence-via-resolutions} is proven in full detail in any more
...
Theorem~\ref{thm:homol:derived-category-equivalence-via-resolutions} should be true, in the sense that
...
exists by Theorem~\ref{thm:homol:projective-resolution-functor-exists}) and with every morphism
...
Theorem~\ref{thm:homol:projective-resolution-functor-exists}; therefore different choices would only
...
\begin{rem}{}{rem:homol:resolution-functor-choice-independence}
  ...
  $\categ{C}^-(\categ{A})$. By Theorem~\ref{thm:homol:projective-resolution-functor-exists}, there is a
  ...
  isomorphism\footnote{`Natural transformations' were rapidly defined
    in \S{}\ref{subsec:linrep:comparing-functors},
...
Theorem~\ref{thm:homol:derived-category-equivalence-via-resolutions}) that there is `only' an equivalence of
categories between $\categ{K}^-(\categ{P})$ and
$\categ{D}^-(\categ{A})$, not a hard and fast `isomorphism'. As I
already pointed out in
\S{}\ref{subsec:linrep:equivalence-of-categories}, this is what should
...
\begin{proof}
  ...
  Theorem~\ref{thm:homol:projective-resolution-functor-exists}, $\rho^\bullet$ lifts to a morphism of
  ...
  Lemma~\ref{lem:homol:quasi-iso-inverting-functor-respects-homotopy}: homotopic morphisms have the same image
  ...
  Lemma~\ref{lem:homol:quasi-iso-inverting-functor-respects-homotopy}.
...
Theorem~\ref{thm:homol:projective-resolution-functor-exists}, gives us an entity which certainly
...
\begin{exer}{\exerused{}}{exer:homol:subcategory-cohomology-degree-0-equiv-a}
  ...
  this subcategory.) [\S{}\ref{subsec:homol:recovering-a},
  \S{}\ref{subsec:homol:from-objects-to-complexes},
...
\begin{exer}{\exerused{}}{exer:homol:resolution-functor-p-i-properties}
  ...
  complex, as in
  \S{}\ref{subsec:homol:poor-man-s-derived-category}. Prove that
  ...
  $\mathscr{I} \circ \mathscr{P} \rightsquigarrow \id_{\categ{K}^-
    (\categ{A})}$. [\S{}\ref{subsec:homol:viewpoint-shift},
  \S{}\ref{subsec:homol:universal-property-of-the-derived-functor}]
\end{exer}
...
\begin{exer}{\exerused{}}{exer:homol:true-lift-doesnt-exist-homotopy-lift-does}
  ...
  \Cref{thm:homol:projective-resolution-functor-exists}). [\S{}\ref{subsec:homol:from-objects-to-complexes}]
\end{exer}
...
\begin{exer}{\exerused{}}{exer:homol:uniqueness-of-derived-functor-nat-iso}
  ...
  isomorphism. [\S{}\ref{subsec:homol:poor-man-s-derived-category}]
\end{exer}
\begin{exer}{\exerused{}}{exer:homol:nat-transformation-identity-to-p-iota-h0}
  ...
  as in \S{}\ref{subsec:homol:poor-man-s-derived-category}, this is
  ...
  H^0$. [\S{}\ref{subsec:homol:viewpoint-shift}]
\end{exer}
...
\S{}\ref{subsec:homol:poor-man-s-derived-category}---the homotopic
...
\S{}\ref{subsec:homol:poor-man-s-derived-category}, the functor
...
out in \S{}\ref{subsec:homol:poor-man-s-derived-category}, there are
...
\S{}\ref{sec:homol:cones-and-homotopies}): the complex $L^\bullet$ is
...
\S{}\ref{subsec:homol:poor-man-s-derived-category}, this would give us
...
\S{}\ref{subsec:homol:poor-man-s-derived-category}, associating with
...
\S{}\ref{subsec:homol:viewpoint-shift}, that is, the subcategories
...
The moral of Example~\ref{exam:homol:exact-functor-preserves-degree-zero-objects} is that deriving exact
...
\begin{proof}
  ...
  \Cref{exer:homol:resolution-functor-p-i-properties}), then we know
  ...
  \Cref{exer:homol:resolution-functor-p-i-properties}):
  \[
...
\begin{rem}{}{rem:homol:composition-of-derived-functors-remark}
  ...
  proof of Proposition~\ref{prop:homol:left-derived-functor-universal-property}, has another interesting
...
The content of Proposition~\ref{prop:homol:left-derived-functor-universal-property} is again in line with
...
\S{}\ref{subsec:linrep:projective-modules} and
\S{}\ref{subsec:linrep:injective-modules}); thus every
...
\begin{exam}{}{exam:homol:tor-as-derived-tensor}
  ...
  \]
  (see
  \S{}\ref{subsec:linrep:adjunction-with-hom-and-explicit-computations}). The
  ...
  \S{}\ref{subsec:linrep:the-tor-functors} matches precisely the
  `concrete' interpretation of the $i$-th left-derived functor given
  above. The reader may note that in
  \S{}\ref{subsec:linrep:the-tor-functors} we used a free resolution
  ...
  \S{}\ref{subsec:linrep:projective-modules} and was attributed there
...
\begin{exam}{}{exam:homol:ext-as-derived-hom}
  ...
  \S{}\ref{subsec:linrep:the-ext-functors}, it is also the $i$-th
...
\S{}\ref{subsec:linrep:the-tor-functors} and
\S{}\ref{subsec:linrep:the-ext-functors}, without proof (save for
...
Lemma~\ref{lem:homol:exact-sequence-of-projective-resolutions} tells us that we can lift exact sequences of
...
not abelian, this is simply not an option. Lemma~\ref{lem:homol:exact-sequence-of-projective-resolutions}
...
\S{}\ref{subsec:homol:the-mapping-cone-of-a-morphism}. These are the
...
\[
  ...
  \end{tikzpicture}
\]
in the sense of \S{}\ref{subsec:homol:triangles}. The horseshoe lemma
...
\begin{proof}
  ...
  (Lemma~\ref{lem:homol:exact-sequence-of-projective-resolutions}) yields projective resolutions of $K^i$
...
\begin{rem}{}{rem:homol:cartan-eilenberg-resolution-naturality}
  The proof of Corollary~\ref{coro:homol:cartan-eilenberg-resolution-of-complex} shows that the
...
\begin{proof}
  ...
  \S{}\ref{subsec:linrep:projectives-and-injectives}). It follows that
  \[\begin{tikzcd}
...
\begin{proof}
  By Lemma~\ref{lem:homol:exact-sequence-of-projective-resolutions}, the given exact sequence is induced by
  an exact sequence of projective resolutions
  \[\begin{tikzcd}
      0 \arrow[r] & P_L^\bullet \arrow[r] & P_M^\bullet \arrow[r] &
      P_N^\bullet \arrow[r] & 0.
    \end{tikzcd}\] By Lemma~\ref{lem:homol:exact-sequence-with-projective-term-functor-properties}, the corresponding
  sequence
  \[\begin{tikzcd}
...
Once more in the style of \S{}\ref{subsec:homol:triangles},
Theorem~\ref{thm:homol:long-exact-sequence-of-derived-functors} tells us that the triangle
\[
  \begin{tikzpicture}[baseline=(current bounding box.center)]
    \node (L) at (1,1.3)
    {$\iota(L)$}; \node (N) at (0,0)
...
as proven in Theorem~\ref{thm:homol:long-exact-sequence-of-derived-functors}; but only functors
...
\begin{proof}
  ...
  (cf. \S{}\ref{subsec:homol:reminder-of-basic-definitions-general-strategy}),
  ...
  Proposition~\ref{prop:homol:morphism-lifts-to-resolutions-uniquely-up-to-homotopy} there exists a morphism of
  ...
  isomorphism.
\end{proof}
Going back to Theorem~\ref{thm:homol:long-exact-sequence-of-derived-functors}, we see that if
...
already pointed out in Example~\ref{exam:homol:exact-functor-preserves-degree-zero-objects}, one should not
...
encountered in \S{}\ref{subsec:rings:monoid-rings}. Objects of
...
\[\begin{tikzcd}
    0 \arrow[r] & L \arrow[r] & M \arrow[r] & N \arrow[r] & 0
  \end{tikzcd}\] we obtain (from Theorem~\ref{thm:homol:long-exact-sequence-of-derived-functors}) a long
...
\S{}\ref{sec:homol:double-complexes}), this can be computed by an
...
Claim~\ref{prop:homol:hilberts-theorem-90} is significant: it goes under the name of
...
enjoy the chance to verify that indeed Claim~\ref{prop:homol:hilberts-theorem-90}
...
Example~\ref{exam:homol:group-cohomology-resolution-for-z} we verified that
...
\begin{exer}{\exerused{}}{exer:homol:mapping-cone-description-of-pm-from-pl-pn}
  ...
  [\S{}\ref{subsec:homol:relating-f-li-f-rif}]
\end{exer}
...
\begin{exer}{\exerused{}}{exer:homol:morphisms-of-ses-induce-morphisms-of-les}
  Complete the proof of Theorem~\ref{thm:homol:long-exact-sequence-of-derived-functors} by showing that
  morphisms of short exact sequences induce morphisms of the
  corresponding long exact sequences of derived
  functors. [\S{}\ref{subsec:homol:long-exact-sequence-of-derived-functors}]
\end{exer}
...
\begin{exer}{\exerused{}}{exer:homol:derived-functor-of-projective-object}
  ...
  0$. [\S{}\ref{subsec:homol:resolution-by-acyclic-objects}]
\end{exer}
...
\begin{exer}{\exerused{}}{exer:homol:generalized-dimension-shifting}
  Generalize
  Exercise~\ref{exer:homol:dimension-shifting-derived-functors} as
  ...
  all $i > k$. [\S{}\ref{subsec:homol:resolution-by-acyclic-objects},
...
\begin{exer}{$\lnot$}{exer:homol:effaceable-delta-functor-morphism-extension}
  ...
  $\delta$-functors
  (Exercise~\ref{exer:homol:delta-functor-definition-derived-functors-are})
...
\begin{exer}{$\lnot$}{exer:homol:derived-functors-are-universal-delta-functors}
  ...
  Exercise~\ref{exer:homol:effaceable-delta-functor-morphism-extension}. Prove
...
\begin{exer}{\exerused{}}{exer:homol:invariants-functor-right-adjoint-trivial-action}
  ...
  \S{}\ref{subsec:homol:example-a-little-group-cohomology} is
...
\begin{exer}{\exerused{}}{exer:homol:exactness-of-group-cohomology-complex-low-degrees}
  ...
  \S{}\ref{subsec:homol:example-a-little-group-cohomology}. Define
...
\begin{exer}{\exerused{}}{exer:homol:hilbert-90-from-vanishing-group-cohomology}
  ...
  consequence of the vanishing of Claim~\ref{prop:homol:hilberts-theorem-90}.  (Hint:
  Use the result of Example~\ref{exam:homol:group-cohomology-resolution-for-cyclic-group}.)
...
\begin{exer}{\exerused{}}{exer:homol:group-homology-of-z-with-coefficients}
  ...
  $M$ carrying a
  $\Z$-action. [\S{}\ref{subsec:homol:example-a-little-group-cohomology}]
\end{exer}
...
(\S{}\ref{subsec:homol:resolution-by-acyclic-objects}). But everything
...
Exercise~\ref{exer:homol:derived-functor-of-projective-object}): if
...
on the right (cf.\ \S{}\ref{subsec:homol:relating-f-li-f-rif}), so in
...
\begin{exam}{}{exam:homol:flat-modules-are-tor-acyclic}
  ...
  $i \ne 0$ and all $M$; see \S{}\ref{subsec:linrep:the-tor-functors}
...
Here is the punch line. In \S{}\ref{subsec:linrep:the-ext-functors} I
...
\begin{proof}
  ...
  \[
    ...
    \end{tikzcd}
  \]
  Applying Theorem~\ref{thm:homol:long-exact-sequence-of-derived-functors} (and
  Proposition~\ref{prop:homol:right-exact-functor-derived-functor-degree-zero}), we obtain a long exact sequence
  ending with
  \[\begin{tikzcd}
  ...
  obtained by applying Theorem~\ref{thm:homol:long-exact-sequence-of-derived-functors} to $(*)$ give
  \[\begin{tikzcd}
  ...
  \]
  (also cf.\ Exercise~\ref{exer:homol:generalized-dimension-shifting})
...
\begin{exam}{}{exam:homol:flat-resolution-computes-tor}
  ...
  (Example~\ref{exam:homol:flat-modules-are-tor-acyclic}), so this is now a consequence of
  Theorem~\ref{thm:homol:derived-functor-via-acyclic-resolution}.
\end{exam}

Theorem~\ref{thm:homol:derived-functor-via-acyclic-resolution} raises an interesting possibility: since
...
Theorem~\ref{thm:homol:derived-functor-via-acyclic-resolution}. Let $A^\bullet$ be an
...
\[\begin{tikzcd}[column sep=small]
  ...
  \end{tikzcd}\] The result of Theorem~\ref{thm:homol:derived-functor-via-acyclic-resolution} is that
...
\S{}\ref{subsec:homol:the-category-of-complexes} that we would examine
...
(\S{}\ref{subsec:homol:the-long-exact-cohomology-sequence}) and the
construction of the mapping cone
(\S{}\ref{subsec:homol:the-mapping-cone-of-a-morphism}). The latter
...
\S{}\ref{subsec:homol:the-mapping-cone-of-a-morphism} is obtained by
\begin{itemize}
...
% \S{}\ref{subsec:homol:the-mapping-cone-of-a-morphism}, no new
...
\S{}\ref{subsec:homol:spectral-sequences}. There are standard
...
\emph{Mutatis mutandis}, Theorem~\ref{thm:homol:acyclic-assembly-lemma} holds for
...
In terms of double complexes, Theorem~\ref{thm:homol:acyclic-assembly-lemma} says that
...
\begin{exam}{}{exam:homol:acyclic-assembly-application}
  Here is a taste of how convenient Theorem~\ref{thm:homol:acyclic-assembly-lemma} is.
  ...
  given in Theorem~\ref{thm:homol:acyclic-assembly-lemma} (in the symmetrically bounded
  version).  According to Theorem~\ref{thm:homol:acyclic-assembly-lemma}, the
  corresponding total complex is exact; as seen in
  Example~\ref{exam:homol:hom-tensor-double-complex-example} (cf.\
...
Example~\ref{exam:homol:acyclic-assembly-application} illustrates well the power of results
such as Theorem~\ref{thm:homol:acyclic-assembly-lemma}: the nuts-and-bolts-style
arguments used in
\S{}\ref{sec:homol:the-homotopic-category-complexes-of-projectives-and}
...
examined in \S{}\ref{subsec:homol:resolution-by-acyclic-objects},
letting a double complex draw the conclusion of
Theorem~\ref{thm:homol:derived-functor-via-acyclic-resolution}. We will then finally be able to go back
...
We have studied in \S{}\ref{subsec:homol:from-objects-to-complexes}
...
\begin{thm}{}{thm:homol:balancing-derived-functors}
  ...
  \item Assume that $(*)$ is a resolution of $N^\bullet$ in
    ...
    \S{}\ref{subsec:homol:from-objects-to-complexes} and following).
...
The statement of Theorem~\ref{thm:homol:balancing-derived-functors} extends that of
Theorem~\ref{thm:homol:acyclic-assembly-lemma}; its proof is a nearly immediate
consequence of the latter. As I mentioned at the beginning of
\S{}\ref{subsec:homol:exactness-of-the-total-complex}, these
...
recover Theorem~\ref{thm:homol:balancing-derived-functors} once we have learned a bit about
spectral sequences in \S{}\ref{subsec:homol:spectral-sequences}, but
...
\begin{proof}
  ...
  The first statement follows from Theorem~\ref{thm:homol:acyclic-assembly-lemma} and
  Proposition~\ref{prop:homol:total-complex-of-cone-is-mapping-cone-of-totalizations}. Indeed, let
  ...
  \[\begin{tikzcd}
      ...
      \arrow[r] & \dots
    \end{tikzcd}\] by Theorem~\ref{thm:homol:acyclic-assembly-lemma}, $TC(M_N)^\bullet$
  is exact; by Proposition~\ref{prop:homol:total-complex-of-cone-is-mapping-cone-of-totalizations} this is the mapping
...
To appreciate the usefulness of Theorem~\ref{thm:homol:balancing-derived-functors}, again in
...
Theorem~\ref{thm:homol:balancing-derived-functors}. This reproduces the main content of
...
\S{}\ref{subsec:homol:resolution-by-acyclic-objects}: we ended that
...
Theorem~\ref{thm:homol:balancing-derived-functors} to the complex
\[\begin{tikzcd}
...
\]
which was the conclusion of Theorem~\ref{thm:homol:derived-functor-via-acyclic-resolution}.
...
in \S{}\ref{subsec:linrep:the-tor-functors} (where we used free
resolutions); see also
\Cref{exam:homol:tor-as-derived-tensor}. Theorem~\ref{thm:homol:tor-is-balanced} makes good on our
old promise (also made in \S{}\ref{subsec:linrep:the-tor-functors}) to
show that the Tor functors could be computed by resolving the second
factor rather than the first.

\begin{proof}
  Apply Theorem~\ref{thm:homol:balancing-derived-functors} to the complex
  \[
    (*) \qquad
    \begin{tikzcd}
  ...
  \]
  by the first statement in Theorem~\ref{thm:homol:balancing-derived-functors}. On the other
  ...
  \]
  by the second statement in Theorem~\ref{thm:homol:balancing-derived-functors}. The result
  follows.
\end{proof}
...
The proof of Theorem~\ref{thm:homol:ext-is-balanced} is left to the reader
(\Cref{exer:homol:ext-via-proj-or-inj-resolution-agree}):
Example~\ref{exam:homol:hom-tensor-double-complex-example} and the strategy extensively discussed
...
last chapter. In \S{}\ref{sec:homol:further-topics} we will give a
...
\begin{exer}{\exerused{}}{exer:homol:total-differential-squares-to-zero}
  ...
  Proposition~\ref{prop:homol:total-complex-is-a-complex}). [\S{}\ref{subsec:homol:complexes-of-complexes}]
\end{exer}
\begin{exer}{\exerused{}}{exer:homol:sign-flip-gives-isomorphic-double-complex}
  ...
  array.) [\S{}\ref{subsec:homol:complexes-of-complexes},
  \S{}\ref{subsec:homol:exactness-of-the-total-complex}]
\end{exer}
\begin{exer}{\exerused{}}{exer:homol:cohomology-of-total-hom-complex-is-hom-in-k}
  With notation as in Example~\ref{exam:homol:hom-tensor-double-complex-example}, prove that the
...
\begin{exer}{\exerused{}}{exer:homol:total-complex-of-mn-is-mapping-cone}
  Prove
  Proposition~\ref{prop:homol:total-complex-of-cone-is-mapping-cone-of-totalizations}. [\S{}\ref{subsec:homol:total-complexes-and-resolutions}]
\end{exer}
\begin{exer}{$\lnot$}{exer:homol:cartan-eilenberg-computes-composite-derived-functor}
  ...
  concentrated in degree $0$, and apply Theorem~\ref{thm:homol:balancing-derived-functors}.)
  [\S{}\ref{subsec:homol:universal-property-of-the-derived-functor},
...
\begin{exer}{\exerused{}}{exer:homol:ext-via-proj-or-inj-resolution-agree}
  Prove Theorem~\ref{thm:homol:ext-is-balanced}: Let $M, N$ be modules over a
  ...
  given in
  \S{}\ref{subsec:linrep:the-ext-functors}. [\S{}\ref{subsec:homol:acyclic-resolutions-again-and-balancing-tor-and-ext}]
\end{exer}
...
\begin{exer}{$\lnot$}{exer:homol:projective-dimension-equivalent-characterizations}
  ...
  adapt Exercise~\ref{exer:homol:generalized-dimension-shifting}.)
...
\begin{exer}{$\lnot$}{exer:homol:injective-dimension-equivalent-characterizations}
  ...
  \end{enumerate}
  (See
  Exercise~\ref{exer:homol:projective-dimension-equivalent-characterizations}.)
  [\ref{exer:homol:global-dimension-pd-id-equality}]
\end{exer}
\begin{exer}{}{exer:homol:global-dimension-pd-id-equality}
  (See
  Exercises~\ref{exer:homol:projective-dimension-equivalent-characterizations}
  and
  \ref{exer:homol:injective-dimension-equivalent-characterizations}.)
  Let $\categ{A}$ be an abelian category with enough injectives and
...
\begin{exer}{\exerused{}}{exer:homol:bifunctor-derived-functor-construction}
  ...
  \item Let
    ...
    (Hint: Mimic the proof of Theorem~\ref{thm:homol:derived-functor-via-acyclic-resolution}.)
  \end{itemize}
  ...
  Exercise~\ref{exer:homol:derived-functors-are-universal-delta-functors}
...
\S{}\ref{subsec:homol:spectral-sequences}, illustrating the spectral
...
\S{}\ref{subsec:homol:quasi-isomorphisms-and-derived-categories} and
...
\S{}\ref{subsec:homol:poor-man-s-derived-category}, which should
...
\S{}\ref{subsec:irred:the-field-of-fractions-of-an-integral-domain}). This
...
\S{}\ref{subsec:homol:quasi-isomorphisms-and-derived-categories}. If
...
\S{}\ref{subsec:homol:poor-man-s-derived-category}. The latter should
...
through the homotopic category (Proposition~\ref{prop:homol:functor-factors-through-homotopy-category}). In
...
\S{}\ref{subsec:homol:quasi-isomorphisms-and-derived-categories}. However,
...
roof
(Exercise~\ref{exer:homol:upside-down-roof-implies-regular-roof});
this may be easier after acquiring a little familiarity with
distinguished triangles. Also, note that the diagram in
Exercise~\ref{exer:homol:upside-down-roof-implies-regular-roof} does
...
them (\S{}\ref{subsec:homol:long-exact-sequence-of-derived-functors})
...
$0$. But the mapping cone of the identity is \emph{homotopically
  equivalent} to $0$
(Exercise~\ref{exer:homol:mapping-cone-of-isomorphism-homotopy-trivial}),
...
(Exercise~\ref{exer:homol:mapping-cone-of-natural-morphism-is-shift})
...
\[
  ...
  \end{tikzpicture}
\]
obtained in Proposition~\ref{prop:homol:mapping-cone-exact-triangle}. In general, a
...
mysterious remarks at the end of \S{}\ref{subsec:homol:triangles}. The
`special triangles'
\[
  \begin{tikzpicture}[baseline=(current bounding box.center)]
    \node (L) at (1,1.3)
  ...
  \end{tikzpicture}
\]
arising as in \S{}\ref{subsec:homol:triangles} from a short exact
sequence
\[
  0 \longrightarrow L^\bullet \xrightarrow{\alpha^\bullet} M^\bullet
  \xrightarrow{\beta^\bullet} N^\bullet \longrightarrow 0
...
(Exercise~\ref{exer:homol:mapping-cone-of-mono-quasi-iso-to-cokernel})
...
applying Corollary~\ref{coro:homol:quasi-iso-iff-mapping-cone-exact}. Thus, in the derived category the
...
Exercise~\ref{exer:homol:connecting-morphism-in-derived-category-from-ses}). Applying
...
\S{}\ref{subsec:homol:triangles}, without having to single out the
...
\S{}\ref{subsec:homol:triangles} turns out to be an artifact: placing
...
\S{}\ref{subsec:homol:universal-property-of-the-derived-functor} are
...
I mentioned in \S{}\ref{subsec:homol:exactness-of-the-total-complex}
...
\S{}\ref{subsec:homol:total-complexes-and-resolutions}. My motivation
...
(Exercise~\ref{exer:homol:derived-exact-couple-triangle-is-exact}).
...
Define\footnote{Here I am implicitly working in a category
  ...
  Theorem~\ref{thm:homol:freyd-mitchell-theorem}). The infinite unions and intersections used
...
(Exercise~\ref{exer:homol:limit-of-spectral-sequence-from-exact-couple})
...
\S{}\ref{subsec:groups2:the-jordan-h-older-theorem} are filtrations of
...
\]
As we know since
\S{}\ref{subsec:homol:the-long-exact-cohomology-sequence}, this
...
\begin{thm}{}{thm:homol:spectral-sequence-of-a-double-complex}
  ...
  \S{}\ref{subsec:homol:exactness-of-the-total-complex}, but it
...
\begin{proof}
  ...
  as stated.
\end{proof}
Theorem~\ref{thm:homol:spectral-sequence-of-a-double-complex} is a substantial generalization of
...
and by Theorem~\ref{thm:homol:spectral-sequence-of-a-double-complex} this says that
...
$1$ (Remark~\ref{rem:homol:spectral-sequence-differential-degree}); that is, $(i,j) \mapsto (i+r, j-(r-1))$.
...
from Theorem~\ref{thm:homol:spectral-sequence-of-a-double-complex}, is probably clearer from this point of
...
complex by Theorem~\ref{thm:homol:spectral-sequence-of-a-double-complex}. The other situation considered in
...
Exercise~\ref{exer:homol:spectral-seq-for-composite-derived-functors}.
...
\begin{exer}{\exerused{}}{exer:homol:mapping-cone-of-isomorphism-homotopy-trivial}
  ...
  equivalent to $0$. [\S{}\ref{subsec:homol:triangulated-categories},
...
\begin{exer}{\exerused{}}{exer:homol:mapping-cone-of-natural-morphism-is-shift}
  ...
  Exercise~\ref{exer:homol:mapping-cone-of-isomorphism-homotopy-trivial}
  first.) [\S{}\ref{subsec:homol:triangulated-categories}]
\end{exer}
...
\begin{exer}{\exerused{}}{exer:homol:connecting-morphism-in-derived-category-from-ses}
  ...
  cohomology. [\S{}\ref{subsec:homol:triangulated-categories}]
\end{exer}

\begin{exer}{\exerused{}}{exer:homol:derived-exact-couple-triangle-is-exact}
  Prove
  Claim~\ref{fact:homol:9.1}. [\S{}\ref{subsec:homol:spectral-sequences}]
\end{exer}
...
\begin{exer}{}{exer:homol:stabilization-of-vertical-spectral-sequence}
  ...
  \S{}\ref{subsec:homol:spectral-sequences}. Prove that
...
\begin{exer}{\exerused{}}{exer:homol:spectral-seq-for-composite-derived-functors}
  ...
  \S{}\ref{subsec:homol:spectral-sequences}. Prove that it abuts to
  $\categ{L}_\bullet(\mathscr{G} \circ \mathscr{F})(A)$.

  (Use the `horizontal' version of Theorem~\ref{thm:homol:spectral-sequence-of-a-double-complex}, together
