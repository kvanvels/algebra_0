...
cases are presented in \Cref{exer:rings:division-ring-p2-commutative,exer:groups2:2.17}, and the reader
eventually obtains a proof in \Cref{fields:exer:5.14}, following
preliminaries given in \Cref{fields:exer:5.12,fields:exer:5.13}. The \lnot
...
to assign \Cref{exer:irred:2.25} will be immediately aware that this exercise
is quoted in \Cref{fields:exer:5.18}, proving a particular case of
...
\ref{rem:rings:wedderburn} refers to Remark 1.16 in Chapter III; if the reference is
