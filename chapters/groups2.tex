...
theory; cf.\
\S{}\ref{sec:fields:short-march-through-applications-of-galois-theory}),
...
\[
  \rho(g, a) = gag^{-1}.
\]
As we know (\S{}\ref{subsec:groups:actions-on-sets}), this datum is
...
\S{}\ref{subsec:groups2:center-centralizer-conjugacy-classes}.
...
\begin{exer}{}{exer:groups2:p-group-action-has-fixed-points}
  ...
  points. [\S{}\ref{subsec:groups2:actions-of-groups-on-sets-reminder},
...
\begin{exer}{}{exer:groups2:quot-ctr-iso-inn}
  ...
  of
  \Cref{exer:groups:inn-cyclic-iff-abelian}. [\S{}\ref{subsec:groups2:center-centralizer-conjugacy-classes}]
\end{exer}
...
\begin{exer}{}{exer:groups2:noncomm-grp-ord-6-iso-s3}
  ...
  \end{itemize} [\S{} ef{subsec:groups2:the-class-formula}, \S{}
...
\S{}\ref{subsec:groups2:the-jordan-h-older-theorem}. Thus, it is
...
\begin{proof}[Proof of \cref{prop:groups2:sylow-i-strong}]
  ...
  By Cauchy's theorem\footnote{Note that, as mentioned in
    \S{}\ref{subsec:groups2:cauchy-s-theorem}, we only need the
  ...
  (\S{}\ref{subsec:groups:subgroups-of-quotients}, especially
...
\S{}\ref{subsec:groups2:sylow-ii}; but the proof given above is easy
...
\begin{proof}
  ...
  (cf.\ \S{}\ref{subsec:groups:subgroups-of-quotients}) of the form
...
\begin{exer}{}{exer:groups2:characteristic-subgrp-basics}
  ...
  \item Let $K$ be a normal subgroup of a finite group $G$, and assume
    ...
    characteristic in $G$.
  \end{itemize} [\S{} ef{subsec:groups2:cauchy-s-theorem}, \S{}
...
\begin{exer}{}{exer:groups2:simple-iff-only-triv-hom-images}
  ...
  itself (up to
  isomorphism). [\S{}\ref{subsec:groups2:composition-factors-schreier-s-theorem}]
\end{exer}
...
\begin{exer}{}{exer:groups2:alt-proof-third-sylow-thm}
  ...
  together an alternative proof of the third Sylow theorem. [\S{}
  ef{subsec:groups2:sylow-iii}]
\end{exer}
...
\begin{exer}{}{exer:groups2:noncomm-grp-ord-pq-structure}
  ...
  \end{itemize} [\S{} ef{subsec:groups2:applications}]
\end{exer}
...
(Exercise~\ref{exer:groups2:fin-grp-has-comp-series-z-does-not}). It
...
\begin{proof}
  ...
  normal in $G$
  (Exercise~\ref{exer:groups2:product-of-normal-subgrps-normal}), and
...
form a
multiset\footnote{See~\S{}\ref{subsec:prelims:examples-multisets-indexed-sets}
...
loose comment back in~\S{}\ref{sec:groups2:the-sylow-theorems}.  It is
...
(Exercise~\ref{exer:groups2:nonisom-grps-same-comp-factors}). One has
to take into account the way the simple groups are `glued' together;
we will come back to this point
in~\S{}\ref{subsec:groups2:exact-sequences-of-groups-extension-problem}.
...
\begin{proof}
  ...
  (Exercise~\ref{exer:groups2:simple-iff-only-triv-hom-images}), as
...
Exercise~\ref{exer:groups2:alt-proof-jordan-holder-via-schreier}).
...
in~\S{}\ref{subsec:groups2:the-jordan-h-older-theorem}.
...
\begin{exer}{}{exer:groups2:nonisom-grps-same-comp-factors}
  ...
  composition
  factors. [\S{}\ref{subsec:groups2:composition-factors-schreier-s-theorem}]
\end{exer}
\begin{exer}{}{exer:groups2:product-of-normal-subgrps-normal}
  ...
  $G$. [\S{}\ref{subsec:groups2:the-jordan-h-older-theorem}]
\end{exer}
...
\begin{exer}{}{exer:groups2:alt-proof-jordan-holder-via-schreier}
  ...
  theorem, using
  Schreier's. [\S{}\ref{subsec:groups2:composition-factors-schreier-s-theorem}]
\end{exer}
...
\begin{exer}{}{exer:groups2:nilp-grp-normal-subgrp-meets-ctr}
  ...
  $G$ (cf.\
  Exercise~\ref{exer:groups2:nilpotent-grp-upper-central-series}). Prove
  ...
  Exercise~\ref{exer:groups2:nontriv-norm-subgrp-meets-ctr}.
...
\begin{exer}{}{exer:groups2:derived-series-terms-characteristic}
  ...
  commutator, as
  in~\S{}\ref{subsec:groups2:the-commutator-subgroup-derived-series-and-solvability}. Prove
...
\begin{exer}{}{exer:groups2:solvable-grp-normal-subgrp-has-comm-normal}
  ...
  \item Prove that $H$ contains a nontrivial commutative subgroup that
    ...
    and use
    Exercise~\ref{exer:groups2:derived-series-terms-characteristic} to
    show it is normal in $G$.)
  \item Find an example showing that $H$ need not intersect the center
    of $G$ nontrivially (cf.\
    Exercise~\ref{exer:groups2:nilp-grp-normal-subgrp-meets-ctr}).
  \end{itemize}
\end{exer}
...
\begin{exer}{}{exer:groups2:grp-ord-lt-120-neq-60-solvable}
  ...
  solvable.  [\S{}\ref{subsec:groups2:conjugacy-an-simplicity},
  \S{}\ref{subsec:fields:solvability-of-polynomial-equations-by-radicals}]
\end{exer}
...
$\{1,\dots,n\}$. In~\S{}\ref{sec:groups:examples-of-groups} we denoted
...
Exercise~\ref{exer:groups2:conj-class-size-example-s8} now, and then
try again after absorbing the material
in~\S{}\ref{subsec:groups2:type-conjugacy-sn}. In short, we should be
...
agreed in~\S{}\ref{subsec:groups:symmetric-groups} that we would let
...
(cf.~\S{}\ref{subsec:groups2:center-centralizer-conjugacy-classes})
for $S_5$:
\[
...
\begin{exam}{}{exam:groups2:4.9}
  ...
  (\S{}\ref{subsec:groups2:the-class-formula}); since the identity is
...
\begin{proof}
  (Cf.\ Exercise~\ref{exer:groups2:idx-2-subgrp-conj-class-half}.)
...
\begin{exam}{}{exam:groups2:4.16}
  ...
  in~\S{}\ref{subsec:groups2:transpositions-parity-and-the-alternating-group}
...
(Exercise~\ref{exer:groups2:no-noncomm-simple-below-60}); and we now
...
(Exercise~\ref{exer:groups2:a6-simple-via-class-formula}). It is in
...
theory (cf., e.g., \Cref{coro:fields:7.16}). Note that $A_2$ is
trivial, $A_3 \cong \Z/3\Z$ is simple and abelian, and $A_4$ is not
simple (Exercise~\ref{exer:groups2:no-noncomm-simple-below-60}).
...
\begin{proof}
  ...
  (Exercise~\ref{exer:groups2:ctr-of-an-trivial}) and $3$-cycles
  ...
  (Exercise~\ref{exer:groups2:a6-simple-via-class-formula}), this
...
\begin{exer}{}{exer:groups2:conj-class-size-example-s8}
  ...
  \[
    ...
    \end{pmatrix}
  \]
  in $S_8$. [\S{} ef{subsec:groups2:cycle-notation}]
\end{exer}
...
(see~\S{}\ref{subsec:groups:products-et-al}); here we analyze this
...
Recall from~\S{}\ref{subsec:groups:products-et-al} that the
...
(see~\S{}\ref{subsec:groups2:the-commutator-subgroup-derived-series-and-solvability})
...
\begin{rem}{}{rem:groups2:5.4}
  ...
  \cref{prop:groups2:5.3} shows $HK \cong H \times K$. As
  $|HK| = |G| = pq$, this proves
...
in~\S{}\ref{subsec:rings:complexes-and-exact-sequences}. A (short)
...
$\Z$-modules) from
\S{}\ref{subsec:rings:complexes-and-exact-sequences}; a notational
...
in~\S{}\ref{subsec:rings:split-exact-sequences} for modules, thus for
...
\begin{exer}{}{exer:groups2:z-mult-2-seq-exact-not-split}
  ...
  split. [\S{}\ref{subsec:groups2:exact-sequences-of-groups-extension-problem}]
\end{exer}
...
\begin{exer}{}{exer:groups2:comm-semidirect-prod-is-direct}
  ...
  $G \cong N \times
  H$. [\S{}\ref{subsec:groups2:classification-of-finite-abelian-groups}]
\end{exer}
...
\begin{exer}{}{exer:groups2:d2n-as-semidirect-prod}
  ...
  explicitly. [\S{}\ref{subsec:groups2:internal-semidirect-products}]
\end{exer}
\begin{exer}{}{exer:groups2:classify-grps-ord-pq}
  ...
  $q$ is prime; cf.\ \Cref{exer:groups:aut-z-aut-cp}.) [\S{}
  ef{subsec:groups2:applications},
...
in~\S{}\ref{subsec:groups:example-subgroup-generated-by-a-subset}.
...
least as far back as\footnote{In fact, this observation will really
  ...
  Remainder Theorem, \Cref{thm:irred:6.1}.}
...
appearing in the first form of \cref{thm:groups2:6.6} are called the
...
of which\footnote{The diligent reader has proved that particular case
  ...
  order to prove statements such as \cref{thm:groups2:6.10}; the point
...
field can have at most $n$ linear factors, this shows\footnote{Unique
  ...
  this issue more formally later; cf.\ \Cref{lem:irred:5.1}.} that if
...
for finitely generated modules over PIDs, \Cref{linalg:5.6}. Neither
Gaussian elimination nor the very general \Cref{linalg:5.6} are any
...
\cref{lem:groups2:6.3} is absorbed into the work necessary to build up
...
\begin{exer}{}{exer:groups2:uniqueness-of-p-grp-decomp}
  ...
  [\S{}\ref{subsec:groups2:invariant-factors-and-elementary-divisors},
...
\begin{exer}{}{exer:groups2:dual-of-fin-abel-grp-iso-self}
  ...
  \item Prove that if $G$ is a finite abelian group, then
    ...
    case.)
  \end{itemize}
  In~\S{}\ref{subsec:linrep:ext-Z-G-Z} we will encounter another
