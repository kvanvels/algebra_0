...
\Cref{exer:groups2:p-group-action-has-fixed-points}. Such immediate consequences of
...
\end{lem}
\begin{proof}
  (Cf.\ \Cref{exer:groups2:quot-ctr-iso-inn}.) As $G/Z(G)$ is cyclic, there exists an element
...
\cref{lem:groups2:quotient-center-cyclic}; cf.\ \Cref{exer:groups2:abel-or-triv-ctr-of-grp-ord-comp}) that if
...
\cref{exer:groups2:p-grp-norm-subgrp-ord-pk}; in any case, the standard argument proving
...
\begin{proof}[Proof of \cref{prop:groups2:sylow-i-strong}]
  ...
  normal in $G$ (\cref{exer:groups2:subgrp-of-ctr-normal}). Therefore we can consider
...
\begin{proof}
  ...
  (\cref{exer:groups2:p-group-action-has-fixed-points}): let $gP$ be one of them. This means that
  $\forall h \in H$:
  \[
    hgP = gP;
  \]
...
\begin{exer}{}{exer:groups2:3.11}
  ...
  Exercise~\ref{exer:groups2:nontriv-norm-subgrp-meets-ctr}.  [\ref{exer:groups2:3.14}]
\end{exer}
