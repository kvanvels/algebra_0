...
group (end of \S{}III.5.2); a functor
...
\begin{exam}{}{linrep:exam:1.4}
  In \S{}III.4.3 I have defined the spectrum of a commutative ring
...
of a field (in \S{}VII.2.1) or whenever I have mentioned polynomial
...
\begin{exam}{}{linrep:exam:1.16}
  ...
  (\S{}II.5.2). What this really means is that for all sets $A$ and
...
\begin{exam}{(Exact functors)}{linrep:exam:1.18}
  ...
  (\S{}III.7.1), so let $R$, $S$ be rings and let
...
\begin{exer}{$*$}{linrep:exer:1.5}
  ...
  extension\footnote{Recall that there are no `zero-homomorphisms'
    between fields; cf.\ \S{}VII.1.1.}) to the restriction
...
the end of \S{}III.5.2). A tensor product $M \otimes_R N$ can only be
...
\begin{proof}
  ...
  $M \times N$ (\S{}III.6.3). This module comes equipped with a
...
\begin{exam}{}{linrep:exam:2.14}
  ...
  terms of coordinate rings (cf.\ \S{}VII.2.3), this map corresponds
...
\[
  ...
  \end{array}
\]
(This will be proven in gory detail in \S{}IX.7.) Tensor the two
...
\begin{exer}{$\lnot$}{linrep:exer:2.4}
  ...
  \S{}III.2.4. [\ref{linrep:exer:2.10}]
\end{exer}
...
\begin{exer}{}{linrep:exer:2.10}
  ...
  \end{itemize}
  (Use \Cref{linrep:2.8} to `compute' the tensor. The CRT from \S{}V.6.1
...
\begin{exer}{$?$}{linrep:exer:2.15}
  ...
  such that $rn = 0$ (cf.\ \S{}VI.4.1). (This is the reason why Tor is
...
\begin{exer}{}{linrep:exer:4.13}
  ...
  taking a formal derivative (as in \S{}VII.4.2). With the evident
...
\item One could start from a projective resolution of $M$:
  ...
  take cohomology,\footnote{Recall from \S{}III.7.1 that the homology
