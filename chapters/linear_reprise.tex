...
\begin{exam}{}{linrep:exam:1.4}
  ...
  topology to $\mathrm{Spec}(R)$ (\Cref{exer:linrep:spec-zariski-topology-is-functor}), making this example
...
in $\categ{D}$ (\Cref{exer:linrep:fully-faithful-reflects-iso}). For all intents and purposes, a fully
...
\begin{exam}{(Equalizers and kernels)}{linrep:exam:1.11}
  ...
  the reader will verify (\Cref{exer:linrep:construction-recovers-kernel}).
\end{exam}
...
more general posets (\Cref{exer:linrep:colimits-in-set-and-mod-directed-poset}). They are somewhat more explicit
...
\begin{exam}{(Exact functors)}{linrep:exam:1.18}
  ...
  image of every exact complex is exact (\Cref{exer:linrep:exact-functor-characterization}).
...
\end{prop}
As the reader will verify (\Cref{exer:linrep:right-adjoint-left-exact-left-adjoint-right-exact}), this follows from the fact
...
\begin{exer}{$\lnot$}{exer:linrep:presheaf-continuous-fns-gluing}
  ...
  making $\mathcal{C}$ a sheaf. [\ref{exer:homol:exp-map-not-epi-of-presheaves}]
\end{exer}
...
\begin{exer}{$\lnot$}{exer:linrep:yoneda-embedding-is-functor}
  ...
  action on morphisms in the natural way.) [\ref{exer:linrep:small-category-embeds-in-functor-category}, \ref{exer:homol:functor-category-into-abelian-is-abelian}]
\end{exer}
...
\begin{exer}{$\lnot$}{exer:linrep:yoneda-lemma}
  ...
  \emph{Yoneda lemma}.  [\ref{exer:linrep:small-category-embeds-in-functor-category}, \ref{exer:homol:yoneda-embedding-left-exact-reflects-exactness}]
\end{exer}

\begin{exer}{}{exer:linrep:small-category-embeds-in-functor-category}
  (Cf.\ \Cref{exer:linrep:yoneda-embedding-is-functor}.) Let $\categ{C}$ be a small category. A
  ...
  \Cref{exer:linrep:yoneda-lemma}.) Thus, every (small) category is equivalent to a
...
\begin{exer}{$\lnot$}{exer:linrep:i-adic-completion-exists}
  ...
  \end{itemize} [\ref{exer:linrep:intersection-of-ideal-powers-krull}, \ref{exer:linrep:p-adic-integers-basics}]
\end{exer}
...
\begin{exer}{}{exer:linrep:intersection-of-ideal-powers-krull}
  ...
  will prove this in \Cref{exer:linrep:intersection-of-ideal-powers-via-artin-rees}. Assume this, and prove that
  $\bigcap_n I^n$ equals the set of $r \in R$ such that $(1-a)r = 0$
  for some $a \in I$. (Hint: One inclusion is elementary. For the
  other, use the Nakayama lemma in the form of \Cref{exer:linalg:jm-eq-m-implies-1-plus-b-kills-m}. This
  ...
  $I$-adic completion is injective (cf.\ \Cref{exer:linrep:i-adic-completion-exists}).
\end{exer}

\begin{exer}{$\lnot$}{exer:linrep:p-adic-integers-basics}
  An important example of the construction presented in \Cref{exer:linrep:i-adic-completion-exists}
...
\begin{exer}{$\lnot$}{exer:linrep:zhat-iso-to-end-of-q-mod-z}
  ...
  elements of $\hat{\Z}$ may be described.) [\ref{exer:linrep:zhat-universal-property-product-of-zp}]
\end{exer}

\begin{exer}{}{exer:linrep:zhat-universal-property-product-of-zp}
  Let $\hat{\Z}$ be as in \Cref{exer:linrep:zhat-iso-to-end-of-q-mod-z}.
  \begin{itemize}
...
\begin{exer}{$\lnot$}{exer:linrep:exact-functor-characterization}
  ...
  complexes to exact complexes. [\S{}\ref{subsec:linrep:comparing-functors}, \ref{exer:homol:exact-functors-commute-with-cohomology}]
\end{exer}
...
\begin{exer}{$\lnot$}{exer:linrep:localization-is-exact-preserves-homology}
  Prove that localization (\Cref{exer:linrep:localization-is-a-functor}) is an exact functor. In fact,
  ...
  \[
    ...
    S^{-1}M_{i-1} \to \cdots.
  \] [\ref{exer:linrep:localization-is-flat}, \ref{exer:linrep:flatness-is-local-property}, \ref{exer:linrep:localization-commutes-with-tor}]
\end{exer}
...
\begin{exer}{$\lnot$}{exer:linrep:center-of-mod-category-iso-to-center-of-ring}
  ...
  isomorphic to the center of $R$. [\ref{exer:linrep:morita-equivalence-and-center}]
\end{exer}
...
is a pure tensor. See \Cref{exer:linrep:pure-tensor-if-n-cyclic} for one situation in which every
...
\begin{proof}
  ...
  (\Cref{exer:linrep:complete-proof-of-adjunction}) that the map $\alpha \mapsto \tilde\phi$ is
...
will take a look at localization in \Cref{exer:linrep:localization-is-tensor-with-localized-ring}.
...
$\Tor^R_0(M, N) \cong M \otimes_R N$ (\Cref{exer:linrep:tor0-iso-to-tensor-product}), and
...
$\Tor^R_2$ vanishes if $R$ is a PID; cf.\ \Cref{exer:linrep:tor-vanishes-above-degree-1-over-pid}).

Note that $\Tor^k_i$ vanishes for $i > 0$ if $k$ is a field,
as vector spaces are flat, and $\Tor^R_i$ vanishes for $i > 1$
if $R$ is a PID (\Cref{exer:linrep:tor-vanishes-above-degree-1-over-pid}). These facts are not surprising, in
...
\begin{exer}{$\lnot$}{exer:linrep:tensor-of-algebras-is-coproduct}
  ...
  \S{}\ref{subsec:rings:products}. [\ref{exer:linrep:f-tensor-f-separable-galois-criteria}]
\end{exer}
\begin{exer}{$?$}{exer:linrep:localization-is-tensor-with-localized-ring}
  ...
  [\S{}\ref{subsec:linrep:adjunction-with-hom-and-explicit-computations}, \ref{exer:linrep:dim-of-m-tensor-k-equals-rank}, \ref{exer:linrep:localization-is-flat}, \ref{exer:linrep:reprove-localization-tensor-via-associativity}]
\end{exer}
\begin{exer}{$\lnot$}{exer:linrep:tensor-and-localization-commute}
  ...
  associativity of tensor products; cf.\ \Cref{exer:linrep:associativity-of-tensor-product}.) [\ref{exer:linrep:flatness-is-local-property}, \ref{exer:linrep:reprove-localization-tensor-via-associativity}]
\end{exer}
...
\begin{exer}{}{exer:linrep:dim-of-m-tensor-k-equals-rank}
  ...
  $V := M \otimes_R K$ is a $K$-vector space (\Cref{exer:linrep:localization-is-tensor-with-localized-ring}). Prove
...
\begin{exer}{$?$}{exer:linrep:tor1-r-torsion-of-n}
  ...
  called Tor.) [\S{}\ref{subsec:linrep:the-tor-functors}, \ref{exer:linrep:why-ext-is-called-ext-part1}]
\end{exer}
...
\begin{exer}{$\lnot$}{exer:linrep:flatness-criterion-via-monomorphisms}
  ...
  ideals $I$ of $R$. [\ref{exer:linrep:flat-iff-torsion-free-over-pid}]
\end{exer}
\begin{exer}{}{exer:linrep:flat-iff-torsion-free-over-pid}
  ...
  Otherwise, use \Cref{exer:linrep:flatness-criterion-via-monomorphisms}.) Geometrically, this says roughly that
...
\begin{exer}{$\lnot$}{exer:linrep:flatness-is-local-property}
  ...
  isomorphic to $K_{\mathfrak{m}}$, and use \Cref{exer:irred:module-zero-iff-zero-locally}.) [\ref{exer:linrep:localization-commutes-with-tor}]
\end{exer}
\begin{exer}{$\lnot$}{exer:linrep:localization-commutes-with-tor}
  ...
  \Tor^{S^{-1}R}_i(S^{-1}M, S^{-1}N)$. (Use \Cref{exer:linrep:localization-is-exact-preserves-homology}.)
  Use this fact to give a leaner proof that flatness is a local
  property (\Cref{exer:linrep:flatness-is-local-property}). [\ref{exer:linrep:flat-iff-tor1-vanishes-at-maximal-ideals}]
\end{exer}
\begin{exer}{$?$}{exer:linrep:flat-in-exact-sequence-with-flat-quotient}
  ...
  \item Prove that for all $R$-modules $Q$, the induced sequence
    ...
    exact.
  \end{itemize} [\ref{exer:linrep:fin-gen-flat-over-noeth-local-is-free}, \S{}\ref{subsec:linrep:duality-and-exactness}]
\end{exer}
\begin{exer}{$\lnot$}{exer:linrep:fin-gen-flat-over-noeth-local-is-free}
  ...
  \item Prove that this sequence induces an exact sequence
    ...
    M/\mathfrak{m}M \to 0$. (Use \Cref{exer:linrep:flat-in-exact-sequence-with-flat-quotient}.)
  ...
  flat if and only if it is free. Compare with \Cref{exer:linalg:direct-summand-of-free-over-local-is-free}.
  [\ref{exer:linrep:flat-iff-tor1-vanishes-at-maximal-ideals}, \ref{exer:linrep:combine-results-reprove-rank-thm}, \ref{exer:linrep:fin-gen-over-noeth-locally-free-iff-projective-iff-flat}]
\end{exer}
...
\begin{exer}{}{exer:linrep:flat-iff-tor1-vanishes-at-maximal-ideals}
  ...
  $\mathfrak{m}$ of $R$. (Use \Cref{exer:linrep:flatness-is-local-property}, and refine the argument
  you used in \Cref{exer:linrep:fin-gen-flat-over-noeth-local-is-free}; remember that Tor localizes, by
  \Cref{exer:linrep:localization-commutes-with-tor}. The Noetherian hypothesis is actually unnecessary,
...
$R^{\oplus(M \times N)}$. The reader will verify (\Cref{exer:linrep:flat-iff-tor1-vanishes-at-maximal-ideals}) that
...
\begin{exer}{$?$}{exer:linrep:associativity-of-tensor-product}
  ...
  \]
  In this sense, $\otimes$ is `associative'. [\ref{exer:linrep:reprove-localization-tensor-via-associativity}, \S{}\ref{subsec:linrep:multilinear-symmetric-alternating-maps}]
\end{exer}
\begin{exer}{$?$}{exer:linrep:reprove-localization-tensor-via-associativity}
  Use the associativity of the tensor product (\Cref{exer:linrep:canonical-map-tensor-restriction-of-scalars}) to prove
  again the formulas given in \Cref{exer:linrep:tensor-and-localization-commute}. (Use \Cref{exer:linrep:localization-is-tensor-with-localized-ring}.) [\ref{exer:linrep:tensor-and-localization-commute}]
\end{exer}
...
\begin{exer}{}{exer:linrep:onto-hom-explicit-restriction-extension-scalars}
  ...
  \item Prove that, for all $R$-modules $M$,
    ...
    $f^*(M) \cong M/IM$. (\Cref{exer:rings:hom-contravariant-left-exact-from-ses} may help.)
...
\begin{exer}{}{exer:linrep:morita-equivalence-and-center}
  ...
  case worked out in this exercise. Recall (\Cref{exer:linrep:center-of-mod-category-iso-to-center-of-ring}) that if $R$
...
tensor product is associative\footnote{In fact, the tensor product is
  associative in a fancier sense; cf.\ \Cref{exer:linrep:canonical-map-tensor-restriction-of-scalars}.} in
...
m_\ell$.  The reader will verify (\Cref{exer:linrep:wedge-power-universal-property-and-sym-power}) that
...
\begin{proof}
  ...
  evidently alternating (\Cref{exer:linrep:multilinear-map-phi-i-alternating}). Thus, it factors uniquely
...
\begin{exam}{}{linrep:4.7}
  ...
  field $k$ (\Cref{exer:linrep:rees-algebra-example-iso-to-quotient}), which is the simplest interesting
...
\begin{proof}
  ...
  (ii)$\iff$(iii) is left to the reader (\Cref{exer:linrep:graded-algebra-lemma-equivalence}).
...
\begin{rem}{}{linrep:4.11}
  ...
  \]
  (\Cref{exer:linrep:skew-commutativity-of-exterior-algebra}), where I use $\wedge$ to denote the operation in
...
\[
  ...
  \mathrm{S}^*_R(N) \to 0
\]
is exact. This is often useful in computations (cf.\ \Cref{exer:linrep:rees-algebra-example-iso-to-quotient}). I
...
\begin{exer}{$\lnot$}{exer:linrep:plucker-embedding-well-defined}
  ...
  $\ell$-di\-men\-sional subspaces of $V$ (\Cref{exer:linalg:grassmannian-cell-decomposition}) to the
  ...
  \emph{Pl\"ucker embedding} of the Grassmannian. [\ref{exer:linrep:grassmannian-2-4-as-projective-quadric}]
\end{exer}

\begin{exer}{}{exer:linrep:grassmannian-2-4-as-projective-quadric}
  The Pl\"ucker embedding described in Exercise~\ref{exer:linrep:plucker-embedding-well-defined}
  ...
  Exercise~\ref{exer:linrep:homog-ideal-vanishing-well-defined-proj-set}) via the corresponding Pl\"ucker
  embeddings.
...
\begin{exer}{$\lnot$}{exer:linrep:homog-ideal-vanishing-well-defined-proj-set}
  ...
  irreverently called the \emph{irrelevant ideal}. [\ref{exer:linrep:grassmannian-2-4-as-projective-quadric}, \ref{exer:linrep:weak-homogeneous-nullstellensatz}]
\end{exer}

\begin{exer}{}{exer:linrep:weak-homogeneous-nullstellensatz}
  (Cf.\ Exercise~\ref{exer:linrep:homog-ideal-vanishing-well-defined-proj-set}.) Prove the `weak homogeneous
...
\begin{exer}{$\lnot$}{exer:linrep:rees-algebra-is-noetherian}
  ...
  Noetherian if $R$ is Noetherian. [\ref{exer:linrep:artin-rees-lemma}]
\end{exer}
...
\begin{exer}{$\lnot$}{exer:linrep:artin-rees-lemma}
  ...
  By Exercise~\ref{exer:linrep:rees-algebra-is-noetherian}, $\mathrm{Rees}_R(I)$ is
  Noetherian.
  \begin{itemize}
  ...
  \item Prove that $J_{s+\ell} = I^\ell J_s$ for all $\ell \geq 0$.
    This is a particular case of the `Artin-Rees' lemma. [\ref{exer:linrep:intersection-of-ideal-powers-via-artin-rees}]
  \end{itemize}
\end{exer}
...
\begin{exer}{$\lnot$}{exer:linrep:intersection-of-ideal-powers-via-artin-rees}
  ...
  (Hint: Exercise~\ref{exer:linrep:artin-rees-lemma}.) [\ref{exer:linrep:intersection-of-ideal-powers-krull}]
\end{exer}
...
\begin{exer}{}{exer:linrep:rees-algebra-example-iso-to-quotient}
  ...
  $k[x,y]$-module; for this, looking back at \Cref{exer:linalg:free-resolution-of-z-over-zxy} may
...
in the distant past (\Cref{exer:rings:hom-contravariant-left-exact-from-ses}), without appealing to
...
be crystal clear to the reader who works out \Cref{exer:linrep:direct-computation-dual-of-free-module}. In
...
\end{equation}
since the dual of $\Z/2\Z$ is zero (\Cref{exer:linrep:z2z-dual-is-zero}). The map $\gamma$ in
...
case of \Cref{exer:rings:exact-seq-with-free-quotient-splits} and, further, it is a consequence of Exercise
...
The diligent reader has proved this already in \Cref{exer:linalg:hom-torsion-free-if-target-torsion-free} and
...
this by working out \Cref{exer:linrep:compute-dual-of-fin-gen-module-over-pid}.  Even if not every module is the
...
sending $(f, m)$ to $f(m)$. For every $m \in M$, we get\footnote{The
  ...
  formally by working out \Cref{exer:linrep:canonical-bijection-hom-dual-swap}.} an $R$-linear map
...
$\omega$ (\Cref{exer:linrep:composition-of-isos-is-canonical-biduality-map}) and $\omega$ knows nothing about choices of
...
foregoing observations (including \Cref{exer:linrep:hom-from-free-iso-dual-tensor-n}) for this particular
...
\begin{exer}{$\lnot$}{exer:linrep:epi-mono-characterization-via-hom}
  ...
  $\alpha^*$ is surjective for all $N$. [\ref{exer:linrep:exactness-criterion-via-hom-dual}, \ref{exer:linrep:injective-iff-hom-surjective-for-injectives}]
\end{exer}
...
\begin{exer}{}{exer:linrep:exactness-criterion-via-hom-dual}
  ...
  already, in \Cref{exer:linrep:epi-mono-characterization-via-hom}. To show
...
\begin{exer}{$\lnot$}{exer:linrep:hom-i-r-mod-i-restriction-map-zero}
  ...
  bundle' in good situations.)  [\ref{exer:linrep:ext1-of-quotient-iso-to-hom-normal-bundle}]
\end{exer}
...
\begin{exer}{}{exer:linrep:nondegenerate-nonsingular-bilinear-forms}
  ...
  \Cref{exer:linalg:on-r-iff-orthonormal-columns-rows}) is nondegenerate. If $M$ is free of rank $n$, let
...
\begin{exer}{$\lnot$}{exer:linrep:annihilator-of-subspace-basics}
  ...
  The \emph{annihilator} of $W$ is\footnote{The notation is inspired
    by \Cref{exer:linalg:orthogonal-complement-is-subspace-dim-n-minus-1}, which is a particular case of this
  ...
  $W$. [\ref{exer:linrep:annihilator-iso-dual-via-exact-seq-free}, \ref{exer:linrep:grassmannian-bijection-with-dual-grassmannian}]
\end{exer}
...
\begin{exer}{}{exer:linrep:annihilator-iso-dual-via-exact-seq-free}
  ...
  the notation introduced for vector spaces in \Cref{exer:linrep:annihilator-of-subspace-basics}, prove
...
\begin{exer}{$\lnot$}{exer:linrep:grassmannian-bijection-with-dual-grassmannian}
  ...
  $r$-dimensional subspaces of $V$ (cf.\ \Cref{exer:linalg:grassmannian-cell-decomposition}) and the
  Grassmannian $\mathrm{Gr}(n-r, V^\vee)$ of $(n-r)$-dimensional
  subspaces of the dual of $V$. (Use \Cref{exer:linrep:annihilator-of-subspace-basics}.) In particular,
...
the enterprising reader (\Cref{exer:linrep:projective-injective-splitting-characterization}).
...
that projective modules are flat is straightforward (\Cref{exer:linrep:projective-modules-are-flat-via-adjunction}),
...
in \Cref{exer:linrep:fin-gen-over-noeth-locally-free-iff-projective-iff-flat}.
...
\begin{rem}{}{linrep:6.10}
  Similarly, $f^*$ preserves projectives (\Cref{exer:linrep:restriction-of-scalars-of-projective-is-projective}).
\end{rem}
...
\begin{rem}{}{linrep:6.13}
  ...
  Corollary~\ref{linrep:6.11} and \Cref{exer:linrep:direct-sum-of-injectives-iff-each-is}).  That is, products
...
\item The conclusion is that $\Ext^0_{\Z}(G, \Z)$ picks up the
  ...
  $i \geq 2$ (as should have been expected; cf.\ \Cref{exer:linrep:ext-vanishes-above-degree-1-over-pid}).
\end{itemize}
...
\begin{exer}{$\lnot$}{exer:linrep:injective-iff-hom-surjective-for-injectives}
  ...
  injectives.) This strengthens the result of \Cref{exer:linrep:epi-mono-characterization-via-hom}.  [\ref{exer:linrep:projective-modules-are-flat-via-adjunction}]
\end{exer}
...
\begin{exer}{$*$}{exer:linrep:projective-modules-are-flat-via-adjunction}
  ...
  \Cref{exer:linrep:injective-iff-hom-surjective-for-injectives}.) [\S{}\ref{subsec:linrep:projective-modules}, \ref{exer:linrep:combine-results-reprove-rank-thm}]
\end{exer}
...
\begin{exer}{}{exer:linrep:fin-gen-over-pid-free-iff-projective-iff-flat}
  ...
  hand', without invoking \Cref{exer:linrep:fin-gen-over-noeth-locally-free-iff-projective-iff-flat}.)
\end{exer}
...
\begin{exer}{$\lnot$}{exer:linrep:fin-gen-over-local-ring-projective-iff-free}
  ...
  in \Cref{exer:linalg:direct-summand-of-free-over-local-is-free}.) Besides PIDs and local rings, there are other
...
\begin{exer}{$\lnot$}{exer:linrep:fin-gen-over-noeth-locally-free-iff-projective-iff-flat}
  ...
  of finite generation is necessary (cf.\ \Cref{exer:linrep:q-is-flat-not-projective-as-z-module}).  [\ref{exer:linrep:fin-gen-over-pid-free-iff-projective-iff-flat}]
\end{exer}
...
\begin{exer}{}{exer:linrep:ext1-of-quotient-iso-to-hom-normal-bundle}
  ...
  \Cref{exer:linrep:hom-i-r-mod-i-restriction-map-zero}. This says that this Ext module essentially computes
  the normal bundle of an embedding.)
\end{exer}

\begin{exer}{$\lnot$}{exer:linrep:why-ext-is-called-ext-part1}
  In \Cref{exer:linrep:tor1-r-torsion-of-n} we have seen why Tor is called Tor. Why is Ext
  ...
  then be an isomorphism: cf.\ \Cref{exer:rings:short-five-lemma-via-snake-lemma}.) Extensions that are
...
\begin{exer}{}{exer:linrep:ext1-bijection-with-extensions}
  \Cref{exer:linrep:why-ext-is-called-ext-part1} teaches us that extensions determine elements of
