...
\begin{exer}{\exerused{}}{exer:homol:total-differential-squares-to-zero}
  ...
  \Cref{prop:homol:total-complex-is-a-complex}). [\S{}\ref{subsec:homol:complexes-of-complexes}]
\end{exer}
...
\begin{exer}{\exerused{}}{exer:homol:total-complex-of-mn-is-mapping-cone}
  Prove
  \Cref{prop:homol:total-complex-of-cone-is-mapping-cone-of-totalizations}. [\S{}\ref{subsec:homol:total-complexes-and-resolutions}]
\end{exer}
...
\begin{exer}{\exerused{}}{exer:homol:derived-exact-couple-triangle-is-exact}
  Prove
  \Cref{fact:homol:9.1}. [\S{}\ref{subsec:homol:spectral-sequences}]
\end{exer}
