...
(\Cref{linrep:exam:1.11}). Here are those definitions again, expanded
for intelligibility:
...
\begin{exer}{}{exer:homol:categorical-cokernel-definition}
  ...
  definition for kernel given in \Cref{linrep:exam:1.11}, and verify
...
\begin{exer}{}{exer:homol:presheaves-valued-in-abelian-form-abelian}
  ...
  (\Cref{linrep:exam:1.5}). Define the \emph{category} of
...
\Cref{linrep:1.6}. Briefly, a functor $F : \categ{A} \to \categ{C}$ is
...
General remarks such as \Cref{linrep:6.2} or the comments about
...
\Cref{linrep:6.4}) and enough injectives (this is challenging; we
verified it in \Cref{linrep:6.12}).
...
\begin{rem}{}{rem:homol:6.8}
  ...
  isomorphism\footnote{`Natural transformations' were rapidly defined
    ...
    \Cref{linrep:1.15}. They are the most sensible notion of a
...
then remember \Cref{linrep:1.19}. The reader should in fact
