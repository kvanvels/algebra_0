...
$\Tor^R_0(M, N) \cong M \otimes_R N$ (Exercise~2.14), and
...
$\Tor^R_2$ vanishes if $R$ is a PID; cf.\ Exercise~2.17).
...
\begin{exer}{}{linrep:exer:2.16}
  ...
  $\Tor^R_1$ vanishes if $I + J = R$, by Lemma~V.6.3.)  Prove
...
\begin{exer}{$\lnot$}{linrep:exer:2.22}
  ...
  \Tor^{S^{-1}R}_i(S^{-1}M, S^{-1}N)$. (Use Exercise~1.25.)
