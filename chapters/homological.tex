...
The limited exposure to the Tor and Ext functors given in \S{}\ref{sec:linrep:tensor-products-and-the-tor-functors}
and \S{}\ref{sec:linrep:projective-and-injective-modules-and-the-ext-functors} should assist the reader in occasional encounters with
...
(co)homology': what information in a complex (see \S{}\ref{sec:rings:complexes-and-homology}) is really
...
\item Products, coproducts may not exist (if the product of
  $\F_2$ and $\F_3$ existed in $\categ{Fld}$, what
...
\item Even when there are kernels and cokernels, monomorphisms need
  ...
  \S{}\ref{subsec:groups:kernel-iff-normal}), and epimorphisms need not be cokernels (the injection
  $\Z \to \Q$ is an epimorphism in $\categ{Ring}$; see \S{}\ref{subsec:rings:monomorphisms-and-epimorphisms}).
...
exact sequences, and the like: the material covered in \S{}\ref{sec:rings:complexes-and-homology} will
...
\S{}\ref{subsec:homol:what-is-missing}) will provide a mathematical reason supporting this
psychological fact.
...
\begin{defn}{}{homol:1.1}
  ...
  Hom-sets.
\end{defn}
None of the categories mentioned in the list in \S{}\ref{subsec:homol:undesirable-features-of-otherwise-reasonable-categories} is additive.
...
epimorphism is the appropriate replacement. Recall (\S{}\ref{subsec:prelims:functions:monomorphisms-and-epimorphisms}) that
...
this: the opposite (cf.\ \Cref{exer:prelim:op-categ-def}) of an additive category is
...
submodule' of \S{}\ref{subsec:rings:submodules-and-quotients} vintage: in abelian categories, the slogan
...
\begin{rem}{}{homol:1.10}
  ...
  reader will encounter in \Cref{exer:homol:category-of-short-exact-sequences-properties} an example of an additive
...
of \S{}\ref{sec:homol:working-in-abelian-categories}), since the objects of an abelian category are not given as
...
straightforward than what follows (\Cref{exer:homol:finite-products-coproducts-coincide-additive}). Here I will prove
...
I will happily leave this to the reader (\Cref{exer:homol:coproduct-to-product-map-is-epi}).
...
the decompositions studied in $\categ{Set}$ (\S{}\ref{subsec:prelims:canonical-decomposition}), $\categ{Grp}$
(\S{}\ref{subsec:groups:canonical-decomposition}), $\categ{Ring}$ (\S{}\ref{subsec:rings:canonical-decomposition-and-consequences}), $R\text{-}\categ{Mod}$
(\S{}\ref{subsec:rings:canonical-decomposition-and-isomorphism-theorems}). In each of these previous examples we could simply
...
satisfied by $\operatorname{coim}\varphi$ (\Cref{exer:homol:universal-property-of-coimage}). With the
...
\begin{exer}{$\lnot$}{exer:homol:preadditive-one-object-is-ring}
  ...
  functor' between preadditive categories makes sense.  [\ref{exer:homol:r-mod-equiv-additive-functors-on-r}]
\end{exer}
...
\begin{exer}{$\lnot$}{exer:homol:functor-category-into-abelian-is-abelian}
  ...
  $\categ{A}^{\categ{C}}$ (cf.\ \Cref{exer:linrep:yoneda-embedding-is-functor}) is an abelian
  category.
  ...
  an exact functor
  $\mathscr{X} : \categ{A}^{\categ{C}} \to \categ{A}$. [\ref{exer:homol:r-mod-equiv-additive-functors-on-r}, \ref{exer:homol:presheaves-valued-in-abelian-form-abelian},
  \ref{exer:homol:exp-map-not-epi-of-presheaves}, \ref{exer:homol:contravariant-additive-functors-category-abelian}, \ref{exer:homol:right-adjoint-functor-category-construction}]
\end{exer}
\begin{exer}{}{exer:homol:r-mod-equiv-additive-functors-on-r}
  For a ring $R$, let $\categ{R}$ denote the preadditive category with
  a single object determined by $R$ (\Cref{exer:homol:preadditive-one-object-is-ring}). Prove that the
  ...
  category $\categ{Ab}^{\categ{R}}$ (cf.\ \Cref{exer:homol:functor-category-into-abelian-is-abelian}). What about
...
\begin{exer}{}{exer:homol:presheaves-valued-in-abelian-form-abelian}
  ...
  abelian category form an abelian category. (Hint: \Cref{exer:homol:functor-category-into-abelian-is-abelian}.)
\end{exer}
\begin{exer}{}{exer:homol:exp-map-not-epi-of-presheaves}
  Consider the presheaf of continuous complex-valued functions
  $\mathscr{C}$ on a circle $S^1$ (cf.\ \Cref{exer:linrep:presheaf-continuous-fns-gluing}) and the
  ...
  presheaves\footnote{Watch out! Both presheaves $\mathscr{C}$,
    ...
    \Cref{exer:linrep:presheaf-continuous-fns-gluing}. Sheaves of abelian groups form a full
    ...
    particular case of \Cref{exer:homol:functor-category-into-abelian-is-abelian}), but the example given above
...
\begin{exer}{}{exer:homol:pullback-kernel-comparison-iso}
  ...
  State and prove an analogous result for push-outs. [\S{}\ref{subsec:homol:products-coproducts-and-direct-sums},
  \S{}\ref{subsec:homol:the-snake-lemma-again}, \S{}\ref{subsec:homol:from-objects-to-complexes}]
\end{exer}
...
notion of exactness of a sequence of $R$-modules, in \S{}\ref{subsec:rings:complexes-and-exact-sequences}. All
...
in \S{}\ref{subsec:homol:additive-categories}--1.3. With notation as above, if the sequence is exact at
...
category of all the statements given in \S{}\ref{sec:rings:complexes-and-homology} for sequences of
...
reviewed in \S{}\ref{sec:homol:complexes-and-homology-again}. However, note that while we can now \emph{state}
the snake lemma (\Cref{lem:rings:snake-lemma}) in any abelian category, the (sketch
of the) \emph{proof} given in \S{}\ref{sec:rings:complexes-and-homology} cannot be directly lifted from
that context and applied to this one, or so it would seem, since the
definition of the `snaking' homomorphism $\delta$ given in \S{}\ref{sec:rings:complexes-and-homology}
...
(Example~\ref{homol:2.2}). By \Cref{exer:homol:pullback-kernel-comparison-iso},
...
for fibered coproducts (\Cref{exer:homol:pushout-preserves-monomorphism}).  Going back to the snake lemma,
...
reader (who may want to wait until we go through \S{}\ref{subsec:homol:working-with-elements-in-a-small-abelian-category}).  The
...
$\ker\beta_1'$ have matching sources by \Cref{exer:homol:pullback-kernel-comparison-iso}. Analogous
...
\S{}\ref{subsec:rings:homology-and-the-snake-lemma}. Together with maps induced by simpler considerations, we
...
However, assuming that we have already done this work in \S{}\ref{subsec:rings:homology-and-the-snake-lemma},
...
construction in \S{}\ref{subsec:rings:homology-and-the-snake-lemma}. Such issues are usually resolved once and
...
from the diagrammatic point of view. \Cref{exer:homol:quotient-iso-image-kernel-two-morphisms} gives another
...
theorem (discussed in \S{}\ref{subsec:homol:what-is-missing}) will obliterate the actual usefulness
...
should feel free to skip this material and jump directly to \S{}\ref{subsec:homol:what-is-missing}.
...
back at the brief discussion at the end of \S{}\ref{subsec:linrep:examples-of-functors}: the `functor
...
with the aid of the connecting morphism defined in \S{}\ref{subsec:homol:the-snake-lemma-again} may be
...
really strictly necessary; I will come back to this point in \S{}\ref{subsec:homol:what-is-missing}.
The construction can be given as an application of the abstract
language developed in \S{}\ref{sec:linrep:preliminaries-reprise}; but I promise that the resulting
...
reader should check carefully (\Cref{exer:homol:element-relation-is-equivalence-relation}).  Now I want to make the
...
$0$, which we can do\footnote{Note that I am not saying that
  ...
  \Cref{exer:homol:element-functor-not-faithful}).} at the level of pointed sets (hence, by chasing
...
\begin{proof}
  ...
  the first statement (\Cref{exer:homol:mono-iff-injective-on-elements}), and I will prove the second.
...
\begin{proof}
  ...
  (\Cref{exer:homol:elements-of-kernel-identified-with-preimage}). For the image, recall that we have a decomposition
  of $\varphi$,
  \[\begin{tikzcd}
  ...
  `image' (cf.\ \S{}\ref{subsec:homol:images-canonical-decomposition-of-morphisms}); the fact that $A \to I$ is an epimorphism is
...
\item The functor $\categ{A} \to \categ{Set}^*$ is not \emph{full};
  ...
  performed in \S{}\ref{subsec:homol:the-snake-lemma-again} in order to construct the connecting morphism
...
functor is automatically faithfully exact; see \Cref{exer:homol:faithful-exact-implies-faithfully-exact}):
everything we laboriously checked in \S{}\ref{subsec:homol:working-with-elements-in-a-small-abelian-category} for our poor man's
...
morphism' discussed in \S{}\ref{subsec:homol:the-snake-lemma-again}. Monomorphisms really can be
...
considerations will play a role in \S{}\ref{sec:homol:the-homotopic-category-complexes-of-projectives-and} and following). In the rest
...
simpler considerations of \S{}\ref{subsec:homol:working-with-elements-in-a-small-abelian-category}.
...
\begin{exer}{$\lnot$}{exer:homol:short-five-lemma}
  Prove the `short five-lemma' (cf.\ \Cref{exer:rings:short-five-lemma-via-snake-lemma}) in any abelian
...
\begin{exer}{}{exer:homol:element-relation-is-equivalence-relation}
  \exerused{} Prove that the relation used in \S{}\ref{subsec:homol:working-with-elements-in-a-small-abelian-category} to define the
...
\begin{exer}{$\lnot$}{exer:homol:id-and-neg-id-same-element}
  ...
  in the sense of \S{}\ref{subsec:homol:working-with-elements-in-a-small-abelian-category}. [\ref{exer:homol:element-functor-not-faithful}]
\end{exer}
\begin{exer}{}{exer:homol:element-relation-not-compatible-with-addition}
  Prove that the equivalence relation $\sim$ introduced in \S{}\ref{subsec:homol:working-with-elements-in-a-small-abelian-category}
...
\begin{exer}{}{exer:homol:element-functor-not-faithful}
  ...
  defined in \S{}\ref{subsec:homol:working-with-elements-in-a-small-abelian-category} is not faithful in general. (Use \Cref{exer:homol:id-and-neg-id-same-element}.)
...
\begin{exer}{}{exer:homol:five-lemma}
  Upgrade the result of \Cref{exer:homol:short-five-lemma}, by proving the
  \emph{five-lemma}: if
  \[\begin{tikzcd}
  ...
  `elements' and the material developed in \S{}\ref{subsec:homol:working-with-elements-in-a-small-abelian-category}.
\end{exer}
...
\begin{exer}{}{exer:homol:fin-dim-vector-spaces-not-fully-embeddable-in-ab}
  By refining the construction in \S{}\ref{subsec:homol:working-with-elements-in-a-small-abelian-category}, one can show that every
  ...
  \End_{\R\text{-}\categ{Vect}}(\R)$.  But look at \Cref{exer:linalg:end-a-field-char-0-implies-a-iso-q}.)
\end{exer}
\begin{exer}{$\lnot$}{exer:homol:full-abelian-subcategory-characterization}
  ...
  \end{itemize} [\ref{exer:homol:contravariant-additive-functors-category-abelian}, \ref{exer:homol:yoneda-embedding-left-exact-reflects-exactness}, \ref{exer:homol:category-of-cochain-complexes-is-abelian}]
\end{exer}
\begin{exer}{$\lnot$}{exer:homol:contravariant-additive-functors-category-abelian}
  ...
  2.14.) [\ref{exer:homol:yoneda-embedding-left-exact-reflects-exactness}]
\end{exer}
...
\begin{exer}{}{exer:homol:yoneda-embedding-left-exact-reflects-exactness}
  Upgrade the Yoneda lemma (\Cref{exer:linrep:yoneda-lemma}) to prove that every
  small abelian category $\categ{A}$ is equivalent to a full
  subcategory of the category $\categ{F}$ of \Cref{exer:homol:contravariant-additive-functors-category-abelian}, by means
  ...
  thus, \Cref{exer:homol:full-abelian-subcategory-characterization} doesn't help), and the Yoneda embedding of
...
fixed abelian category $\categ{A}$; by what we have seen in \S{}\ref{sec:homol:working-in-abelian-categories}, we
...
I will start off with a reminder of what we did in \S{}\ref{subsec:rings:complexes-and-exact-sequences}. Once
...
of an application. In \S{}\ref{sec:rings:complexes-and-homology} I chose homology; in this chapter I
...
$\image d^{i-1} \subseteq \ker d^i$. The complex is
\emph{exact} at $M^i$ if $\image d^{i-1} = \ker d^i$; it is
...
\[
  ...
  \longrightarrow \dots
\]
is a resolution of $A$ if $\coker d^{-1} \cong A$, and
...
resolution (\Cref{exer:homol:resolution-gives-exact-truncated-complexes}). Note that the datum of a bounded-above
...
resolutions, in \S{}\ref{subsec:linalg:finitely-presented-modules-and-free-resolutions}.  The complex $\iota(A)$,
\[
...
$\Tor^R_i(M, N)$ (cf. \S{}\ref{subsec:linrep:the-tor-functors}). Algebraic topology
...
have in fact claimed (in \S{}\ref{subsec:linrep:the-ext-functors}) that resolutions by
...
\begin{proof}
  ...
  (\Cref{exer:homol:category-of-cochain-complexes-is-abelian}). In broad terms, morphisms between two given
...
will be important later on (\S{}\ref{subsec:homol:complexes-of-complexes}).
...
\item $\categ{C}^+(\categ{A})$ denote the full\footnote{That is,
    ...
    \Cref{exer:prelim:subcat}.} subcategory of $\categ{C}(\categ{A})$ determined
...
(see \S{}\ref{subsec:homol:complexes-of-projective-and-injective-objects}); thus, $\categ{C}^{\leq 0}(\categ{P})$,
...
defined by setting\footnote{The sign in the differentials is inserted
  ...
  change the isomorphism class of the complex (\Cref{exer:homol:sign-change-differential-isomorphic-complex}).}
...
\begin{proof}
  ...
  \]
  This morphism is $0$ when restricted to $\image d^{i-1}$,
...
\S{}\ref{subsec:rings:complexes-and-exact-sequences} is the famous snake lemma, \Cref{lem:rings:snake-lemma}, which has come
back to entertain us in \S{}\ref{subsec:homol:the-snake-lemma-again}. Written cohomologically and with the
benefit of the language introduced in \S{}\ref{subsec:homol:the-category-of-complexes}, the snake lemma takes
...
\S{}\ref{subsec:rings:homology-and-the-snake-lemma} and can be summarized (cohomologically speaking) as
follows:
\begin{itemize}
...
We checked in \S{}\ref{subsec:rings:homology-and-the-snake-lemma} that choosing a different preimage for $n$
in $M^0$, while it may change the element $\ell$, does not change its
image in $\coker(\lambda^0)$. Thus $\delta$ is
well-defined. As we have seen in \S{}\ref{subsec:homol:the-snake-lemma-again}, it is relatively
...
absorbed into the snake lemma itself (cf.\ \Cref{exer:homol:reduce-long-exact-seq-to-snake-lemma}); but I have
...
$\categ{A}$ (\Cref{exer:homol:ses-of-complexes-non-exact-cohomology-example}). In other words, the $i$-th cohomology is
...
(or conversely, depending on your taste; cf.\ \Cref{exer:homol:reduce-long-exact-seq-to-snake-lemma}).
...
\begin{proof}
  ...
  for the reader (\Cref{exer:homol:details-of-long-exact-cohomology-sequence}). But I will stress the extent to which
  ...
  and is left to the reader.\footnote{The reader is welcome to look
    ...
    \S{}\ref{sec:homol:working-in-abelian-categories}, element-based proofs suffice to prove the statement in any
...
\[
  ...
  \longrightarrow N^\bullet \longrightarrow 0;
\]
the element of surprise in the long exact sequence obtained in \S{}\ref{subsec:homol:the-long-exact-cohomology-sequence}
...
exact sequence of complexes. In \S{}\ref{subsec:homol:the-long-exact-cohomology-sequence} we have obtained from this
...
later\footnote{Beware that some authors call the distinguished
  ...
  from this viewpoint.} (\S{}\ref{sec:homol:the-homotopic-category-complexes-of-projectives-and}). As with the `special' triangles given
...
last cryptic remarks (\S{}\ref{subsec:homol:triangulated-categories}).
...
\begin{exer}{\exerused{}}{exer:homol:resolution-gives-exact-truncated-complexes}
  ...
  \[
    ...
    \coker d^{-1} \longrightarrow M^1 \xrightarrow{d^1}
...
\begin{exer}{$\lnot$}{exer:homol:cochain-complexes-as-functor-subcategory}
  ...
  subcategory of the abelian category $\categ{A}^{\categ{I}}$. [\ref{exer:homol:category-of-cochain-complexes-is-abelian}]
\end{exer}
\begin{exer}{\exerused{}}{exer:homol:category-of-cochain-complexes-is-abelian}
  ...
  in an abelian category, defined in \S{}\ref{subsec:homol:the-category-of-complexes}, is itself an abelian
...
\begin{exer}{$\lnot$}{exer:homol:category-of-short-exact-sequences-properties}
  ...
  \end{itemize} [\S{}\ref{subsec:homol:abelian-categories}, \ref{exer:homol:long-exact-cohomology-sequence-is-functorial}]
\end{exer}
...
\begin{exer}{}{exer:homol:exact-functors-commute-with-cohomology}
  ...
  functor is still an exact complex (cf.\ \Cref{exer:linrep:exact-functor-characterization}).
\end{exer}
...
\begin{exer}{\exerused{}}{exer:homol:details-of-long-exact-cohomology-sequence}
  ...
  (\Cref{homol:3.5}). [\S{}\ref{subsec:homol:the-long-exact-cohomology-sequence}, \ref{exer:homol:reduce-long-exact-seq-to-snake-lemma}]
\end{exer}
\begin{exer}{\exerused{}}{exer:homol:reduce-long-exact-seq-to-snake-lemma}
  Here is a way to reduce \Cref{exer:homol:details-of-long-exact-cohomology-sequence} to the snake lemma itself.
  ...
  snake lemma given in \Cref{rem:rings:snake-lemma-relaxed-hypotheses}.) [\S{}\ref{subsec:homol:the-long-exact-cohomology-sequence}, \ref{exer:homol:differential-category-is-abelian}]
\end{exer}
\begin{exer}{$\lnot$}{exer:homol:long-exact-cohomology-sequence-is-functorial}
  ...
  (cf.\ \Cref{exer:homol:category-of-short-exact-sequences-properties}) of complexes to the category of
...
\begin{exer}{}{exer:homol:two-exact-columns-implies-third-abelian-category}
  Redo \Cref{exer:rings:infinite-ladder-two-exact-columns-implies-third}.
\end{exer}
\begin{exer}{}{exer:homol:differential-category-is-abelian}
  The viewpoint in \Cref{exer:homol:reduce-long-exact-seq-to-snake-lemma} admits the following straightforward
  generalization.
...
\begin{exer}{\exerused{}}{exer:homol:exact-vertex-implies-isomorphic-cohomologies}
  ...
  from a short exact sequence of complexes (as in \S{}\ref{subsec:homol:triangles}) is exact,
...
\begin{exer}{$\lnot$}{exer:homol:grothendieck-grp-euler-char-abelian-category}
  ...
  construction given in \S{}\ref{subsec:linalg:euler-characteristic-and-the-grothendieck-group}.
  ...
  $\chi(M^\bullet) = \chi(L^\bullet) + \chi(N^\bullet)$. [\ref{exer:homol:euler-char-of-mapping-cone}, \ref{exer:homol:euler-char-additive-on-distinguished-triangles}]
\end{exer}
...
compensate for this lack of exactness; we will see how in \S{}\ref{subsec:homol:the-mapping-cone-of-a-morphism}. We
...
and construct a new `homotopic category' of complexes (see \S{}\ref{sec:homol:the-homotopic-category-complexes-of-projectives-and}).
...
constructed in \S{}\ref{subsec:homol:the-long-exact-cohomology-sequence}. In fact, the mapping cone will give us the
third vertex of a `special' triangle (cf.\ the end of \S{}\ref{subsec:homol:triangles}):
\[
  (\dagger) \quad
  \begin{tikzpicture}[baseline=(current bounding box.center)]
    \node (M) at (1,1.3)
...
`special' triangles encountered in \S{}\ref{subsec:homol:triangles}); but taking cohomology
\[
  \begin{tikzpicture}[baseline=(current bounding box.center)]
    \node (M) at (1.7,1.3)
    {$H^\bullet(M^\bullet)$}; \node (L) at (0,0)
...
prototype of the `distinguished triangles' mentioned in \S{}\ref{subsec:homol:triangles} (cf.\
...
that $MC(\alpha)^\bullet$ is indeed a cochain complex (\Cref{exer:homol:cone-of-morphism-is-a-complex});
...
later (\S{}\ref{subsec:homol:complexes-of-complexes}).
...
\begin{coro}{}{homol:4.2}
  ...
  (Cf.\ \Cref{exer:homol:exact-vertex-implies-isomorphic-cohomologies}.)
\end{coro}
...
\[
  ...
  \xrightarrow{\coker d^{-1}_{M^\bullet}} A
...
triangles' (cf.\ \S{}\ref{subsec:homol:triangles}) abstracting exact sequences and giving long
...
that `homotopy equivalence of complexes' is also (\Cref{exer:homol:homotopy-and-homotopy-equiv-are-equiv-relations}).
...
exercise to verify this fact directly (\Cref{exer:homol:cone-of-null-homotopic-morphism-is-exact}).
...
\begin{rem}{}{homol:4.12}
  ...
  injective/projective modules, as we will do in \S{}\ref{subsec:homol:complexes-of-projective-and-injective-objects}, is precisely
...
presented in \S{}\ref{subsec:homol:reminder-of-basic-definitions-general-strategy} work, in a class of interesting examples. As we
...
quasi-isomorphisms (\Cref{exer:homol:additive-vs-exact-functors-quasi-iso-preservation}): an additive functor does not
...
preparatory work, so it is left to the reader (\Cref{exer:homol:homotopy-equiv-functor-cohomology-iso}).
...
choices made in \S{}\ref{subsec:linrep:the-tor-functors} and \S{}\ref{subsec:linrep:the-ext-functors}, concerning the
definition of the Tor and Ext functors, as we will see later in the
chapter (\S{}\ref{sec:homol:derived-functors}, especially Examples~7.6 and~7.7).
...
\begin{exer}{}{exer:homol:euler-char-of-mapping-cone}
  ...
  Euler characteristic (see \Cref{exer:homol:grothendieck-grp-euler-char-abelian-category}). Prove that
  \[
...
\begin{exer}{$\lnot$}{exer:homol:mapping-cylinder-is-a-complex}
  ...
  complex. [\ref{exer:homol:homotopic-maps-extend-to-cylinder-morphism}, \ref{exer:homol:exact-sequence-cylinder-to-cone}, \ref{exer:homol:exact-sequence-target-to-cylinder-quasi-iso}, \ref{exer:homol:cylinder-homotopy-equivalent-to-target}]
\end{exer}
\begin{exer}{}{exer:homol:homotopic-maps-extend-to-cylinder-morphism}
  ...
  object leads to the algebraic mapping cylinder of \Cref{exer:homol:mapping-cylinder-is-a-complex}.
...
\begin{exer}{$\lnot$}{exer:homol:exact-sequence-cylinder-to-cone}
  ...
  $X \times 0$ to a point in the mapping cylinder (cf.\ \Cref{exer:homol:mapping-cylinder-is-a-complex}
  and the description of the mapping cone given in \S{}\ref{subsec:homol:the-mapping-cone-of-a-morphism}).
...
\begin{exer}{$\lnot$}{exer:homol:exact-sequence-target-to-cylinder-quasi-iso}
  With notation as in \Cref{exer:homol:mapping-cylinder-is-a-complex} (in particular, for a cochain
  morphism $\alpha^\bullet : L^\bullet \to M^\bullet$), prove that
  there is an exact sequence of cochain complexes
  \[
  ...
  $M^\bullet \to MCyl(\alpha)^\bullet$. [\ref{exer:homol:cylinder-homotopy-equivalent-to-target}, \ref{exer:homol:replace-morphism-by-monomorphism-up-to-homotopy}]
\end{exer}
\begin{exer}{$\lnot$}{exer:homol:cylinder-homotopy-equivalent-to-target}
  Still with notation as in \Cref{exer:homol:mapping-cylinder-is-a-complex}, define maps
  ...
  equivalent. This strengthens the conclusion of \Cref{exer:homol:exact-sequence-target-to-cylinder-quasi-iso}.
  [\ref{exer:homol:replace-morphism-by-monomorphism-up-to-homotopy}]
\end{exer}
...
One message I have tried to convey in \S{}\ref{sec:homol:cones-and-homotopies} is that while
...
category, in \S{}\ref{sec:homol:projective-and-injective-resolutions-and-the-derived-category}.
...
higher-brow considerations at the end of \S{}\ref{subsec:homol:quasi-isomorphisms-and-derived-categories}. Again consider any
additive functor
\[
  \mathscr{F} : \categ{C}(\categ{A}) \longrightarrow \categ{D}
\]
...
respects composition (\Cref{exer:homol:homotopy-compatible-with-composition}); in other words, the operation of
composition
\[
...
injective, objects from $\categ{A}$ (cf. \S{}\ref{subsec:homol:complexes-of-projective-and-injective-objects}) will also play a
...
As I already mentioned in \S{}\ref{subsec:homol:triangles}, $\categ{K}(\categ{A})$ is a
\emph{triangulated} category; the `distinguished triangles' are the
triangles arising from the cones of morphisms, as in \S{}\ref{subsec:homol:the-mapping-cone-of-a-morphism}. (I will
briefly describe the situation in \S{}\ref{subsec:homol:triangulated-categories}.)
...
of sequences at the end of \S{}\ref{subsec:linrep:projectives-and-injectives} hold in any abelian category,
...
the opposite of an abelian category is again abelian (\Cref{exer:homol:opposite-of-abelian-is-abelian}),
...
\S{}\ref{subsec:linrep:projective-modules} and \S{}\ref{subsec:linrep:injective-modules} use the specific properties of the
...
\begin{exam}{}{exam:homol:5.6}
  ...
  objects (\Cref{exer:homol:no-nontrivial-proj-inj-finite-abelian-groups}).
\end{exam}
...
in \S{}\ref{sec:linrep:projective-and-injective-modules-and-the-ext-functors}: in particular, we have already observed that, for every
...
the reader will verify (\Cref{exer:homol:split-exact-complex-characterization}), this has to do with whether
...
\begin{proof}
  ...
  $MC(\rho)^\bullet$ of $\rho^\bullet$ (\S{}\ref{subsec:homol:the-mapping-cone-of-a-morphism}), and define morphisms
  \[
  ...
  complexes $P^\bullet \to MC(\rho)[-1]^\bullet$. Indeed\footnote{It
    ...
    defined in \S{}\ref{subsec:homol:the-mapping-cone-of-a-morphism}. The negative sign will now come in very
    handy.},
  \[
  ...
  \[\begin{tikzcd}
    ...
    \end{tikzcd}\] so (\Cref{exer:homol:homotopy-compatible-with-composition}, part (i)) the fact that
...
\Cref{thm:homol:5.9} will follow from a more general
...
\begin{proof}
  ...
  % non-commutative homotopy "lozenge" diagram of \S{}\ref{subsec:homol:homotopy}
  \[
...
\begin{proof}[Proof of \cref{thm:homol:5.9}]
  ...
  \]
  (\Cref{exer:homol:homotopy-compatible-with-composition}), it follows that
  $\beta^\bullet \circ \alpha^\bullet \sim
...
\begin{exer}{\exerused{}}{exer:homol:direct-sum-projectives-injectives-abelian-category}
  ...
  category. [\ref{exer:homol:functor-category-has-enough-injectives-projectives}, \ref{exer:homol:complex-projective-iff-split-exact-of-projectives}, \S{}\ref{subsec:homol:long-exact-sequence-of-derived-functors}]
\end{exer}
...
\begin{exer}{\exerused{}}{exer:homol:left-adjoint-preserves-projectives}
  ...
  injective objects.  [\ref{exer:homol:x-hat-preserves-injectives}, \S{}\ref{subsec:homol:viewpoint-shift}]
\end{exer}
\begin{exer}{$\lnot$}{exer:homol:right-adjoint-functor-category-construction}
  ...
  information determines the whole natural transformation.) [\ref{exer:homol:x-hat-preserves-injectives}, \ref{exer:homol:functor-category-has-enough-injectives-projectives}]
\end{exer}
\begin{exer}{$\lnot$}{exer:homol:x-hat-preserves-injectives}
  As in \Cref{exer:homol:right-adjoint-functor-category-construction}, let $\categ{C}$ be a small category and let
  ...
  injective in $\categ{A}^{\categ{C}}$. (Hint: \Cref{exer:homol:left-adjoint-preserves-projectives}.)  [\ref{exer:homol:functor-category-has-enough-injectives-projectives}]
\end{exer}
\begin{exer}{$\lnot$}{exer:homol:functor-category-has-enough-injectives-projectives}
  ...
  \begin{itemize}
  \item With notation as in \Cref{exer:homol:right-adjoint-functor-category-construction}, let
  ...
  (\categ{A}^{op})^{(\categ{C}^{op})}$.) [\ref{exer:homol:presheaves-have-enough-injectives-projectives}]
\end{exer}
\begin{exer}{}{exer:homol:presheaves-have-enough-injectives-projectives}
  ...
  projectives\footnote{The category of \emph{sheaves} of abelian
    ...
    general it does not have enough projectives.}. (Use \Cref{exer:homol:functor-category-has-enough-injectives-projectives}.)
\end{exer}
\begin{exer}{\exerused{}}{exer:homol:split-exact-complex-characterization}
  ...
  sense analogous to the one given for modules in \S{}\ref{subsec:rings:split-exact-sequences}) if and
  ...
  $N^\bullet$ is `split exact' as defined in \S{}\ref{subsec:homol:homotopy-equivalences-vs-quasi-isomorphisms-in-k-a}) if and only if
  ...
  [\S{}\ref{subsec:homol:homotopy-equivalences-vs-quasi-isomorphisms-in-k-a}, \ref{exer:homol:complex-projective-iff-split-exact-of-projectives}, \S{}\ref{subsec:homol:long-exact-sequence-of-derived-functors}]
\end{exer}
...
\begin{exer}{$\lnot$}{exer:homol:uniqueness-of-projective-resolution-up-to-homotopy}
  ...
  \item Assume that there are quasi-isomorphisms
    ...
    wait until you have covered \S{}\ref{sec:homol:projective-and-injective-resolutions-and-the-derived-category}, in particular \Cref{thm:homol:6.6}.)
  \end{itemize} [\ref{exer:homol:chain-of-quasi-isos-gives-homotopy-equivalence}]
\end{exer}
...
(\Cref{exer:homol:homotopy-and-homotopy-equiv-are-equiv-relations}), while quasi-isomorphism is not (see the discussion
...
quasi-isomorphisms are not (\Cref{exer:homol:additive-vs-exact-functors-quasi-iso-preservation}).
...
description of the derived category (\S{}\ref{subsec:homol:poor-man-s-derived-category}).
...
as a full subcategory of $\categ{K}(\categ{A})$ (\Cref{exer:homol:complexes-in-degree-0-copy-of-a}). We
...
\begin{rem}{}{rem:homol:6.2}
  ...
  variations. This is not the case (\Cref{exer:homol:complex-projective-iff-split-exact-of-projectives}).
\end{rem}
...
\begin{proof}
  ...
  $M^\bullet$ with its truncated version (cf. \Cref{exer:homol:resolution-gives-exact-truncated-complexes}) and then
...
this assertion, for it is a key point (\Cref{exer:homol:subcategory-cohomology-degree-0-equiv-a}). If $\categ{A}$
...
At this point we hopefully agree (\Cref{exer:homol:subcategory-cohomology-degree-0-equiv-a}) that the homotopic
...
observed in \S{}\ref{subsec:homol:quasi-isomorphisms-and-derived-categories}, resolutions (in $\categ{C}^-(\categ{A})$ or
...
\begin{proof}
  ...
  isomorphically to the kernel of $d^i_{L^\bullet}$ (\Cref{exer:homol:pullback-kernel-comparison-iso});
  ...
  \Cref{homol:2.2}) that it is a push-out as well, and (\Cref{exer:homol:pullback-kernel-comparison-iso}
  ...
  now established that there exists a homotopy lift\footnote{That is,
    ...
    cf. \Cref{exer:homol:true-lift-doesnt-exist-homotopy-lift-does}.} to any complex $P^\bullet$ mapping
...
universal problem presented in \S{}\ref{subsec:homol:quasi-isomorphisms-and-derived-categories}. The precise statement is the
following.
...
\begin{rem}{}{rem:homol:6.8}
  ...
  isomorphism\footnote{`Natural transformations' were rapidly defined
    in \S{}\ref{subsec:linrep:comparing-functors}, \Cref{linrep:1.15}. They are the most sensible
...
already pointed out in \S{}\ref{subsec:linrep:equivalence-of-categories}, this is what should be expected
...
\begin{proof}
  ...
  $\categ{D}$). The reader will verify (\Cref{exer:homol:uniqueness-of-derived-functor-nat-iso}) that this
...
\begin{exer}{\exerused{}}{exer:homol:subcategory-cohomology-degree-0-equiv-a}
  ...
  this subcategory.) [\S{}\ref{subsec:homol:recovering-a}, \S{}\ref{subsec:homol:from-objects-to-complexes}, \ref{exer:homol:nat-transformation-identity-to-p-iota-h0}, \S{}\ref{subsec:homol:viewpoint-shift}]
\end{exer}
...
\begin{exer}{\exerused{}}{exer:homol:resolution-functor-p-i-properties}
  ...
  complex, as in \S{}\ref{subsec:homol:poor-man-s-derived-category}. Prove that $\mathscr{P}$ induces a functor
...
\begin{exer}{}{exer:homol:chain-of-quasi-isos-gives-homotopy-equivalence}
  (Cf. \Cref{exer:homol:uniqueness-of-projective-resolution-up-to-homotopy}.) Let $\categ{A}$ be an abelian category with
...
\begin{exer}{$\lnot$}{exer:homol:nonzero-derived-morphism-zero-in-cohomology-example}
  ...
  information than `just' cohomology.) [\ref{exer:homol:true-lift-doesnt-exist-homotopy-lift-does}, \ref{exer:homol:nonzero-derived-morphism-domain-example}]
\end{exer}
\begin{exer}{\exerused{}}{exer:homol:true-lift-doesnt-exist-homotopy-lift-does}
  Consider the second morphism given in \Cref{exer:homol:nonzero-derived-morphism-zero-in-cohomology-example}, together with a
...
\begin{exer}{}{exer:homol:nonzero-derived-morphism-domain-example}
  ...
  particularly easy if you have worked out \Cref{exer:homol:nonzero-derived-morphism-zero-in-cohomology-example}).
\end{exer}
...
\begin{exer}{\exerused{}}{exer:homol:nat-transformation-identity-to-p-iota-h0}
  (Cf. \Cref{exer:homol:subcategory-cohomology-degree-0-equiv-a}.) Let $\categ{A}$ be an abelian category with
  ...
  $\categ{A} \to \widehat{\categ{A}}$; with notation as in \S{}\ref{subsec:homol:poor-man-s-derived-category},
...
\S{}\ref{subsec:homol:poor-man-s-derived-category}---the homotopic category $\categ{K}^-(\categ{P})$ is a
...
$\widehat{\categ{A}} \to \categ{A}$. With notation as in \S{}\ref{subsec:homol:poor-man-s-derived-category}, the
functor $\mathscr{P} \circ \iota$ associating with every object of
$\categ{A}$ a projective resolution gives a `weak' inverse to
$H^0$. As pointed out in \S{}\ref{subsec:homol:poor-man-s-derived-category}, there are many different possible
...
\[
  ...
  \categ{C}(\categ{B})
\]
(we briefly encountered this functor in \S{}\ref{sec:homol:cones-and-homotopies}): the complex
...
$\categ{A}$, resp., $\categ{B}$); given our discussion in \S{}\ref{subsec:homol:poor-man-s-derived-category},
...
not preserve projectives\footnote{Note that tensor is right-exact, and
  ...
  functors do preserve projectives: \Cref{exer:homol:left-adjoint-preserves-projectives}.} (\Cref{exer:homol:no-projective-abelian-grp-is-tensor-image}).
Assuming that $\categ{B}$ has enough projectives, the natural way to
`fix' this problem is to apply a corresponding functor
$\mathscr{P}_{\categ{B}}$ constructed as in \S{}\ref{subsec:homol:poor-man-s-derived-category}, associating with
...
defined on the homotopic category (cf. \Cref{exer:homol:resolution-functor-p-i-properties}).
...
derived categories, discussed at the beginning of \S{}\ref{subsec:homol:viewpoint-shift}, that is,
...
\]
Well, in general there isn't (\Cref{exer:homol:derived-functor-nat-transformation-not-iso-example}). What is
...
\end{prop}
\begin{proof}
  If we have done our homework (and in particular \Cref{exer:homol:resolution-functor-p-i-properties}), then
...
\begin{rem}{}{rem:homol:7.4}
  ...
  (\Cref{exer:homol:resolution-functor-p-i-properties}), used in the proof of
  ...
  `distributes' through compositions in this case (\Cref{exer:homol:composition-of-derived-functors}).
...
both enough projectives and injectives (as seen in \S{}\ref{subsec:linrep:projective-modules} and
\S{}\ref{subsec:linrep:injective-modules}); thus every covariant/contravariant functor
...
\begin{exam}{}{exam:homol:7.6}
  ...
  \]
  (see \S{}\ref{subsec:linrep:adjunction-with-hom-and-explicit-computations}). The left-derived functor of $\_ \otimes_R N$ is
  ...
  of $\Tor^R_i (M, N)$ given in \S{}\ref{subsec:linrep:the-tor-functors} matches
  precisely the `concrete' interpretation of the $i$-th left-derived
  functor given above. The reader may note that in \S{}\ref{subsec:linrep:the-tor-functors} we
  ...
  \S{}\ref{subsec:linrep:projective-modules} and was attributed there to the `magic of homological
  ...
  \S{}\ref{subsec:linrep:the-tor-functors}, that $\Tor_i(M, N)$ may in fact be
  computed by using a projective resolution \emph{of $N$} rather than
  $M$. Both mysteries will be dispelled in \S{}\ref{sec:homol:double-complexes}.
\end{exam}
...
\begin{exam}{}{exam:homol:7.7}
  ...
  injective resolution of $N$. As mentioned in \S{}\ref{subsec:linrep:the-ext-functors}, it is
...
existence of these exact sequences in \S{}\ref{subsec:linrep:the-tor-functors} and \S{}\ref{subsec:linrep:the-ext-functors},
...
category: as I mentioned in passing in \S{}\ref{subsec:homol:quasi-isomorphisms-and-derived-categories}, these triangles play
...
complexes in the abelian case explored in \S{}\ref{subsec:homol:the-long-exact-cohomology-sequence}.
...
\begin{proof}
  ...
  $P_M^i := P_L^i \oplus P_N^i$; this is projective (\Cref{exer:homol:direct-sum-projectives-injectives-abelian-category}),
...
(\Cref{exer:homol:mapping-cone-description-of-pm-from-pl-pn}) that $P_M^\bullet$ is the mapping cone of a morphism
...
\[
  ...
  \end{tikzpicture}
\]
in the sense mentioned in \S{}\ref{subsec:homol:the-mapping-cone-of-a-morphism}. These are the triangles giving the
...
\[
  ...
  \end{tikzpicture}
\]
in the sense of \S{}\ref{subsec:homol:triangles}. The horseshoe lemma shows that this functor
...
\begin{proof}
  ...
  (\Cref{exer:homol:epi-mono-factorization-is-coim-image}). The statements follow. (If $M^\bullet$ is exact,
...
\begin{proof}
  ...
  \[\begin{tikzcd}
    ...
    \end{tikzcd}\] splits (see the end of \S{}\ref{subsec:linrep:projectives-and-injectives}). It follows
  that
  \[\begin{tikzcd}
      0 \arrow[r] & \mathscr{F}(L^i) \arrow[r] & \mathscr{F}(M^i)
      \arrow[r] & \mathscr{F}(P^i) \arrow[r] & 0
    \end{tikzcd}\] is (split and) exact for all $i$
  (\Cref{exer:homol:split-exact-complex-characterization}). Exactness of a sequence of complexes is determined
...
necessary to prove this to the reader (\Cref{exer:homol:morphisms-of-ses-induce-morphisms-of-les}).
...
Once more in the style of \S{}\ref{subsec:homol:triangles}, Theorem~\ref{thm:homol:7.12} tells
...
\begin{proof}
  ...
  so is its cohomology. Since $H_i = H^{-i}$ (cf. \S{}\ref{subsec:homol:reminder-of-basic-definitions-general-strategy}), the first
  claim follows.
...
$\categ{R}^i\mathscr{F}$ vanish in this case (\Cref{exer:homol:exact-functor-vanishing-higher-derived-functors}). As
...
encountered in \S{}\ref{subsec:rings:monoid-rings}. Objects of $G\text{-}\categ{Mod}$ may be
called $G$-modules.
...
reader should either check this directly or do \Cref{exer:homol:invariants-functor-right-adjoint-trivial-action} and then
...
(and as will finally be verified in \S{}\ref{sec:homol:double-complexes}), this can be computed by an
...
that $(\dagger)$ is exact (\Cref{exer:homol:exactness-of-group-cohomology-complex-low-degrees}), at least for the part
...
so by \Cref{exer:fields:distinct-automorphisms-linearly-independent} they must be linearly independent.  Therefore,
...
prove this particular case in \Cref{exer:fields:hilberts-theorem-90-multiplicative} and now will enjoy the
chance to verify that indeed Claim~\ref{prop:homol:7.18} implies
Hilbert's result (\Cref{exer:homol:hilbert-90-from-vanishing-group-cohomology}).
...
$H_\bullet(\Z, M)$ (\Cref{exer:homol:group-homology-of-z-with-coefficients}).
...
\begin{exer}{$\lnot$}{exer:homol:cartan-eilenberg-resolution-computes-cohomology}
  ...
  and 9.10. [\ref{exer:homol:spectral-seq-for-composite-derived-functors}]
\end{exer}
...
\begin{exer}{\exerused{}}{exer:homol:generalized-dimension-shifting}
  Generalize Exercise~\ref{exer:homol:dimension-shifting-derived-functors} as follows: with the same
  notation, assume
  \[\begin{tikzcd}
  ...
  all $i > k$. [\S{}\ref{subsec:homol:resolution-by-acyclic-objects}, \ref{exer:homol:projective-dimension-equivalent-characterizations}]
\end{exer}
\begin{exer}{$\lnot$}{exer:homol:delta-functor-definition-derived-functors-are}
  ...
  example. [\ref{exer:homol:effaceable-delta-functor-morphism-extension}, \ref{exer:homol:bifunctor-derived-functor-construction}]
\end{exer}
\begin{exer}{$\lnot$}{exer:homol:effaceable-delta-functor-morphism-extension}
  `Morphisms' $\{\mathscr{T}^i\} \to \{\mathscr{S}^i\}$ of
  $\delta$-functors (Exercise~\ref{exer:homol:delta-functor-definition-derived-functors-are}) are natural
  ...
  and consider the exact sequence $0 \to A \to B \to C \to 0$.) [\ref{exer:homol:derived-functors-are-universal-delta-functors}]
\end{exer}
\begin{exer}{$\lnot$}{exer:homol:derived-functors-are-universal-delta-functors}
  Assume the result stated in Exercise~\ref{exer:homol:effaceable-delta-functor-morphism-extension}. Prove
  ...
  sheaf cohomology. [\ref{exer:homol:bifunctor-derived-functor-construction}]
\end{exer}
\begin{exer}{\exerused{}}{exer:homol:invariants-functor-right-adjoint-trivial-action}
  Prove that the functor $\cdot^G$ defined in \S{}\ref{subsec:homol:example-a-little-group-cohomology} is right-adjoint
...
\begin{exer}{\exerused{}}{exer:homol:exactness-of-group-cohomology-complex-low-degrees}
  Consider the complex $(\dagger)$ defined in \S{}\ref{subsec:homol:example-a-little-group-cohomology}. Define maps
...
\begin{exer}{\exerused{}}{exer:homol:hilbert-90-from-vanishing-group-cohomology}
  Deduce Hilbert's theorem 90 (as stated in \Cref{exer:fields:hilberts-theorem-90-multiplicative}) as a
...
(\S{}\ref{subsec:homol:resolution-by-acyclic-objects}). But everything is clarified substantially by going one step
...
$i \ge 1$ if $P$ is projective (cf.\ Exercise~\ref{exer:homol:derived-functor-of-projective-object}):
...
on the right (cf.\ \S{}\ref{subsec:homol:relating-f-li-f-rif}), so in context we can just talk about
...
\begin{exam}{}{exam:homol:8.2}
  ...
  $\Tor_i(M, N) = 0$ for $i \ne 0$ and all $M$; see
  \S{}\ref{subsec:linrep:the-tor-functors} to be reminded of why, or---better---prove it anew.
...
Here is the punch line. In \S{}\ref{subsec:linrep:the-ext-functors} I had claimed that flat
...
\begin{proof}
  ...
  \Cref{exer:homol:cohomology-right-exact-functor-exact-complex} to the exact complex
  \[\begin{tikzcd}
  ...
  \]
  (also cf.\ Exercise~\ref{exer:homol:generalized-dimension-shifting}) and concludes the proof.
\end{proof}
...
\Cref{exer:homol:bifunctor-derived-functor-construction} for a typical situation.)
...
I warned the reader as far back as \S{}\ref{subsec:homol:the-category-of-complexes} that we would examine
...
of complexes leading to the long exact cohomology sequence (\S{}\ref{subsec:homol:the-long-exact-cohomology-sequence})
and the construction of the mapping cone (\S{}\ref{subsec:homol:the-mapping-cone-of-a-morphism}). The latter case
...
The mapping cone $MC(\alpha)^\bullet$ constructed in \S{}\ref{subsec:homol:the-mapping-cone-of-a-morphism} is
obtained by
\begin{itemize}
...
% \S{}\ref{subsec:homol:the-mapping-cone-of-a-morphism}, no new mathematical content beyond what the surrounding
% prose states.
...
to an isomorphic double complex, \Cref{exer:homol:sign-flip-gives-isomorphic-double-complex}; in fact, other choices
...
\begin{proof}
  ...
  \[
    ...
    \circ \delta_v = 0.
  \]
  The reader will formalize this computation (\Cref{exer:homol:total-differential-squares-to-zero}).
\end{proof}
...
\begin{exam}{}{exam:homol:8.8}
  ...
  (\Cref{exer:homol:sign-flip-gives-isomorphic-double-complex}), and by a slight abuse of language they can both be
  ...
  reader will verify (\Cref{exer:homol:cohomology-of-total-hom-complex-is-hom-in-k}) that, with suitable positions:
  \begin{itemize}
...
computed by an extremely clever device called \emph{spectral
  sequence}, which we will (briefly) encounter in \S{}\ref{subsec:homol:spectral-sequences}. There are
...
\begin{exam}{}{exam:homol:8.10}
  ...
  Example~\ref{exam:homol:8.8} (cf.\ \Cref{exer:homol:cohomology-of-total-hom-complex-is-hom-in-k}), this says that
...
arguments used in \S{}\ref{sec:homol:the-homotopic-category-complexes-of-projectives-and} are bypassed, and statements such as
...
question examined in \S{}\ref{subsec:homol:resolution-by-acyclic-objects}, letting a double complex draw the
...
We have studied in \S{}\ref{subsec:homol:from-objects-to-complexes} the problem of constructing complexes of
...
can safely be left to the reader (\Cref{exer:homol:total-complex-of-mn-is-mapping-cone}). The following
...
consequence of the latter. As I mentioned at the beginning of \S{}\ref{subsec:homol:exactness-of-the-total-complex},
...
learned a bit about spectral sequences in \S{}\ref{subsec:homol:spectral-sequences}, but it is not hard
...
the context of our (hard) work in \S{}\ref{sec:homol:projective-and-injective-resolutions-and-the-derived-category}, note that it provides us with
...
simplify the material I presented in \S{}\ref{sec:homol:projective-and-injective-resolutions-and-the-derived-category} but at the price of dealing
...
complexes), go back to the question we studied in \S{}\ref{subsec:homol:resolution-by-acyclic-objects}: we ended
...
in \S{}\ref{subsec:linrep:the-tor-functors} (where we used free resolutions); see also
\Cref{exam:homol:7.6}. Theorem~\ref{thm:homol:8.13} makes good on our old
promise (also made in \S{}\ref{subsec:linrep:the-tor-functors}) to show that the Tor functors
...
(\Cref{exer:homol:ext-via-proj-or-inj-resolution-agree}): Example~\ref{exam:homol:8.8} and the strategy
...
last chapter. In \S{}\ref{sec:homol:further-topics} we will give a brief look at material that
...
\begin{exer}{\exerused{}}{exer:homol:cohomology-of-total-hom-complex-is-hom-in-k}
  ...
  These isomorphisms require careful sign adjustments.) [\S{}\ref{subsec:homol:complexes-of-complexes},
...
\begin{exer}{$\lnot$}{exer:homol:cartan-eilenberg-computes-composite-derived-functor}
  ...
  [\S{}\ref{subsec:homol:universal-property-of-the-derived-functor}, \ref{exer:homol:cartan-eilenberg-resolution-computes-cohomology}, \ref{exer:homol:spectral-seq-for-composite-derived-functors}]
\end{exer}
\begin{exer}{\exerused{}}{exer:homol:ext-via-proj-or-inj-resolution-agree}
  ...
  given in \S{}\ref{subsec:linrep:the-ext-functors}. [\S{}\ref{subsec:homol:acyclic-resolutions-again-and-balancing-tor-and-ext}]
\end{exer}
...
\begin{exer}{$\lnot$}{exer:homol:projective-dimension-equivalent-characterizations}
  ...
  adapt Exercise~\ref{exer:homol:generalized-dimension-shifting}.) [\ref{exer:homol:injective-dimension-equivalent-characterizations}, \ref{exer:homol:global-dimension-pd-id-equality}]
\end{exer}
\begin{exer}{$\lnot$}{exer:homol:injective-dimension-equivalent-characterizations}
  ...
  \end{enumerate}
  (See Exercise~\ref{exer:homol:projective-dimension-equivalent-characterizations}.) [\ref{exer:homol:global-dimension-pd-id-equality}]
\end{exer}
\begin{exer}{}{exer:homol:global-dimension-pd-id-equality}
  (See Exercises~\ref{exer:homol:projective-dimension-equivalent-characterizations} and \ref{exer:homol:injective-dimension-equivalent-characterizations}.)
  Let $\categ{A}$ be an abelian category with enough injectives and
...
\begin{exer}{\exerused{}}{exer:homol:bifunctor-derived-functor-construction}
  ...
  \item Prove that the $\categ{T}^i\mathscr{F}_B$ form a
    $\delta$-functor, in the sense of Exercise~\ref{exer:homol:delta-functor-definition-derived-functors-are}.
  ...
  Exercise~\ref{exer:homol:derived-functors-are-universal-delta-functors} and the uniqueness of universal
...
\S{}\ref{subsec:homol:spectral-sequences}, illustrating the spectral sequence associated to a double
...
Derived categories made their appearance in \S{}\ref{subsec:homol:quasi-isomorphisms-and-derived-categories} and have since
...
derived category is in the `poor man's version' of \S{}\ref{subsec:homol:poor-man-s-derived-category}, which
...
of the field of fractions (see \S{}\ref{subsec:irred:the-field-of-fractions-of-an-integral-domain}). This process, in a more
general version dealing with inverting `multiplicative subsets' of a
ring, is called \emph{localization} (\Cref{exer:irred:localization-construction}). Categories may
...
\S{}\ref{subsec:homol:quasi-isomorphisms-and-derived-categories}. If $\categ{A}$ has (for example) enough projectives, then the
bounded version $\categ{D}^-(\categ{A})$ is equivalent to the homotopy
category $\categ{K}^-(\categ{P})$ of complexes of projectives, as I
have endeavored to justify in \S{}\ref{subsec:homol:poor-man-s-derived-category}. The latter should be viewed as
...
\S{}\ref{subsec:homol:quasi-isomorphisms-and-derived-categories}. However, the real benefits of introducing the derived
...
roof (Exercise~\ref{exer:homol:upside-down-roof-implies-regular-roof}); this may be easier after
acquiring a little familiarity with distinguished triangles. Also,
note that the diagram in Exercise~\ref{exer:homol:upside-down-roof-implies-regular-roof} does not
...
homotopic categories of complexes. I have pointed out in \S{}\ref{subsec:homol:definition-of-the-homotopic-category-of-complexes} that
...
(\S{}\ref{subsec:homol:long-exact-sequence-of-derived-functors}) bears witness to this fact.  The essential ingredients of a
...
$MC(\alpha)^\bullet \to L[1]^\bullet$ studied in \S{}\ref{subsec:homol:the-mapping-cone-of-a-morphism}.
...
$0$. But the mapping cone of the identity is \emph{homotopically
  equivalent} to $0$ (Exercise~\ref{exer:homol:mapping-cone-of-isomorphism-homotopy-trivial}), so the rotated
...
(Exercise~\ref{exer:homol:mapping-cone-of-natural-morphism-is-shift}) that if
...
mysterious remarks at the end of \S{}\ref{subsec:homol:triangles}. The `special triangles'
\[
  \begin{tikzpicture}[baseline=(current bounding box.center)]
    \node (L) at (1,1.3)
    {$L^\bullet$}; \node (N) at (0,0)
  ...
  \end{tikzpicture}
\]
arising as in \S{}\ref{subsec:homol:triangles} from a short exact sequence
\[
  0 \longrightarrow L^\bullet \xrightarrow{\alpha^\bullet} M^\bullet
  \xrightarrow{\beta^\bullet} N^\bullet \longrightarrow 0
\]
...
hand, the reader can now verify (Exercise~\ref{exer:homol:mapping-cone-of-mono-quasi-iso-to-cokernel}) that
...
Exercise~\ref{exer:homol:connecting-morphism-in-derived-category-from-ses}). Applying the cohomology functor to
...
\[
  ...
  \end{tikzpicture}
\]
expressing the long exact cohomology sequence as in \S{}\ref{subsec:homol:triangles}, without
...
`special' triangles in \S{}\ref{subsec:homol:triangles} turns out to be an artifact: placing
...
\to \categ{D}^\pm(\categ{B})$ encountered in \S{}\ref{subsec:homol:universal-property-of-the-derived-functor} are also functors
...
studied in \S{}\ref{subsec:homol:long-exact-sequence-of-derived-functors}.

\subsection{Spectral sequences}
\label{subsec:homol:spectral-sequences}
I mentioned in \S{}\ref{subsec:homol:exactness-of-the-total-complex} that `spectral sequences' may be used to
...
information linking it back to \S{}\ref{subsec:homol:total-complexes-and-resolutions}. My motivation is that, in the
...
The reader will verify (Exercise~\ref{exer:homol:limit-of-spectral-sequence-from-exact-couple}) that if the
...
\S{}\ref{subsec:groups2:the-jordan-h-older-theorem} are filtrations of $G$. If $M$ is an object of an abelian
...
\]
As we know since \S{}\ref{subsec:homol:the-long-exact-cohomology-sequence}, this determines an exact triangle (couple!)
\[
  \begin{tikzpicture}[baseline=(current bounding box.center)]
...
\begin{thm}{}{homol:9.5}
  ...
  complex, as I glibly announced in \S{}\ref{subsec:homol:exactness-of-the-total-complex}, but it computes the
...
\begin{proof}
  ...
  couple (Exercise~\ref{exer:homol:limit-of-spectral-sequence-from-exact-couple}), as a subquotient of
  ...
  By the innocent \Cref{exer:homol:quotient-iso-image-kernel-two-morphisms},
  \[
...
put together by working out Exercise~\ref{exer:homol:spectral-seq-for-composite-derived-functors}.
...
\begin{exer}{}{exer:homol:euler-char-additive-on-distinguished-triangles}
  ...
  bounded complexes in these categories (see \Cref{exer:homol:grothendieck-grp-euler-char-abelian-category}). Prove
  that if
  \[
    \begin{tikzpicture}[baseline=(current bounding box.center)]
      \node (A) at (1,1.3) {$A$}; \node (C) at (0,0)
...
\begin{exer}{\exerused{}}{exer:homol:mapping-cone-of-isomorphism-homotopy-trivial}
  ...
  equivalent to $0$. [\S{}\ref{subsec:homol:triangulated-categories}, \ref{exer:homol:mapping-cone-of-natural-morphism-is-shift}]
\end{exer}
...
\begin{exer}{\exerused{}}{exer:homol:mapping-cone-of-natural-morphism-is-shift}
  ...
  Exercise~\ref{exer:homol:mapping-cone-of-isomorphism-homotopy-trivial} first.) [\S{}\ref{subsec:homol:triangulated-categories}]
\end{exer}
...
\begin{exer}{}{exer:homol:stabilization-of-vertical-spectral-sequence}
  ...
  complex from the vertical filtration, as in \S{}\ref{subsec:homol:spectral-sequences}. Prove that
...
\begin{exer}{\exerused{}}{exer:homol:spectral-seq-for-composite-derived-functors}
  ...
  This is precisely the set-up of \Cref{exer:homol:cartan-eilenberg-computes-composite-derived-functor}. Now take the double
  ...
  \]
  (Use \Cref{exer:homol:cartan-eilenberg-resolution-computes-cohomology} to compute the ${}_hE_1$ term.)
  ...
  \Cref{exer:homol:cartan-eilenberg-computes-composite-derived-functor}.) [\S{}\ref{subsec:homol:universal-property-of-the-derived-functor}, \ref{exer:homol:cartan-eilenberg-resolution-computes-cohomology}, \S{}\ref{subsec:homol:spectral-sequences}]
\end{exer}
