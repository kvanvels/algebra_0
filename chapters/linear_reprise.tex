...
such that there are `natural isomorphisms' (see \S{}1.5) from
...
\begin{exam}{(Exact functors)}{linrep:exam:1.18}
  ...
  \S{}2.3). We say that an additive functor $F$ is \emph{left-exact}
  if whenever
  \[
...
\begin{exer}{}{linrep:exer:1.8}
  ...
  \item Denote by $h_S$ the functor
    $\Hom_{K\text{-}\mathrm{Aff}}(\mathord{-}, S)$ (as in \S{}1.2),
...
\begin{exer}{$\lnot$}{linrep:exer:1.9}
  ...
  $X \mapsto h_X := \Hom_{\categ{C}} (\mathord{-}, X)$ (cf.\ \S{}1.2)
...
\begin{exer}{$\lnot$}{linrep:exer:1.10}
  ...
  $h^X := \Hom_{\categ{C}} (\mathord{-}, X)$ (cf.\ \S{}1.2). For every
...
\begin{exer}{}{linrep:exer:1.11}
  ...
  $h^X$ (cf.\ \S{}1.2). In this case, $X$ `represents' the
...
\begin{exer}{$\lnot$}{linrep:exer:1.16}
  ...
  $\categ{Set}$ and $R\text{-}\categ{Mod}$ given in \S{}1.4, for any
...
functor $P \mapsto \Hom_R(N, P)$; cf.\ \S{}1.2. We have defined
...
tensor products verified in \S{}2.1. In particular, and this is good
...
\S{}3.2) carries naturally an $S$-module structure. This association
...
is an $R$-module, I have pointed out in \S{}3.2 that
...
\begin{exer}{}{linrep:exer:3.7}
  ...
  restriction of scalars; cf.\ \S{}3.3).
\end{exer}
...
\begin{exer}{}{linrep:exer:4.21}
  ...
  use the exact sequence mentioned at the end of \S{}4.4. It will be
...
discussed in general terms in \S{}1.2)?
...
this better after digesting \S{}6, but the following observation will
suffice for now.
...
\begin{exer}{$*$}{linrep:exer:5.12}
  ...
  defined in \S{}5.5. [\S{}\ref{subsec:linrep:duals-and-matrices-biduality}]
\end{exer}
...
\begin{exer}{$*$}{linrep:exer:5.13}
  ...
  \S{}5.5. [\S{}\ref{subsec:linrep:duals-and-matrices-biduality}]
\end{exer}
...
defined in \S{}3.3 a functor\footnote{Watch out --- in \S{}3.3 the
