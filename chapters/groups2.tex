...
We already know that products exist in $\categ{Grp}$ (see~\S{}\ref{subsec:groups:products-et-al});
...
products in the category $\categ{Grp}$.  There are situations in which
...
$\gamma : H \to \Aut_{$\categ{Grp}$}(N)$. The reader is
...
\begin{prop}{}{prop:groups2:5.10}
  ...
  $\theta : H \to \Aut_{$\categ{Grp}$}(N)$ be a
...
\begin{prop}{}{prop:groups2:5.11}
  ...
  $\gamma : H \to \Aut_{$\categ{Grp}$}(N)$ be defined by
...
\begin{exam}{}{exam:groups2:5.13}
  ...
  $C_2 \to \Aut_{$\categ{Grp}$}(C_3)$: the trivial map,
...
$\Aut_{$\categ{Grp}$}(N)$ and can be carried out. See
...
\begin{exer}{}{exer:groups2:5.12}
  ...
  $\Aut_{$\categ{Grp}$}(C_q) \cong C_{q-1}$ if $q$ is
...
\begin{exer}{}{exer:groups2:5.14}
  Recall that
  $S_3 \cong \Aut_{$\categ{Grp}$}(C_2 \times C_2)$
...
\begin{exer}{}{exer:groups2:5.15}
  ...
  \item Recall (or prove again) that, up to isomorphism, the only
    ...
    $C_4 \to \Aut_{$\categ{Grp}$}(N)$ and two
    homomorphisms
    $C_2 \times C_2 \to \Aut_{$\categ{Grp}$} (N)$ up to
...
\begin{exer}{}{exer:groups2:5.17}
  Prove that the multiplicative group $\H^*$ of nonzero
...
\begin{exer}{}{exer:groups2:6.10}
  ...
  $G^\vee := \Hom_{\textsf{Grp}}(G, \C^*)$, where
  $\C^*$ is the multiplicative group of $\C$.
  \begin{itemize}
