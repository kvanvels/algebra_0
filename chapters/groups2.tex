...
applications (for example, in Galois theory; cf.\ \S{}VII.7), and it
...
\[
  \rho(g, a) = gag^{-1}.
\]
As we know (\S{}II.9.2), this datum is equivalent to the datum of a
...
to be able to tell whether a group is simple or not.\footnote{In fact,
  ...
  classification result mentioned at the end of \S{}II.6.3, arguably
...
\begin{proof}[Proof of \cref{prop:groups2:sylow-i-strong}]
  ...
  quotient (\S{}II.8.3, especially \Cref{prop:groups:subgroups-of-quotients-bijection}), this subgroup
...
\begin{proof}
  ...
  (cf.\ \S{}II.8.3) of the form $H'/H$ for a subgroup $H'$ of
...
form a multiset\footnote{See~\S{}I.2.2 for a reminder on multisets:
...
(\S{}VII.7.4).  But we can already appreciate it in the way it relates
...
$\categ{Set}$) of the set $\{1,\dots,n\}$. In~\S{}II.2 we denoted
...
agreed in~\S{}II.2.1 that we would let our permutations act on the
...
in~\S{}III.7.1. A (short) exact sequence of groups is a sequence of
...
$\Z$-modules) from \S{}III.7.1; a notational difference is that here
