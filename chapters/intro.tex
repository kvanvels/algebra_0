...
this will in turn be quoted in \ref{subsec:fields:abelian-groups-as-galois-groups-over-q}, discussing the realization
...
little algebraic geometry here and there (for example, see \ref{sec:fields:algebraic-closure-nullstellensatz-and-a-little-algebraic}),
...
3.1 in Chapter I is followed by [5.1, \ref{subsec:linrep:functors}, \ref{subsec:homol:additive-categories},
