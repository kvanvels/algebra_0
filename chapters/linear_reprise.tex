...
\begin{exer}{$\lnot$}{exer:linrep:yoneda-embedding-is-functor}
  ...
  action on morphisms in the natural way.) [\ref{exer:linrep:small-category-embeds-in-functor-category}, \ref{exer:homol:1.11}]
\end{exer}
...
\begin{exer}{$\lnot$}{exer:linrep:yoneda-lemma}
  ...
  \emph{Yoneda lemma}.  [\ref{exer:linrep:small-category-embeds-in-functor-category}, \ref{exer:homol:2.17}]
\end{exer}
