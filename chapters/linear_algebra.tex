...
$\mathbb{Q}$-vector spaces}. (In particular, $(\mathbb{R}, +)$ and
...
is a field of characteristic $0$. Prove that $A \cong \mathbb{Q}$.
(Hint: Prove that $A$ carries a $\mathbb{Q}$-vector space structure;
