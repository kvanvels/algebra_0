...
a less `general' nature than those considered in Chapter~II\@. Most of
...
Recall that we proved (Proposition~II.9.9) that every
...
(Definition~II.9.8) the subgroup of $G$ fixing $a$. This fact applies
...
stabilizer of any $a \in O$; in particular (Corollary~II.9.10) the
...
\begin{proof}
  ...
  \[
    |S| = |Z| + \sum_{a \in A} |O_a|,
  \]
  where $O_a$ denotes the orbit of $a$. By Proposition~II.9.9, the
...
Exercise~1.1. Such immediate consequences of
...
Recall (Example~II.9.3) that every group $G$ acts on itself in at
...
\end{lem}
\begin{proof}
  (Cf.\ Exercise~1.5.) As $G/Z(G)$ is cyclic, there exists an element
...
\cref{lem:groups2:quotient-center-cyclic}; cf.\ Exercise~1.6) that if
...
\begin{exam}{}{}
  ...
  noncommutative group of order 6 up to isomorphism (Exercise~1.13).
\end{exam}
...
Lemma~2.9.  Another useful numerical tool is the observation that if
...
determine $\ker\gamma$ (Exercise~1.21).

This is especially useful if $H$ is finite and some information is
available concerning $\operatorname{Aut}_{\categ{Grp}}(K)$ (for an
example, see Exercise~4.14). A classic application is presented in
Exercise~1.22.
...
\begin{exer}{}{exer:groups2:1.2}
  ...
  $n$. You have actually done this already: Exercise~II.2.7. This
...
\begin{exer}{}{exer:groups2:1.4}
  ...
  $Z(G)$. Prove that $N$ is normal in $G$. [\S{}2.2]
\end{exer}
...
\begin{exer}{}{exer:groups2:1.6}
  ...
  order $p^2$, for a prime $p$, is commutative. [\S{}1.3]
\end{exer}
...
\begin{exer}{}{exer:groups2:1.8}
  ...
  $p^k$ for every nonnegative $k \leq r$. [\S{}2.2]
\end{exer}
...
\begin{exer}{}{exer:groups2:1.13}
  ...
  observed in Example~1.10, $G$ must have trivial center and exactly
...
\begin{exer}{}{exer:groups2:1.16}
  ...
  in $H$. (Hint: Note that $H$ is normal in $G$, by Exercise~II.8.2;
  apply Proposition~II.8.11.) [\S{}4.4]
\end{exer}
\begin{exer}{}{exer:groups2:1.17}
  ...
  overlap, at least at the identity.) [1.18, 1.20]
\end{exer}
\begin{exer}{}{exer:groups2:1.18}
  ...
  $s \in S$. (Hint: By Proposition~II.9.9, you may assume $S = G/H$,
  with $H$ proper in $G$. Use Exercise~1.17.)
\end{exer}
...
\begin{exer}{}{exer:groups2:1.22}
  ...
  $H$ is contained in the center of $G$. (Hint: By Exercise~1.21 there
  is a homomorphism
  $\gamma : G \to \operatorname{Aut}_{\categ{Grp}}(H)$; by
  Exercise~II.4.14, $\operatorname{Aut}_{\categ{Grp}}(H)$ has order
  $p - 1$. What can you say about $\gamma$?) [\S{}1.4]
\end{exer}
...
theorem for abelian groups (in Exercise~II.8.17), we could directly
...
then that subgroup must be normal (Exercise~2.2), suffices for
...
\begin{proof}[Proof of \cref{prop:groups2:sylow-i-strong}]
  ...
  quotient (\S{}II.8.3, especially Proposition~II.8.9), this subgroup
...
\begin{rem}{}{}
  The diligent reader worked out in Exercise~II.8.20 a \emph{stronger}
...
\begin{proof}
  ...
  homomorphism $\gamma : G \to \operatorname{Aut}(H)$.  Now $H$ is
  cyclic of order $p$, so $|\operatorname{Aut}(H)| = p - 1$
  (Exercise~II.4.14); the order of $\gamma(G)$ must divide both $pq$
  ...
  then $|gh| = pq$ by Exercise~II.1.14.
\end{proof}
...
low-brow alternatives, see Exercise~2.18 or Remark~5.4.
...
semidirect products (Exercise~5.12). But we are in fact already in the
...
\begin{proof}
  ...
  \[
    q \mid (r^2 - 1) = (r-1)(r+1)
  \]
  by Corollary~II.1.11. Since $q$ is prime, this says that
  ...
  $2q$ (by Exercise~II.1.14), and $G$ is cyclic, a contradiction.
  ...
  $D_{2q}$, as the reader hopefully verified in Exercise~II.2.5; the
  statement follows.
\end{proof}
...
\begin{exer}{}{exer:groups2:2.2}
  ...
  \item Let $K$ be a normal subgroup of a finite group $G$, and assume
    ...
    characteristic in $G$.
  \end{itemize} [\S{}2.1, \S{}2.4, 2.13, \S{}3.3]
\end{exer}
...
\begin{exer}{}{exer:groups2:2.4}
  ...
  itself (up to isomorphism). [\S{}3.2]
\end{exer}
...
\begin{exer}{}{exer:groups2:2.17}
  ...
  \item Conclude that $G$ is contained in the center of $R$. Recall
    ...
    Exercise~III.2.9), and conclude that $R$ is commutative.
  \end{itemize}
  Like Exercise~III.2.11, this is a particular case of a theorem of
...
\begin{exer}{}{exer:groups2:2.18}
  ...
  nor $p$ nor $q$; deduce that $G$ is cyclic. [\S{}2.5]
\end{exer}
...
\begin{exer}{}{exer:groups2:2.23}
  ...
  $N > 1$, then $|G|$ divides $N!$. (Hint: Exercise~II.9.12.) This
  problem capitalizes on the idea behind Example~2.15.  [2.25]
\end{exer}
...
\begin{exer}{}{exer:groups2:2.25}
  ...
  Conclude that every simple group\footnote{The reader will prove
    later (Exercise~4.22) that there is in fact only one simple group
...
\begin{proof}
  ...
  quotients, by Proposition~II.8.10 (the ``third isomorphism
  ...
  Theorem~II.7.12) there is an onto homomorphism
  \[
...
subgroup essentially immediate (cf.\ Exercise~II.7.11):
...
\begin{proof}
  ...
  universal property of quotients (Theorem~II.7.12).
\end{proof}
...
\begin{exer}{}{exer:groups2:3.5}
  ...
  group $G$, then $HK$ is a normal subgroup of $G$. [\S{}3.1]
\end{exer}
...
\begin{exer}{}{exer:groups2:3.7}
  ...
  theorem, using Schreier's. [\S{}3.2]
\end{exer}

\begin{exer}{}{exer:groups2:3.8}
  \exerused Prove
  Lemma~\ref{lem:groups2:commutator-homomorphism}. [\S{}3.3]
\end{exer}
...
\begin{exer}{}{exer:groups2:3.10}
  ...
  subgroup of $G$ corresponding (as in Proposition~II.8.9) to the
  center of $G/Z_{i-1}$.
  \begin{itemize}
...
\begin{proof}
  ...
  Proposition~II.8.11), and it properly contains $A_n$, so it must
...
\begin{exer}{}{exer:groups2:4.11}
  ...
  in Wilson's theorem (cf.\ Exercise~II.4.16).
\end{exer}
...
\begin{exer}{}{exer:groups2:4.13}
  ...
  the determinant of the matrix $M_\sigma$ defined in Exercise~II.2.1.
\end{exer}
...
realized as a subgroup of $G$. Recall (Proposition~II.8.11) that if
...
\begin{rem}{}{rem:groups2:5.4}
  ...
  conclusion we obtained in Claim~2.16.
\end{rem}
...
Exercise~1.21) conjugation determines a homomorphism
...
\begin{exam}{}{exam:groups2:5.13}
  ...
  are
  \[
    \mathrm{id} : \begin{cases} e \mapsto e, \\ y \mapsto y, \\ y^2
      \mapsto y^2,
    \end{cases}
...
sense explains) the discussion presented in Claim~2.17.
...
\begin{exer}{}{exer:groups2:5.4}
  ...
  \[0 \longrightarrow \Z \xrightarrow{\cdot 2} \Z \longrightarrow
    \Z/2\Z \longrightarrow 0\] is exact but does not split. [\S{}5.2]
\end{exer}
...
\begin{exer}{}{exer:groups2:5.14}
  Recall that
  $S_3 \cong \operatorname{Aut}_{\textsf{Grp}}(C_2 \times C_2)$
  (Exercise~II.4.13). Let $\iota$ be this isomorphism. Prove that
...
\begin{exer}{}{exer:groups2:5.15}
  ...
  \item Recall (or prove again) that, up to isomorphism, the only
    ...
    homomorphisms
    $C_2 \times C_2 \to \operatorname{Aut}_{\textsf{Grp}} (N)$ up to
...
\begin{exer}{}{exer:groups2:5.17}
  ...
  product $\mathrm{SU}(2) \rtimes \R^+$. (Hint: Exercise~III.2.5.) Is
...
In due time (Proposition~VI.2.11, Exercise~VI.2.19) we will in fact be
able to classify all finitely generated abelian groups: as mentioned
in Example~II.6.3, all such groups are products of cyclic
...
of which\footnote{The diligent reader has proved that particular case
  in Exercise~II.4.11. The proof hinted at in that exercise upgrades
...
Example~II.4.6.  \emph{Preview of coming attractions:} Finitely
...
\begin{exer}{}{exer:groups2:6.6}
  ...
  there, up to isomorphism? [\S{}II.6.3]
\end{exer}
...
\begin{exer}{}{exer:groups2:6.13}
  ...
  elements of order $2$, and $12$ elements of order $4$.) [\S{}II.4.3]
\end{exer}
