...
\else
  \input{fonts}
\fi
\usepackage[normalem]{ulem} % \tolean{}/\leaned{} markers below; normalem keeps \emph italic.
...
% to be added to the Algebra0Lean project. Underlines the text in
% place so it stays readable in context. Optional first argument is a
% margin note (e.g. which Lean declaration this became, or hints on
% how to formalize it) rendered in the PDF as a reminder:
...
% \leaned is a true no-op on the rendered text: no underline, and its
