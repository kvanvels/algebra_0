...
\begin{exer}{$*$}{exer:linrep:graded-algebra-lemma-equivalence}
  ...
  \Cref{lem:linrep:homogeneous-ideal-tfae}. [\S{}\ref{subsec:linrep:very-small-detour-graded-algebra}]
\end{exer}
...
\begin{exer}{$*$}{exer:linrep:skew-commutativity-of-exterior-algebra}
  ...
  \Cref{rem:linrep:exterior-algebra-skew-commutative}. [\S{}\ref{subsec:linrep:tensor-algebras}]
\end{exer}
...
By \Cref{prop:linrep:dual-module-torsion-free}, $M^{\vee\vee}$ is torsion-free. In
...
\begin{exer}{$*$}{exer:linrep:evaluation-map-dual-tensor-free-iso-hom}
  ...
  \Cref{prop:linrep:hom-into-free-module-via-dual}. [\S{}\ref{subsec:linrep:dual-modules}]
\end{exer}
