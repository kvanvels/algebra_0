...
\begin{exam}{}{exam:groups2:order-6-class-formula}
  ...
  noncommutative group of order 6 up to isomorphism (\Cref{exer:groups2:noncomm-grp-ord-6-iso-s3}).
\end{exam}
...
determine $\ker\gamma$ (\Cref{exer:groups2:conj-action-kernel-is-centralizer}).

This is especially useful if $H$ is finite and some information is
available concerning $\Aut_{\categ{Grp}}(K)$ (for an
example, see \Cref{exer:groups2:ctr-of-an-trivial}). A classic application is presented in
\Cref{exer:groups2:min-prime-ord-normal-subgrp-central}.
...
\begin{exer}{}{exer:groups2:nontriv-norm-subgrp-meets-ctr}
  ...
  $H \cap Z(G) \neq \{e\}$. (Hint: Use the class formula.) [\ref{exer:groups2:nilp-grp-normal-subgrp-meets-ctr}]
\end{exer}
...
\begin{exer}{}{exer:groups2:grp-not-union-of-conjugates}
  ...
  overlap, at least at the identity.) [\ref{exer:groups2:transitive-action-has-free-elt}, \ref{exer:groups2:gl2c-union-of-conjugates-of-borel}]
\end{exer}
\begin{exer}{}{exer:groups2:transitive-action-has-free-elt}
  ...
  with $H$ proper in $G$. Use \Cref{exer:groups2:grp-not-union-of-conjugates}.)
\end{exer}
...
\begin{exer}{}{exer:groups2:gl2c-union-of-conjugates-of-borel}
  ...
  in \Cref{exer:groups2:grp-not-union-of-conjugates} is necessary. (Hint: Equivalently, prove that every
...
\begin{exer}{}{exer:groups2:conj-action-kernel-is-centralizer}
  ...
  $K$.  [\S{}\ref{subsec:groups2:conjugation-of-subsets-and-subgroups}, \ref{exer:groups2:min-prime-ord-normal-subgrp-central}]
\end{exer}
\begin{exer}{}{exer:groups2:min-prime-ord-normal-subgrp-central}
  ...
  $H$ is contained in the center of $G$. (Hint: By \Cref{exer:groups2:conj-action-kernel-is-centralizer} there
  is a homomorphism
...
then that subgroup must be normal (\Cref{exer:groups2:characteristic-subgrp-basics}), suffices for
...
then that subgroup must be normal.\footnote{For an alternative
  viewpoint, see \Cref{exer:groups2:characteristic-subgrp-basics}.}
...
\begin{proof}
  ...
  action of $G$ on $H$, hence (by \cref{exer:groups2:conj-action-kernel-is-centralizer}) a
...
low-brow alternatives, see \Cref{exer:groups2:alt-proof-ord-pq-cyclic-via-sylow-count} or \Cref{rem:groups2:5.4}.
...
semidirect products (\Cref{exer:groups2:classify-grps-ord-pq}). But we are in fact already in the
position of obtaining rather sophisticated information about this
group, even without knowing its construction in general
(\Cref{exer:groups2:noncomm-grp-ord-pq-structure}).
...
\cref{exer:groups2:noncomm-grp-ord-6-iso-s3}: every noncommutative group of order 6 is
...
ef{subsec:groups2:sylow-iii}, \ref{exer:groups2:sylow-normal-implies-char-self-normalizing}, \S{}\ref{subsec:groups2:the-commutator-subgroup-derived-series-and-solvability}]
\end{exer}
...
\begin{exer}{}{exer:groups2:p-subgrp-in-normalizer-subset-sylow}
  ...
  $G$. Deduce that $H \subseteq P$.) [\ref{exer:groups2:sylow-conj-action-p-unique-fixed-pt}]
\end{exer}
\begin{exer}{}{exer:groups2:sylow-conj-action-p-unique-fixed-pt}
  ...
  Use \Cref{exer:groups2:p-subgrp-in-normalizer-subset-sylow}.) [\ref{exer:groups2:alt-proof-third-sylow-thm}]
\end{exer}
\begin{exer}{}{exer:groups2:alt-proof-third-sylow-thm}
  ...
  \Cref{exer:groups2:sylow-conj-action-p-unique-fixed-pt} to paste together an alternative proof of the third
  Sylow theorem. [\S{}
...
\begin{exer}{}{exer:groups2:sylow-normal-implies-char-self-normalizing}
  ...
  \item Prove that if $P$ is normal in $G$, then it is in fact
    characteristic in $G$ (cf.\ \cref{exer:groups2:characteristic-subgrp-basics}).
  ...
  \end{itemize} [\ref{exer:groups2:nilp-grp-proper-subgrp-lt-normalizer}]
\end{exer}
...
\begin{exer}{}{exer:groups2:noncomm-grp-ord-8-is-d8-or-q8}
  ...
  \end{itemize} [\ref{exer:groups2:complete-classification-ord-8}, \ref{exer:fields:nested-radical-galois-examples}]
\end{exer}
...
\begin{exer}{}{exer:groups2:simple-grp-ord-divides-np-factorial}
  ...
  problem capitalizes on the idea behind \Cref{exam:groups2:no-simple-order-24}.  [\ref{exer:groups2:simple-grp-ord-60-subgrp-idx-5}]
\end{exer}
...
\begin{exer}{}{exer:groups2:simple-grp-ord-60-subgrp-idx-5}
  ...
  \item Use Sylow's theorems and simple numerology to prove that $G$
    ...
    fifteen elements of order 2 or 4. (\cref{exer:groups2:simple-grp-ord-divides-np-factorial} will
    likely be helpful.)
  ...
  Conclude that every simple group\footnote{The reader will prove
    later (\Cref{exer:groups2:a5-unique-simple-grp-ord-60}) that there is in fact only one simple group
...
(Exercise~\ref{exer:groups2:fin-grp-has-comp-series-z-does-not}). It is also clear that if a normal
...
\begin{proof}
  ...
  normal in $G$ (Exercise~\ref{exer:groups2:product-of-normal-subgrps-normal}), and
...
(Exercise~\ref{exer:groups2:nonisom-grps-same-comp-factors}). One has to take into account the
...
\begin{proof}
  ...
  (Exercise~\ref{exer:groups2:simple-iff-only-triv-hom-images}), as needed.  Summarizing, we have
...
isomorphism theorem (cf.\ Exercise~\ref{exer:groups2:alt-proof-jordan-holder-via-schreier}).
...
\begin{proof}
  ...
  Exercise~\ref{exer:groups2:characteristic-subgrp-basics}).
...
\begin{exer}{}{exer:groups2:nilpotent-grp-upper-central-series}
  ...
  \end{itemize} [\ref{exer:groups2:nilp-grp-normal-subgrp-meets-ctr}, \ref{exer:groups2:nilp-grp-proper-subgrp-lt-normalizer},
...
\begin{exer}{}{exer:groups2:nilp-grp-normal-subgrp-meets-ctr}
  ...
  $G$ (cf.\ Exercise~\ref{exer:groups2:nilpotent-grp-upper-central-series}). Prove that $H$
  ...
  Exercise~\ref{exer:groups2:nontriv-norm-subgrp-meets-ctr}.  [\ref{exer:groups2:solvable-grp-normal-subgrp-has-comm-normal}]
\end{exer}
\begin{exer}{}{exer:groups2:nilp-grp-proper-subgrp-lt-normalizer}
  Let $H$ be a proper subgroup of a finite nilpotent group $G$ (cf.\
  Exercise~\ref{exer:groups2:nilpotent-grp-upper-central-series}). Prove that $H \subsetneq
  ...
  Sylow subgroup of a finite nilpotent group is normal\footnote{This
    ...
    Exercise~\ref{exer:groups2:all-sylow-normal-implies-direct-product}.}. (Use
  Exercise~\ref{exer:groups2:sylow-normal-implies-char-self-normalizing}.)
\end{exer}
\begin{exer}{}{exer:groups2:derived-series-terms-characteristic}
  ...
  characteristic (hence normal) in $G$. [\ref{exer:groups2:solvable-grp-normal-subgrp-has-comm-normal}]
\end{exer}
\begin{exer}{}{exer:groups2:solvable-grp-normal-subgrp-has-comm-normal}
  ...
  \item Prove that $H$ contains a nontrivial commutative subgroup that
    ...
    and use Exercise~\ref{exer:groups2:derived-series-terms-characteristic} to show it is normal in
    $G$.)
  \item Find an example showing that $H$ need not intersect the center
    of $G$ nontrivially (cf.\ Exercise~\ref{exer:groups2:nilp-grp-normal-subgrp-meets-ctr}).
  \end{itemize}
\end{exer}
...
maximal enlightenment, try to do Exercise~\ref{exer:groups2:conj-class-size-example-s8} now,
...
\begin{proof}
  ...
  (Exercise~\ref{exer:groups2:disjoint-cycle-factor-unique}).
\end{proof}
...
\begin{proof}
  (Cf.\ Exercise~\ref{exer:groups2:idx-2-subgrp-conj-class-half}.) Note that
...
(Exercise~\ref{exer:groups2:no-noncomm-simple-below-60}); and we now see why $60$ is
special:
...
(Exercise~\ref{exer:groups2:a6-simple-via-class-formula}). It is in fact the case that all
...
(Exercise~\ref{exer:groups2:no-noncomm-simple-below-60}).
...
\begin{proof}
  ...
  (Exercise~\ref{exer:groups2:ctr-of-an-trivial}) and $3$-cycles generate $A_n$, we
  ...
  (Exercise~\ref{exer:groups2:a6-simple-via-class-formula}), this implies $N \cap A_6 = A_6$.
...
Exercise~\ref{exer:groups2:grp-ord-lt-120-neq-60-solvable}.
...
\begin{exer}{}{exer:groups2:sn-gen-by-transposition-and-ncycle}
  ...
  [\cref{exer:groups2:d8-in-s4-and-dihedral-in-sn}, \S{}\ref{subsec:fields:galois-groups-of-polynomials}]
\end{exer}
...
\begin{exer}{}{exer:groups2:d8-in-s4-and-dihedral-in-sn}
  By \cref{exer:groups2:sn-gen-by-transposition-and-ncycle}, $S_4$ is generated by $(12)$ and
...
\begin{exer}{}{exer:groups2:sylow-count-sp-wilsons-thm}
  ...
  subgroups of $S_p$. (Use \cref{exer:groups2:num-ncycles-and-conj-class-size-formula}.) Use this result
...
\begin{exer}{}{exer:groups2:a5-unique-simple-grp-ord-60}
  ...
  $60$, up to isomorphism. (Hint: By \Cref{exer:groups2:simple-grp-ord-60-subgrp-idx-5}, a simple group $G$
  ...
  $2$-Sylow subgroups; cf.\ \cref{exer:groups2:a5-ord-2-elts-and-sylow-count}. Thus, the other
  possibility contemplated in \Cref{exer:groups2:simple-grp-ord-60-subgrp-idx-5} does not occur. [\ref{exer:groups2:simple-grp-ord-60-subgrp-idx-5}]
\end{exer}
...
\Cref{exer:groups2:conj-action-kernel-is-centralizer}) conjugation determines a homomorphism
...
of dihedral groups (\cref{exer:groups2:d2n-as-semidirect-prod}); this enriches (and in a
...
\cref{exer:groups2:classify-grps-ord-28} for a further illustration of this technique.
\begin{exer}{}{exer:groups2:all-sylow-normal-implies-direct-product}
  ...
  \item Prove that $G$ is nilpotent. (Hint: Mod out by the center, and
    ...
    of groups?)
  \end{itemize}
  Together with \cref{exer:groups2:nilpotent-grp-upper-central-series}, this shows that a finite
  group is nilpotent if and only if each of its Sylow subgroups is
  normal. [\cref{exer:groups2:nilp-grp-proper-subgrp-lt-normalizer}, \S{}\ref{subsec:groups2:classification-of-finite-abelian-groups}]
\end{exer}
...
In due time (\Cref{linalg:2.11}, \Cref{exer:linalg:fin-gen-abel-grp-direct-sum-cyclic-via-matrices}) we will in fact be
...
abelian groups are nilpotent; cf.\ \cref{exer:groups2:all-sylow-normal-implies-direct-product}.)  Thus, we
...
(\cref{exer:groups2:uniqueness-of-p-grp-decomp}).  The prime powers appearing in the first
...
\begin{exer}{}{exer:groups2:uniqueness-of-p-grp-decomp}
  ...
  [\S{}\ref{subsec:groups2:invariant-factors-and-elementary-divisors}, \S{}\ref{subsec:linalg:the-classification-theorem}, \ref{exer:linalg:complete-uniqueness-proof-classification-thm}]
\end{exer}
...
\begin{exer}{}{exer:groups2:mult-by-p-hom-ker-coker-props}
  ...
  \end{itemize} [\cref{exer:groups2:subgrp-with-given-invariant-divisors}]
\end{exer}
\begin{exer}{}{exer:groups2:subgrp-with-given-invariant-divisors}
  ...
  \cref{exer:groups2:mult-by-p-hom-ker-coker-props}, compare $\ker\rho$ for $H$ and $G$ to
...
\begin{exer}{}{exer:groups2:fin-abel-grp-contains-subgrp-iso-quot}
  ...
  $p$-groups; then use \cref{exer:groups2:subgrp-with-given-invariant-divisors}.) Show that both
